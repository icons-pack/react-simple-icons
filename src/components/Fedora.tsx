    ...
    export type FedoraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fedora = React.forwardRef<SVGSVGElement, FedoraProps>(function Fedora({color = 'currentColor', size = 24, title = "fedora", ...others}, ref) {
