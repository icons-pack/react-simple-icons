...
export type WritedotasProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Writedotas = React.forwardRef<SVGSVGElement, WritedotasProps>(function Writedotas({color = 'currentColor', size = 24, title = "writedotas", ...others}, ref) {
