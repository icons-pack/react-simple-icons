    ...
    export type BorgbackupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Borgbackup = React.forwardRef<SVGSVGElement, BorgbackupProps>(function Borgbackup({color = 'currentColor', size = 24, title = "borgbackup", ...others}, ref) {
