    ...
    export type VitestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vitest = React.forwardRef<SVGSVGElement, VitestProps>(function Vitest({color = 'currentColor', size = 24, title = "vitest", ...others}, ref) {
