...
const Handlebarsdotjs = React.forwardRef<SVGSVGElement, HandlebarsdotjsProps>(function Handlebarsdotjs(
  { color = 'currentColor', size = 24, title = 'handlebarsdotjs', ...others },
  ref,
) {
  return (
    <svg
