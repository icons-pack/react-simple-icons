...
export type SemanticscholarProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Semanticscholar = React.forwardRef<SVGSVGElement, SemanticscholarProps>(function Semanticscholar({color = 'currentColor', size = 24, title = "semanticscholar", ...others}, ref) {
