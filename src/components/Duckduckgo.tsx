    ...
    export type DuckduckgoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Duckduckgo = React.forwardRef<SVGSVGElement, DuckduckgoProps>(function Duckduckgo({color = 'currentColor', size = 24, title = "duckduckgo", ...others}, ref) {
