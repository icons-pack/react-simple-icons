    ...
    export type KalilinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kalilinux = React.forwardRef<SVGSVGElement, KalilinuxProps>(function Kalilinux({color = 'currentColor', size = 24, title = "kalilinux", ...others}, ref) {
