    ...
    export type CloudflarepagesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cloudflarepages = React.forwardRef<SVGSVGElement, CloudflarepagesProps>(function Cloudflarepages({color = 'currentColor', size = 24, title = "cloudflarepages", ...others}, ref) {
