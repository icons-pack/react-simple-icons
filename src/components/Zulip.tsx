    ...
    export type ZulipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zulip = React.forwardRef<SVGSVGElement, ZulipProps>(function Zulip({color = 'currentColor', size = 24, title = "zulip", ...others}, ref) {
