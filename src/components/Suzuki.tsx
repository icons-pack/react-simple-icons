    ...
    export type SuzukiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Suzuki = React.forwardRef<SVGSVGElement, SuzukiProps>(function Suzuki({color = 'currentColor', size = 24, title = "suzuki", ...others}, ref) {
