    ...
    export type JekyllProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jekyll = React.forwardRef<SVGSVGElement, JekyllProps>(function Jekyll({color = 'currentColor', size = 24, title = "jekyll", ...others}, ref) {
