...
const Windicss = React.forwardRef<SVGSVGElement, WindicssProps>(function Windicss(
  { color = 'currentColor', size = 24, title = 'windicss', ...others },
  ref,
) {
  return (
    <svg
