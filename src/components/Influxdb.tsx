...
export type InfluxdbProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Influxdb = React.forwardRef<SVGSVGElement, InfluxdbProps>(function Influxdb({color = 'currentColor', size = 24, title = "influxdb", ...others}, ref) {
