...
export type SignalProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Signal = React.forwardRef<SVGSVGElement, SignalProps>(function Signal({color = 'currentColor', size = 24, title = "signal", ...others}, ref) {
