...
export type LodashProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Lodash = React.forwardRef<SVGSVGElement, LodashProps>(function Lodash({color = 'currentColor', size = 24, title = "lodash", ...others}, ref) {
