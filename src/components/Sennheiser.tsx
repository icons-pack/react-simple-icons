...
export type SennheiserProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sennheiser = React.forwardRef<SVGSVGElement, SennheiserProps>(function Sennheiser({color = 'currentColor', size = 24, title = "sennheiser", ...others}, ref) {
