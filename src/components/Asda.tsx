    ...
    export type AsdaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Asda = React.forwardRef<SVGSVGElement, AsdaProps>(function Asda({color = 'currentColor', size = 24, title = "asda", ...others}, ref) {
