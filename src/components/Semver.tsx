...
export type SemverProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Semver = React.forwardRef<SVGSVGElement, SemverProps>(function Semver({color = 'currentColor', size = 24, title = "semver", ...others}, ref) {
