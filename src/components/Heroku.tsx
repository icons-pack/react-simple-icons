    ...
    export type HerokuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Heroku = React.forwardRef<SVGSVGElement, HerokuProps>(function Heroku({color = 'currentColor', size = 24, title = "heroku", ...others}, ref) {
