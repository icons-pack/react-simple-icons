...
export type WindowsxpProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Windowsxp = React.forwardRef<SVGSVGElement, WindowsxpProps>(function Windowsxp({color = 'currentColor', size = 24, title = "windowsxp", ...others}, ref) {
