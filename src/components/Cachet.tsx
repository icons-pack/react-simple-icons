    ...
    export type CachetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cachet = React.forwardRef<SVGSVGElement, CachetProps>(function Cachet({color = 'currentColor', size = 24, title = "cachet", ...others}, ref) {
