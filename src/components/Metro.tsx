    ...
    export type MetroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Metro = React.forwardRef<SVGSVGElement, MetroProps>(function Metro({color = 'currentColor', size = 24, title = "metro", ...others}, ref) {
