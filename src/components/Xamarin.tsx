    ...
    export type XamarinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Xamarin = React.forwardRef<SVGSVGElement, XamarinProps>(function Xamarin({color = 'currentColor', size = 24, title = "xamarin", ...others}, ref) {
