    ...
    export type SoundchartsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Soundcharts = React.forwardRef<SVGSVGElement, SoundchartsProps>(function Soundcharts({color = 'currentColor', size = 24, title = "soundcharts", ...others}, ref) {
