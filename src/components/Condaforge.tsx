    ...
    export type CondaforgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Condaforge = React.forwardRef<SVGSVGElement, CondaforgeProps>(function Condaforge({color = 'currentColor', size = 24, title = "condaforge", ...others}, ref) {
