...
export type HiveBlockchainProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const HiveBlockchain = React.forwardRef<SVGSVGElement, HiveBlockchainProps>(function HiveBlockchain({color = 'currentColor', size = 24, title = "hive_blockchain", ...others}, ref) {
