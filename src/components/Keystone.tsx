    ...
    export type KeystoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Keystone = React.forwardRef<SVGSVGElement, KeystoneProps>(function Keystone({color = 'currentColor', size = 24, title = "keystone", ...others}, ref) {
