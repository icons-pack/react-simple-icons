    ...
    export type MetrodeparisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Metrodeparis = React.forwardRef<SVGSVGElement, MetrodeparisProps>(function Metrodeparis({color = 'currentColor', size = 24, title = "metrodeparis", ...others}, ref) {
