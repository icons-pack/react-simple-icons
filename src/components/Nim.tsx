    ...
    export type NimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nim = React.forwardRef<SVGSVGElement, NimProps>(function Nim({color = 'currentColor', size = 24, title = "nim", ...others}, ref) {
