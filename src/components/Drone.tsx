    ...
    export type DroneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Drone = React.forwardRef<SVGSVGElement, DroneProps>(function Drone({color = 'currentColor', size = 24, title = "drone", ...others}, ref) {
