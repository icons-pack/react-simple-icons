    ...
    export type ThemightyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Themighty = React.forwardRef<SVGSVGElement, ThemightyProps>(function Themighty({color = 'currentColor', size = 24, title = "themighty", ...others}, ref) {
