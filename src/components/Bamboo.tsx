...
export type BambooProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bamboo = React.forwardRef<SVGSVGElement, BambooProps>(function Bamboo({color = 'currentColor', size = 24, title = "bamboo", ...others}, ref) {
