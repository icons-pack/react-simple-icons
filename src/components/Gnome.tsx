    ...
    export type GnomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gnome = React.forwardRef<SVGSVGElement, GnomeProps>(function Gnome({color = 'currentColor', size = 24, title = "gnome", ...others}, ref) {
