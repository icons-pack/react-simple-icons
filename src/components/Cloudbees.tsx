...
export type CloudbeesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cloudbees = React.forwardRef<SVGSVGElement, CloudbeesProps>(function Cloudbees({color = 'currentColor', size = 24, title = "cloudbees", ...others}, ref) {
