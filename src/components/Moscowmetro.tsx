...
export type MoscowmetroProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Moscowmetro = React.forwardRef<SVGSVGElement, MoscowmetroProps>(function Moscowmetro({color = 'currentColor', size = 24, title = "moscowmetro", ...others}, ref) {
