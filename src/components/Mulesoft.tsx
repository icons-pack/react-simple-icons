...
export type MulesoftProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mulesoft = React.forwardRef<SVGSVGElement, MulesoftProps>(function Mulesoft({color = 'currentColor', size = 24, title = "mulesoft", ...others}, ref) {
