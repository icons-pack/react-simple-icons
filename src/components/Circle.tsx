    ...
    export type CircleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Circle = React.forwardRef<SVGSVGElement, CircleProps>(function Circle({color = 'currentColor', size = 24, title = "circle", ...others}, ref) {
