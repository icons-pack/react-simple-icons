    ...
    export type IcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Icloud = React.forwardRef<SVGSVGElement, IcloudProps>(function Icloud({color = 'currentColor', size = 24, title = "icloud", ...others}, ref) {
