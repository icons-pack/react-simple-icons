    ...
    const Affinitypublisher = React.forwardRef<SVGSVGElement, AffinitypublisherProps>(function Affinitypublisher({color = 'currentColor', size = 24, title = "affinitypublisher", ...others}, ref) {
