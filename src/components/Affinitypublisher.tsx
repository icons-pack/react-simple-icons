...
const Affinitypublisher = React.forwardRef<SVGSVGElement, IconProps>(function Affinitypublisher({color = 'currentColor', size = 24, title = "affinitypublisher", ...others}, ref) {
