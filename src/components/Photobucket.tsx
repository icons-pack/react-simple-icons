    ...
    export type PhotobucketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Photobucket = React.forwardRef<SVGSVGElement, PhotobucketProps>(function Photobucket({color = 'currentColor', size = 24, title = "photobucket", ...others}, ref) {
