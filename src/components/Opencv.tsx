    ...
    export type OpencvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Opencv = React.forwardRef<SVGSVGElement, OpencvProps>(function Opencv({color = 'currentColor', size = 24, title = "opencv", ...others}, ref) {
