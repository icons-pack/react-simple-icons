    ...
    export type JcbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jcb = React.forwardRef<SVGSVGElement, JcbProps>(function Jcb({color = 'currentColor', size = 24, title = "jcb", ...others}, ref) {
