...
const Pytorchlightning = React.forwardRef<SVGSVGElement, PytorchlightningProps>(function Pytorchlightning({color = 'currentColor', size = 24, title = "pytorchlightning", ...others}, ref) {
