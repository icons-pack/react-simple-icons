    ...
    export type ApachesparkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Apachespark = React.forwardRef<SVGSVGElement, ApachesparkProps>(function Apachespark({color = 'currentColor', size = 24, title = "apachespark", ...others}, ref) {
