    ...
    export type StylelintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Stylelint = React.forwardRef<SVGSVGElement, StylelintProps>(function Stylelint({color = 'currentColor', size = 24, title = "stylelint", ...others}, ref) {
