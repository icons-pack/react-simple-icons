    ...
    export type ItunesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Itunes = React.forwardRef<SVGSVGElement, ItunesProps>(function Itunes({color = 'currentColor', size = 24, title = "itunes", ...others}, ref) {
