    ...
    export type TheregisterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Theregister = React.forwardRef<SVGSVGElement, TheregisterProps>(function Theregister({color = 'currentColor', size = 24, title = "theregister", ...others}, ref) {
