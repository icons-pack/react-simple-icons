    ...
    export type MicrosoftacademicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftacademic = React.forwardRef<SVGSVGElement, MicrosoftacademicProps>(function Microsoftacademic({color = 'currentColor', size = 24, title = "microsoftacademic", ...others}, ref) {
