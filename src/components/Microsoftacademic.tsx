...
const Microsoftacademic = React.forwardRef<SVGSVGElement, IconProps>(function Microsoftacademic({color = 'currentColor', size = 24, title = "microsoftacademic", ...others}, ref) {
