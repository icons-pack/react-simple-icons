    ...
    export type PhpstormProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Phpstorm = React.forwardRef<SVGSVGElement, PhpstormProps>(function Phpstorm({color = 'currentColor', size = 24, title = "phpstorm", ...others}, ref) {
