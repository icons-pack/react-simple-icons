...
export type SteinbergProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Steinberg = React.forwardRef<SVGSVGElement, SteinbergProps>(function Steinberg({color = 'currentColor', size = 24, title = "steinberg", ...others}, ref) {
