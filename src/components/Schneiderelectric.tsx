...
const Schneiderelectric = React.forwardRef<SVGSVGElement, IconProps>(function Schneiderelectric({color = 'currentColor', size = 24, title = "schneiderelectric", ...others}, ref) {
