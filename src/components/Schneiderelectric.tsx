...
const Schneiderelectric = React.forwardRef<SVGSVGElement, SchneiderelectricProps>(function Schneiderelectric(
  { color = 'currentColor', size = 24, title = 'schneiderelectric', ...others },
  ref,
) {
  return (
    <svg
