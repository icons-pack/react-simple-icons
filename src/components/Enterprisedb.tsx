...
const Enterprisedb = React.forwardRef<SVGSVGElement, EnterprisedbProps>(function Enterprisedb(
  { color = 'currentColor', size = 24, title = 'enterprisedb', ...others },
  ref,
) {
  return (
    <svg
