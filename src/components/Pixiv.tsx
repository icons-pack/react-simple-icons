    ...
    export type PixivProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pixiv = React.forwardRef<SVGSVGElement, PixivProps>(function Pixiv({color = 'currentColor', size = 24, title = "pixiv", ...others}, ref) {
