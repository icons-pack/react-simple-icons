    ...
    export type KashflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kashflow = React.forwardRef<SVGSVGElement, KashflowProps>(function Kashflow({color = 'currentColor', size = 24, title = "kashflow", ...others}, ref) {
