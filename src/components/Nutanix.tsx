...
export type NutanixProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nutanix = React.forwardRef<SVGSVGElement, NutanixProps>(function Nutanix({color = 'currentColor', size = 24, title = "nutanix", ...others}, ref) {
