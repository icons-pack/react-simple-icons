    ...
    export type QuantcastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Quantcast = React.forwardRef<SVGSVGElement, QuantcastProps>(function Quantcast({color = 'currentColor', size = 24, title = "quantcast", ...others}, ref) {
