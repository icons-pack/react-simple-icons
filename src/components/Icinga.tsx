    ...
    export type IcingaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Icinga = React.forwardRef<SVGSVGElement, IcingaProps>(function Icinga({color = 'currentColor', size = 24, title = "icinga", ...others}, ref) {
