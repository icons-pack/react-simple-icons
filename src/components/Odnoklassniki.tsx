    ...
    const Odnoklassniki = React.forwardRef<SVGSVGElement, OdnoklassnikiProps>(function Odnoklassniki({color = 'currentColor', size = 24, title = "odnoklassniki", ...others}, ref) {
