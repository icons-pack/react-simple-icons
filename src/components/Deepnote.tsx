    ...
    export type DeepnoteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Deepnote = React.forwardRef<SVGSVGElement, DeepnoteProps>(function Deepnote({color = 'currentColor', size = 24, title = "deepnote", ...others}, ref) {
