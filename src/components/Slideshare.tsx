    ...
    export type SlideshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Slideshare = React.forwardRef<SVGSVGElement, SlideshareProps>(function Slideshare({color = 'currentColor', size = 24, title = "slideshare", ...others}, ref) {
