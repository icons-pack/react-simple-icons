    ...
    export type OpennebulaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Opennebula = React.forwardRef<SVGSVGElement, OpennebulaProps>(function Opennebula({color = 'currentColor', size = 24, title = "opennebula", ...others}, ref) {
