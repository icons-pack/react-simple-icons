...
export type NintendoThreeDsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const NintendoThreeDs = React.forwardRef<SVGSVGElement, NintendoThreeDsProps>(function NintendoThreeDs({color = 'currentColor', size = 24, title = "nintendo3ds", ...others}, ref) {
