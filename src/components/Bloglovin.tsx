    ...
    export type BloglovinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bloglovin = React.forwardRef<SVGSVGElement, BloglovinProps>(function Bloglovin({color = 'currentColor', size = 24, title = "bloglovin", ...others}, ref) {
