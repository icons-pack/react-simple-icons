    ...
    export type SketchfabProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sketchfab = React.forwardRef<SVGSVGElement, SketchfabProps>(function Sketchfab({color = 'currentColor', size = 24, title = "sketchfab", ...others}, ref) {
