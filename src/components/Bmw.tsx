...
export type BmwProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bmw = React.forwardRef<SVGSVGElement, BmwProps>(function Bmw({color = 'currentColor', size = 24, title = "bmw", ...others}, ref) {
