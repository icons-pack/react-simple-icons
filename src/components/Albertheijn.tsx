...
export type AlbertheijnProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Albertheijn = React.forwardRef<SVGSVGElement, AlbertheijnProps>(function Albertheijn({color = 'currentColor', size = 24, title = "albertheijn", ...others}, ref) {
