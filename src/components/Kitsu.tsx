    ...
    export type KitsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kitsu = React.forwardRef<SVGSVGElement, KitsuProps>(function Kitsu({color = 'currentColor', size = 24, title = "kitsu", ...others}, ref) {
