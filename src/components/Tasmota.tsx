...
export type TasmotaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Tasmota = React.forwardRef<SVGSVGElement, TasmotaProps>(function Tasmota({color = 'currentColor', size = 24, title = "tasmota", ...others}, ref) {
