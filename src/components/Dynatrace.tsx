...
export type DynatraceProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Dynatrace = React.forwardRef<SVGSVGElement, DynatraceProps>(function Dynatrace({color = 'currentColor', size = 24, title = "dynatrace", ...others}, ref) {
