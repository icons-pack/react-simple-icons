...
export type SmashdotggProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Smashdotgg = React.forwardRef<SVGSVGElement, SmashdotggProps>(function Smashdotgg({color = 'currentColor', size = 24, title = "smashdotgg", ...others}, ref) {
