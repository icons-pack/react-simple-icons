    ...
    export type MobxstatetreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mobxstatetree = React.forwardRef<SVGSVGElement, MobxstatetreeProps>(function Mobxstatetree({color = 'currentColor', size = 24, title = "mobxstatetree", ...others}, ref) {
