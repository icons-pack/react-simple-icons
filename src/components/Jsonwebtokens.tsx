    ...
    export type JsonwebtokensProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jsonwebtokens = React.forwardRef<SVGSVGElement, JsonwebtokensProps>(function Jsonwebtokens({color = 'currentColor', size = 24, title = "jsonwebtokens", ...others}, ref) {
