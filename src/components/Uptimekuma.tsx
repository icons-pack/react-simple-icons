...
export type UptimekumaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Uptimekuma = React.forwardRef<SVGSVGElement, UptimekumaProps>(function Uptimekuma({color = 'currentColor', size = 24, title = "uptimekuma", ...others}, ref) {
