...
export type AirbyteProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Airbyte = React.forwardRef<SVGSVGElement, AirbyteProps>(function Airbyte({color = 'currentColor', size = 24, title = "airbyte", ...others}, ref) {
