...
const Karlsruherverkehrsverbund = React.forwardRef<SVGSVGElement, IconProps>(function Karlsruherverkehrsverbund({color = 'currentColor', size = 24, title = "karlsruherverkehrsverbund", ...others}, ref) {
