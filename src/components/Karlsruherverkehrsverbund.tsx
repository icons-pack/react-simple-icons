    ...
    export type KarlsruherverkehrsverbundProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Karlsruherverkehrsverbund = React.forwardRef<SVGSVGElement, KarlsruherverkehrsverbundProps>(function Karlsruherverkehrsverbund({color = 'currentColor', size = 24, title = "karlsruherverkehrsverbund", ...others}, ref) {
