...
export type AdobeacrobatreaderProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Adobeacrobatreader = React.forwardRef<SVGSVGElement, AdobeacrobatreaderProps>(function Adobeacrobatreader({color = 'currentColor', size = 24, title = "adobeacrobatreader", ...others}, ref) {
