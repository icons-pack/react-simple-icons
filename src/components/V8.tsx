    ...
    export type V8Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const V8 = React.forwardRef<SVGSVGElement, V8Props>(function V8({color = 'currentColor', size = 24, title = "v8", ...others}, ref) {
