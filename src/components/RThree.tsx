    ...
    export type RThreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const RThree = React.forwardRef<SVGSVGElement, RThreeProps>(function RThree({color = 'currentColor', size = 24, title = "r3", ...others}, ref) {
