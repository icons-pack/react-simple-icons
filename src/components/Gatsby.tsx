    ...
    export type GatsbyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gatsby = React.forwardRef<SVGSVGElement, GatsbyProps>(function Gatsby({color = 'currentColor', size = 24, title = "gatsby", ...others}, ref) {
