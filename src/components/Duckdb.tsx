    ...
    export type DuckdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Duckdb = React.forwardRef<SVGSVGElement, DuckdbProps>(function Duckdb({color = 'currentColor', size = 24, title = "duckdb", ...others}, ref) {
