...
export type ClypProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Clyp = React.forwardRef<SVGSVGElement, ClypProps>(function Clyp({color = 'currentColor', size = 24, title = "clyp", ...others}, ref) {
