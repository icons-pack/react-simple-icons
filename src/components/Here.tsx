...
export type HereProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Here = React.forwardRef<SVGSVGElement, HereProps>(function Here({color = 'currentColor', size = 24, title = "here", ...others}, ref) {
