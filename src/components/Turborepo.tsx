    ...
    export type TurborepoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Turborepo = React.forwardRef<SVGSVGElement, TurborepoProps>(function Turborepo({color = 'currentColor', size = 24, title = "turborepo", ...others}, ref) {
