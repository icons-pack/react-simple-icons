    ...
    export type HaxeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Haxe = React.forwardRef<SVGSVGElement, HaxeProps>(function Haxe({color = 'currentColor', size = 24, title = "haxe", ...others}, ref) {
