    ...
    export type SalesforceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Salesforce = React.forwardRef<SVGSVGElement, SalesforceProps>(function Salesforce({color = 'currentColor', size = 24, title = "salesforce", ...others}, ref) {
