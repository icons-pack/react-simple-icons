    ...
    export type WpengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wpengine = React.forwardRef<SVGSVGElement, WpengineProps>(function Wpengine({color = 'currentColor', size = 24, title = "wpengine", ...others}, ref) {
