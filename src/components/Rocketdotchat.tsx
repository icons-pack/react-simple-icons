...
const Rocketdotchat = React.forwardRef<SVGSVGElement, RocketdotchatProps>(function Rocketdotchat({color = 'currentColor', size = 24, title = "rocketdotchat", ...others}, ref) {
