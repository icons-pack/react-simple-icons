...
export type ElementaryProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Elementary = React.forwardRef<SVGSVGElement, ElementaryProps>(function Elementary({color = 'currentColor', size = 24, title = "elementary", ...others}, ref) {
