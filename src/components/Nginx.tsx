    ...
    export type NginxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nginx = React.forwardRef<SVGSVGElement, NginxProps>(function Nginx({color = 'currentColor', size = 24, title = "nginx", ...others}, ref) {
