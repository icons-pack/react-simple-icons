    ...
    export type MdbookProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mdbook = React.forwardRef<SVGSVGElement, MdbookProps>(function Mdbook({color = 'currentColor', size = 24, title = "mdbook", ...others}, ref) {
