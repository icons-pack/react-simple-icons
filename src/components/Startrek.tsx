...
export type StartrekProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Startrek = React.forwardRef<SVGSVGElement, StartrekProps>(function Startrek({color = 'currentColor', size = 24, title = "startrek", ...others}, ref) {
