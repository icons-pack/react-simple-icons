...
export type GooglelensProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Googlelens = React.forwardRef<SVGSVGElement, GooglelensProps>(function Googlelens({color = 'currentColor', size = 24, title = "googlelens", ...others}, ref) {
