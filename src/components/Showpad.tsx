...
export type ShowpadProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Showpad = React.forwardRef<SVGSVGElement, ShowpadProps>(function Showpad({color = 'currentColor', size = 24, title = "showpad", ...others}, ref) {
