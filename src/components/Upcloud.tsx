...
export type UpcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Upcloud = React.forwardRef<SVGSVGElement, UpcloudProps>(function Upcloud({color = 'currentColor', size = 24, title = "upcloud", ...others}, ref) {
