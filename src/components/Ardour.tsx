...
export type ArdourProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ardour = React.forwardRef<SVGSVGElement, ArdourProps>(function Ardour({color = 'currentColor', size = 24, title = "ardour", ...others}, ref) {
