    ...
    export type TurbosquidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Turbosquid = React.forwardRef<SVGSVGElement, TurbosquidProps>(function Turbosquid({color = 'currentColor', size = 24, title = "turbosquid", ...others}, ref) {
