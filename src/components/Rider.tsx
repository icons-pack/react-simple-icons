    ...
    export type RiderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rider = React.forwardRef<SVGSVGElement, RiderProps>(function Rider({color = 'currentColor', size = 24, title = "rider", ...others}, ref) {
