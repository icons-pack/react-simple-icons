    ...
    export type TaxbuzzProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Taxbuzz = React.forwardRef<SVGSVGElement, TaxbuzzProps>(function Taxbuzz({color = 'currentColor', size = 24, title = "taxbuzz", ...others}, ref) {
