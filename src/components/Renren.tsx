    ...
    export type RenrenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Renren = React.forwardRef<SVGSVGElement, RenrenProps>(function Renren({color = 'currentColor', size = 24, title = "renren", ...others}, ref) {
