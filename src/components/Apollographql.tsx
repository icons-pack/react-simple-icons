    ...
    export type ApollographqlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Apollographql = React.forwardRef<SVGSVGElement, ApollographqlProps>(function Apollographql({color = 'currentColor', size = 24, title = "apollographql", ...others}, ref) {
