...
const Americanairlines = React.forwardRef<SVGSVGElement, IconProps>(function Americanairlines({color = 'currentColor', size = 24, title = "americanairlines", ...others}, ref) {
