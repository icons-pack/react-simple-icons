...
export type AmericanairlinesProps = {
  /**
...
const Americanairlines = React.forwardRef<SVGSVGElement, AmericanairlinesProps>(function Americanairlines(
  { color = 'currentColor', size = 24, title = 'americanairlines', ...others },
  ref,
) {
  return (
    <svg
