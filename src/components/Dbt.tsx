    ...
    export type DbtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dbt = React.forwardRef<SVGSVGElement, DbtProps>(function Dbt({color = 'currentColor', size = 24, title = "dbt", ...others}, ref) {
