...
const Googleclassroom = React.forwardRef<SVGSVGElement, GoogleclassroomProps>(function Googleclassroom(
  { color = 'currentColor', size = 24, title = 'googleclassroom', ...others },
  ref,
) {
  return (
    <svg
