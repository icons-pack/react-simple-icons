    ...
    export type CloudfoundryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cloudfoundry = React.forwardRef<SVGSVGElement, CloudfoundryProps>(function Cloudfoundry({color = 'currentColor', size = 24, title = "cloudfoundry", ...others}, ref) {
