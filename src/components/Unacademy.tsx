...
export type UnacademyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Unacademy = React.forwardRef<SVGSVGElement, UnacademyProps>(function Unacademy({color = 'currentColor', size = 24, title = "unacademy", ...others}, ref) {
