    ...
    export type SellfyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sellfy = React.forwardRef<SVGSVGElement, SellfyProps>(function Sellfy({color = 'currentColor', size = 24, title = "sellfy", ...others}, ref) {
