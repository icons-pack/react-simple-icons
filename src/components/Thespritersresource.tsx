...
const Thespritersresource = React.forwardRef<SVGSVGElement, ThespritersresourceProps>(function Thespritersresource(
  { color = 'currentColor', size = 24, title = 'thespritersresource', ...others },
  ref,
) {
  return (
    <svg
