...
const Thespritersresource = React.forwardRef<SVGSVGElement, IconProps>(function Thespritersresource({color = 'currentColor', size = 24, title = "thespritersresource", ...others}, ref) {
