    ...
    export type PyscaffoldProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pyscaffold = React.forwardRef<SVGSVGElement, PyscaffoldProps>(function Pyscaffold({color = 'currentColor', size = 24, title = "pyscaffold", ...others}, ref) {
