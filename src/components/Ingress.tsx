...
export type IngressProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ingress = React.forwardRef<SVGSVGElement, IngressProps>(function Ingress({color = 'currentColor', size = 24, title = "ingress", ...others}, ref) {
