    ...
    export type BigcartelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bigcartel = React.forwardRef<SVGSVGElement, BigcartelProps>(function Bigcartel({color = 'currentColor', size = 24, title = "bigcartel", ...others}, ref) {
