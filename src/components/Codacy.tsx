    ...
    export type CodacyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codacy = React.forwardRef<SVGSVGElement, CodacyProps>(function Codacy({color = 'currentColor', size = 24, title = "codacy", ...others}, ref) {
