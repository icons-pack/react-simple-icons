    ...
    export type ApachesolrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Apachesolr = React.forwardRef<SVGSVGElement, ApachesolrProps>(function Apachesolr({color = 'currentColor', size = 24, title = "apachesolr", ...others}, ref) {
