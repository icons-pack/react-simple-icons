    ...
    export type SequelizeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sequelize = React.forwardRef<SVGSVGElement, SequelizeProps>(function Sequelize({color = 'currentColor', size = 24, title = "sequelize", ...others}, ref) {
