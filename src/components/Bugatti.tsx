    ...
    export type BugattiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bugatti = React.forwardRef<SVGSVGElement, BugattiProps>(function Bugatti({color = 'currentColor', size = 24, title = "bugatti", ...others}, ref) {
