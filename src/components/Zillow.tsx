...
export type ZillowProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Zillow = React.forwardRef<SVGSVGElement, ZillowProps>(function Zillow({color = 'currentColor', size = 24, title = "zillow", ...others}, ref) {
