    ...
    export type GimpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gimp = React.forwardRef<SVGSVGElement, GimpProps>(function Gimp({color = 'currentColor', size = 24, title = "gimp", ...others}, ref) {
