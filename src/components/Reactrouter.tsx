...
export type ReactrouterProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Reactrouter = React.forwardRef<SVGSVGElement, ReactrouterProps>(function Reactrouter({color = 'currentColor', size = 24, title = "reactrouter", ...others}, ref) {
