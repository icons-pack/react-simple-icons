    ...
    export type SquarespaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Squarespace = React.forwardRef<SVGSVGElement, SquarespaceProps>(function Squarespace({color = 'currentColor', size = 24, title = "squarespace", ...others}, ref) {
