    ...
    export type ZoomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zoom = React.forwardRef<SVGSVGElement, ZoomProps>(function Zoom({color = 'currentColor', size = 24, title = "zoom", ...others}, ref) {
