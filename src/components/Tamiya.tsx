...
export type TamiyaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Tamiya = React.forwardRef<SVGSVGElement, TamiyaProps>(function Tamiya({color = 'currentColor', size = 24, title = "tamiya", ...others}, ref) {
