    ...
    const Generalmotors = React.forwardRef<SVGSVGElement, GeneralmotorsProps>(function Generalmotors({color = 'currentColor', size = 24, title = "generalmotors", ...others}, ref) {
