...
const Clockify = React.forwardRef<SVGSVGElement, ClockifyProps>(function Clockify(
  { color = 'currentColor', size = 24, title = 'clockify', ...others },
  ref,
) {
  return (
    <svg
