    ...
    export type ZebratechnologiesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zebratechnologies = React.forwardRef<SVGSVGElement, ZebratechnologiesProps>(function Zebratechnologies({color = 'currentColor', size = 24, title = "zebratechnologies", ...others}, ref) {
    ...
    export default Zebratechnologies
