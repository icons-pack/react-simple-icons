    ...
    export type EvernoteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Evernote = React.forwardRef<SVGSVGElement, EvernoteProps>(function Evernote({color = 'currentColor', size = 24, title = "evernote", ...others}, ref) {
