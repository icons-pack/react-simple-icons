...
export type RokuProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Roku = React.forwardRef<SVGSVGElement, RokuProps>(function Roku({color = 'currentColor', size = 24, title = "roku", ...others}, ref) {
