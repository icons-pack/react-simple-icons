    ...
    export type TaichilangProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Taichilang = React.forwardRef<SVGSVGElement, TaichilangProps>(function Taichilang({color = 'currentColor', size = 24, title = "taichilang", ...others}, ref) {
