    ...
    export type OvercastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Overcast = React.forwardRef<SVGSVGElement, OvercastProps>(function Overcast({color = 'currentColor', size = 24, title = "overcast", ...others}, ref) {
