    ...
    export type AureliaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aurelia = React.forwardRef<SVGSVGElement, AureliaProps>(function Aurelia({color = 'currentColor', size = 24, title = "aurelia", ...others}, ref) {
