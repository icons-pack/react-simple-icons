    ...
    export type NTwentySixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const NTwentySix = React.forwardRef<SVGSVGElement, NTwentySixProps>(function NTwentySix({color = 'currentColor', size = 24, title = "n26", ...others}, ref) {
