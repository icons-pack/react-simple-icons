    ...
    export type SteemitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Steemit = React.forwardRef<SVGSVGElement, SteemitProps>(function Steemit({color = 'currentColor', size = 24, title = "steemit", ...others}, ref) {
