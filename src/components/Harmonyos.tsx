    ...
    export type HarmonyosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Harmonyos = React.forwardRef<SVGSVGElement, HarmonyosProps>(function Harmonyos({color = 'currentColor', size = 24, title = "harmonyos", ...others}, ref) {
