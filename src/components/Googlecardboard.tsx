...
export type GooglecardboardProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Googlecardboard = React.forwardRef<SVGSVGElement, GooglecardboardProps>(function Googlecardboard({color = 'currentColor', size = 24, title = "googlecardboard", ...others}, ref) {
