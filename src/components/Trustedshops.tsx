...
export type TrustedshopsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Trustedshops = React.forwardRef<SVGSVGElement, TrustedshopsProps>(function Trustedshops({color = 'currentColor', size = 24, title = "trustedshops", ...others}, ref) {
