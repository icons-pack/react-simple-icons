    ...
    export type InkdropProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Inkdrop = React.forwardRef<SVGSVGElement, InkdropProps>(function Inkdrop({color = 'currentColor', size = 24, title = "inkdrop", ...others}, ref) {
