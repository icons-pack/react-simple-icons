...
const Adobeaftereffects = React.forwardRef<SVGSVGElement, IconProps>(function Adobeaftereffects({color = 'currentColor', size = 24, title = "adobeaftereffects", ...others}, ref) {
