    ...
    export type AdobeaftereffectsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobeaftereffects = React.forwardRef<SVGSVGElement, AdobeaftereffectsProps>(function Adobeaftereffects({color = 'currentColor', size = 24, title = "adobeaftereffects", ...others}, ref) {
