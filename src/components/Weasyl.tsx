    ...
    export type WeasylProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Weasyl = React.forwardRef<SVGSVGElement, WeasylProps>(function Weasyl({color = 'currentColor', size = 24, title = "weasyl", ...others}, ref) {
