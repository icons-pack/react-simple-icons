...
export type HuluProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Hulu = React.forwardRef<SVGSVGElement, HuluProps>(function Hulu({color = 'currentColor', size = 24, title = "hulu", ...others}, ref) {
