    ...
    export type BloggerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Blogger = React.forwardRef<SVGSVGElement, BloggerProps>(function Blogger({color = 'currentColor', size = 24, title = "blogger", ...others}, ref) {
