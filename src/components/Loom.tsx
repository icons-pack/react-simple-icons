    ...
    export type LoomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Loom = React.forwardRef<SVGSVGElement, LoomProps>(function Loom({color = 'currentColor', size = 24, title = "loom", ...others}, ref) {
