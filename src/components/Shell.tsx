...
export type ShellProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Shell = React.forwardRef<SVGSVGElement, ShellProps>(function Shell({color = 'currentColor', size = 24, title = "shell", ...others}, ref) {
