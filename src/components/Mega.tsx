    ...
    export type MegaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mega = React.forwardRef<SVGSVGElement, MegaProps>(function Mega({color = 'currentColor', size = 24, title = "mega", ...others}, ref) {
