...
export type EtsyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Etsy = React.forwardRef<SVGSVGElement, EtsyProps>(function Etsy({color = 'currentColor', size = 24, title = "etsy", ...others}, ref) {
