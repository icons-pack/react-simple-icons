    ...
    export type TablecheckProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tablecheck = React.forwardRef<SVGSVGElement, TablecheckProps>(function Tablecheck({color = 'currentColor', size = 24, title = "tablecheck", ...others}, ref) {
