    ...
    export type AmulProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Amul = React.forwardRef<SVGSVGElement, AmulProps>(function Amul({color = 'currentColor', size = 24, title = "amul", ...others}, ref) {
