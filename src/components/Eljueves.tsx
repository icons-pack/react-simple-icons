    ...
    export type EljuevesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Eljueves = React.forwardRef<SVGSVGElement, EljuevesProps>(function Eljueves({color = 'currentColor', size = 24, title = "eljueves", ...others}, ref) {
