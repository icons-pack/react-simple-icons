    ...
    export type PrettierProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Prettier = React.forwardRef<SVGSVGElement, PrettierProps>(function Prettier({color = 'currentColor', size = 24, title = "prettier", ...others}, ref) {
