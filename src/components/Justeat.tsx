    ...
    export type JusteatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Justeat = React.forwardRef<SVGSVGElement, JusteatProps>(function Justeat({color = 'currentColor', size = 24, title = "justeat", ...others}, ref) {
