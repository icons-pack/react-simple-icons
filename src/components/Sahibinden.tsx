    ...
    export type SahibindenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sahibinden = React.forwardRef<SVGSVGElement, SahibindenProps>(function Sahibinden({color = 'currentColor', size = 24, title = "sahibinden", ...others}, ref) {
