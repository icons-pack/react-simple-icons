    ...
    export type PrismicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Prismic = React.forwardRef<SVGSVGElement, PrismicProps>(function Prismic({color = 'currentColor', size = 24, title = "prismic", ...others}, ref) {
