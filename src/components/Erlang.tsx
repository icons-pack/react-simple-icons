    ...
    export type ErlangProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Erlang = React.forwardRef<SVGSVGElement, ErlangProps>(function Erlang({color = 'currentColor', size = 24, title = "erlang", ...others}, ref) {
