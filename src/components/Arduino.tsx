    ...
    export type ArduinoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Arduino = React.forwardRef<SVGSVGElement, ArduinoProps>(function Arduino({color = 'currentColor', size = 24, title = "arduino", ...others}, ref) {
