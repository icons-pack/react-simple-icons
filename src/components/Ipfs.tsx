    ...
    export type IpfsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ipfs = React.forwardRef<SVGSVGElement, IpfsProps>(function Ipfs({color = 'currentColor', size = 24, title = "ipfs", ...others}, ref) {
