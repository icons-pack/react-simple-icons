...
export type VaporProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Vapor = React.forwardRef<SVGSVGElement, VaporProps>(function Vapor({color = 'currentColor', size = 24, title = "vapor", ...others}, ref) {
