    ...
    export type NewyorktimesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Newyorktimes = React.forwardRef<SVGSVGElement, NewyorktimesProps>(function Newyorktimes({color = 'currentColor', size = 24, title = "newyorktimes", ...others}, ref) {
