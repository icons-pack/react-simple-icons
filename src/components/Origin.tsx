    ...
    export type OriginProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Origin = React.forwardRef<SVGSVGElement, OriginProps>(function Origin({color = 'currentColor', size = 24, title = "origin", ...others}, ref) {
