    ...
    export type ThesoundsresourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Thesoundsresource = React.forwardRef<SVGSVGElement, ThesoundsresourceProps>(function Thesoundsresource({color = 'currentColor', size = 24, title = "thesoundsresource", ...others}, ref) {
