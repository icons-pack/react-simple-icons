    ...
    export type ToshibaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Toshiba = React.forwardRef<SVGSVGElement, ToshibaProps>(function Toshiba({color = 'currentColor', size = 24, title = "toshiba", ...others}, ref) {
