    ...
    export type MoneygramProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Moneygram = React.forwardRef<SVGSVGElement, MoneygramProps>(function Moneygram({color = 'currentColor', size = 24, title = "moneygram", ...others}, ref) {
