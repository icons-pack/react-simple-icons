    ...
    export type PerforceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Perforce = React.forwardRef<SVGSVGElement, PerforceProps>(function Perforce({color = 'currentColor', size = 24, title = "perforce", ...others}, ref) {
