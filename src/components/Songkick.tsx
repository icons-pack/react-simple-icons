    ...
    export type SongkickProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Songkick = React.forwardRef<SVGSVGElement, SongkickProps>(function Songkick({color = 'currentColor', size = 24, title = "songkick", ...others}, ref) {
