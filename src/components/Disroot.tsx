    ...
    export type DisrootProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Disroot = React.forwardRef<SVGSVGElement, DisrootProps>(function Disroot({color = 'currentColor', size = 24, title = "disroot", ...others}, ref) {
