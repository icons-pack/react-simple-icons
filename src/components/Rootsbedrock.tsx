    ...
    export type RootsbedrockProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rootsbedrock = React.forwardRef<SVGSVGElement, RootsbedrockProps>(function Rootsbedrock({color = 'currentColor', size = 24, title = "rootsbedrock", ...others}, ref) {
