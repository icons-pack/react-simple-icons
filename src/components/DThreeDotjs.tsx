...
const DThreeDotjs = React.forwardRef<SVGSVGElement, DThreeDotjsProps>(function DThreeDotjs(
  { color = 'currentColor', size = 24, title = 'd3dotjs', ...others },
  ref,
) {
  return (
    <svg
