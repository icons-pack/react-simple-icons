    ...
    export type I18nextProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const I18next = React.forwardRef<SVGSVGElement, I18nextProps>(function I18next({color = 'currentColor', size = 24, title = "i18next", ...others}, ref) {
