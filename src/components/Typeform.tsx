...
export type TypeformProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Typeform = React.forwardRef<SVGSVGElement, TypeformProps>(function Typeform({color = 'currentColor', size = 24, title = "typeform", ...others}, ref) {
