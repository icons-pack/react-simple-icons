    ...
    export type GithubactionsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Githubactions = React.forwardRef<SVGSVGElement, GithubactionsProps>(function Githubactions({color = 'currentColor', size = 24, title = "githubactions", ...others}, ref) {
