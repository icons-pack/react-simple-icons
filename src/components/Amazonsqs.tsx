    ...
    export type AmazonsqsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Amazonsqs = React.forwardRef<SVGSVGElement, AmazonsqsProps>(function Amazonsqs({color = 'currentColor', size = 24, title = "amazonsqs", ...others}, ref) {
