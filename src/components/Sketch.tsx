    ...
    export type SketchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sketch = React.forwardRef<SVGSVGElement, SketchProps>(function Sketch({color = 'currentColor', size = 24, title = "sketch", ...others}, ref) {
