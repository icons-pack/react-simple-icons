    ...
    export type BitwardenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bitwarden = React.forwardRef<SVGSVGElement, BitwardenProps>(function Bitwarden({color = 'currentColor', size = 24, title = "bitwarden", ...others}, ref) {
