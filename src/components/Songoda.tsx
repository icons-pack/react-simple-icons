    ...
    export type SongodaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Songoda = React.forwardRef<SVGSVGElement, SongodaProps>(function Songoda({color = 'currentColor', size = 24, title = "songoda", ...others}, ref) {
