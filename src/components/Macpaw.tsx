    ...
    export type MacpawProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Macpaw = React.forwardRef<SVGSVGElement, MacpawProps>(function Macpaw({color = 'currentColor', size = 24, title = "macpaw", ...others}, ref) {
