...
export type QuickbooksProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Quickbooks = React.forwardRef<SVGSVGElement, QuickbooksProps>(function Quickbooks({color = 'currentColor', size = 24, title = "quickbooks", ...others}, ref) {
