...
export type ApacherocketmqProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Apacherocketmq = React.forwardRef<SVGSVGElement, ApacherocketmqProps>(function Apacherocketmq({color = 'currentColor', size = 24, title = "apacherocketmq", ...others}, ref) {
