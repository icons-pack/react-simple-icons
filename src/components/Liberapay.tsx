...
export type LiberapayProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Liberapay = React.forwardRef<SVGSVGElement, LiberapayProps>(function Liberapay({color = 'currentColor', size = 24, title = "liberapay", ...others}, ref) {
