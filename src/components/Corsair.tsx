    ...
    export type CorsairProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Corsair = React.forwardRef<SVGSVGElement, CorsairProps>(function Corsair({color = 'currentColor', size = 24, title = "corsair", ...others}, ref) {
