    ...
    export type OpnsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Opnsense = React.forwardRef<SVGSVGElement, OpnsenseProps>(function Opnsense({color = 'currentColor', size = 24, title = "opnsense", ...others}, ref) {
