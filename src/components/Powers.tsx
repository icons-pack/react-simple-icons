...
export type PowersProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Powers = React.forwardRef<SVGSVGElement, PowersProps>(function Powers({color = 'currentColor', size = 24, title = "powers", ...others}, ref) {
