    ...
    export type MyspaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Myspace = React.forwardRef<SVGSVGElement, MyspaceProps>(function Myspace({color = 'currentColor', size = 24, title = "myspace", ...others}, ref) {
