    ...
    export type SwiperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Swiper = React.forwardRef<SVGSVGElement, SwiperProps>(function Swiper({color = 'currentColor', size = 24, title = "swiper", ...others}, ref) {
