...
const Redbubble = React.forwardRef<SVGSVGElement, RedbubbleProps>(function Redbubble(
  { color = 'currentColor', size = 24, title = 'redbubble', ...others },
  ref,
) {
  return (
    <svg
