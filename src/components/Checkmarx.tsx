...
export type CheckmarxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Checkmarx = React.forwardRef<SVGSVGElement, CheckmarxProps>(function Checkmarx({color = 'currentColor', size = 24, title = "checkmarx", ...others}, ref) {
