    ...
    export type AdobefontsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobefonts = React.forwardRef<SVGSVGElement, AdobefontsProps>(function Adobefonts({color = 'currentColor', size = 24, title = "adobefonts", ...others}, ref) {
