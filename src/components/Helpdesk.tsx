    ...
    export type HelpdeskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Helpdesk = React.forwardRef<SVGSVGElement, HelpdeskProps>(function Helpdesk({color = 'currentColor', size = 24, title = "helpdesk", ...others}, ref) {
