    ...
    export type BbcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bbc = React.forwardRef<SVGSVGElement, BbcProps>(function Bbc({color = 'currentColor', size = 24, title = "bbc", ...others}, ref) {
