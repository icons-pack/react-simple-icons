...
export type PowerfxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Powerfx = React.forwardRef<SVGSVGElement, PowerfxProps>(function Powerfx({color = 'currentColor', size = 24, title = "powerfx", ...others}, ref) {
