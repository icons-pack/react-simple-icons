...
export type PaperspaceProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Paperspace = React.forwardRef<SVGSVGElement, PaperspaceProps>(function Paperspace({color = 'currentColor', size = 24, title = "paperspace", ...others}, ref) {
