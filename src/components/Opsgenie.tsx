...
export type OpsgenieProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Opsgenie = React.forwardRef<SVGSVGElement, OpsgenieProps>(function Opsgenie({color = 'currentColor', size = 24, title = "opsgenie", ...others}, ref) {
