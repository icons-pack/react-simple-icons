...
const Obsidian = React.forwardRef<SVGSVGElement, ObsidianProps>(function Obsidian(
  { color = 'currentColor', size = 24, title = 'obsidian', ...others },
  ref,
) {
  return (
    <svg
