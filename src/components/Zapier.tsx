    ...
    export type ZapierProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zapier = React.forwardRef<SVGSVGElement, ZapierProps>(function Zapier({color = 'currentColor', size = 24, title = "zapier", ...others}, ref) {
