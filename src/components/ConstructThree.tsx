    ...
    export type ConstructThreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const ConstructThree = React.forwardRef<SVGSVGElement, ConstructThreeProps>(function ConstructThree({color = 'currentColor', size = 24, title = "construct3", ...others}, ref) {
