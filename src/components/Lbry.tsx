...
export type LbryProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Lbry = React.forwardRef<SVGSVGElement, LbryProps>(function Lbry({color = 'currentColor', size = 24, title = "lbry", ...others}, ref) {
