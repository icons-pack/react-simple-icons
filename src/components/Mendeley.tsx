...
export type MendeleyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mendeley = React.forwardRef<SVGSVGElement, MendeleyProps>(function Mendeley({color = 'currentColor', size = 24, title = "mendeley", ...others}, ref) {
