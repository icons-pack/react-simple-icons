...
const Peakdesign = React.forwardRef<SVGSVGElement, PeakdesignProps>(function Peakdesign(
  { color = 'currentColor', size = 24, title = 'peakdesign', ...others },
  ref,
) {
  return (
    <svg
