    ...
    export type AeromexicoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aeromexico = React.forwardRef<SVGSVGElement, AeromexicoProps>(function Aeromexico({color = 'currentColor', size = 24, title = "aeromexico", ...others}, ref) {
