    ...
    export type YamahacorporationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Yamahacorporation = React.forwardRef<SVGSVGElement, YamahacorporationProps>(function Yamahacorporation({color = 'currentColor', size = 24, title = "yamahacorporation", ...others}, ref) {
