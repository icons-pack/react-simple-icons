...
const Internetexplorer = React.forwardRef<SVGSVGElement, IconProps>(function Internetexplorer({color = 'currentColor', size = 24, title = "internetexplorer", ...others}, ref) {
