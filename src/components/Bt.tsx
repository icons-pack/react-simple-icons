    ...
    export type BtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bt = React.forwardRef<SVGSVGElement, BtProps>(function Bt({color = 'currentColor', size = 24, title = "bt", ...others}, ref) {
