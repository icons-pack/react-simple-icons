    ...
    export type MicrosoftbingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftbing = React.forwardRef<SVGSVGElement, MicrosoftbingProps>(function Microsoftbing({color = 'currentColor', size = 24, title = "microsoftbing", ...others}, ref) {
