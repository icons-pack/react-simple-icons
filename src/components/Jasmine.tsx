    ...
    export type JasmineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jasmine = React.forwardRef<SVGSVGElement, JasmineProps>(function Jasmine({color = 'currentColor', size = 24, title = "jasmine", ...others}, ref) {
