...
export type CinemaFourDProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const CinemaFourD = React.forwardRef<SVGSVGElement, CinemaFourDProps>(function CinemaFourD({color = 'currentColor', size = 24, title = "cinema4d", ...others}, ref) {
