...
export type ReweProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Rewe = React.forwardRef<SVGSVGElement, ReweProps>(function Rewe({color = 'currentColor', size = 24, title = "rewe", ...others}, ref) {
