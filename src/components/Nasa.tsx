...
export type NasaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nasa = React.forwardRef<SVGSVGElement, NasaProps>(function Nasa({color = 'currentColor', size = 24, title = "nasa", ...others}, ref) {
