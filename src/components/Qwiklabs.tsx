    ...
    export type QwiklabsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Qwiklabs = React.forwardRef<SVGSVGElement, QwiklabsProps>(function Qwiklabs({color = 'currentColor', size = 24, title = "qwiklabs", ...others}, ref) {
