    ...
    export type DartyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Darty = React.forwardRef<SVGSVGElement, DartyProps>(function Darty({color = 'currentColor', size = 24, title = "darty", ...others}, ref) {
