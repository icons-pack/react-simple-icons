    ...
    export type CirrusciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cirrusci = React.forwardRef<SVGSVGElement, CirrusciProps>(function Cirrusci({color = 'currentColor', size = 24, title = "cirrusci", ...others}, ref) {
