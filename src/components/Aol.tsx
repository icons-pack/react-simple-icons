...
export type AolProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Aol = React.forwardRef<SVGSVGElement, AolProps>(function Aol({color = 'currentColor', size = 24, title = "aol", ...others}, ref) {
