    ...
    export type HibobProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hibob = React.forwardRef<SVGSVGElement, HibobProps>(function Hibob({color = 'currentColor', size = 24, title = "hibob", ...others}, ref) {
