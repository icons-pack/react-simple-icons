    ...
    export type AntenaThreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const AntenaThree = React.forwardRef<SVGSVGElement, AntenaThreeProps>(function AntenaThree({color = 'currentColor', size = 24, title = "antena3", ...others}, ref) {
