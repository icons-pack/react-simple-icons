    ...
    export type SmartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Smart = React.forwardRef<SVGSVGElement, SmartProps>(function Smart({color = 'currentColor', size = 24, title = "smart", ...others}, ref) {
