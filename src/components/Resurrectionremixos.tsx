    ...
    export type ResurrectionremixosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Resurrectionremixos = React.forwardRef<SVGSVGElement, ResurrectionremixosProps>(function Resurrectionremixos({color = 'currentColor', size = 24, title = "resurrectionremixos", ...others}, ref) {
