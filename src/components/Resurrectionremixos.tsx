...
const Resurrectionremixos = React.forwardRef<SVGSVGElement, IconProps>(function Resurrectionremixos({color = 'currentColor', size = 24, title = "resurrectionremixos", ...others}, ref) {
