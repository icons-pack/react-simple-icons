...
export type BastyonProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bastyon = React.forwardRef<SVGSVGElement, BastyonProps>(function Bastyon({color = 'currentColor', size = 24, title = "bastyon", ...others}, ref) {
