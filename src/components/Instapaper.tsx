    ...
    export type InstapaperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Instapaper = React.forwardRef<SVGSVGElement, InstapaperProps>(function Instapaper({color = 'currentColor', size = 24, title = "instapaper", ...others}, ref) {
