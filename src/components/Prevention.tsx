...
export type PreventionProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Prevention = React.forwardRef<SVGSVGElement, PreventionProps>(function Prevention({color = 'currentColor', size = 24, title = "prevention", ...others}, ref) {
