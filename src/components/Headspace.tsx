...
export type HeadspaceProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Headspace = React.forwardRef<SVGSVGElement, HeadspaceProps>(function Headspace({color = 'currentColor', size = 24, title = "headspace", ...others}, ref) {
