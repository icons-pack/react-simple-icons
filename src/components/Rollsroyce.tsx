    ...
    export type RollsroyceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rollsroyce = React.forwardRef<SVGSVGElement, RollsroyceProps>(function Rollsroyce({color = 'currentColor', size = 24, title = "rollsroyce", ...others}, ref) {
