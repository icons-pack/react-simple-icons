    ...
    export type AsepriteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aseprite = React.forwardRef<SVGSVGElement, AsepriteProps>(function Aseprite({color = 'currentColor', size = 24, title = "aseprite", ...others}, ref) {
