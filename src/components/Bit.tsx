    ...
    export type BitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bit = React.forwardRef<SVGSVGElement, BitProps>(function Bit({color = 'currentColor', size = 24, title = "bit", ...others}, ref) {
