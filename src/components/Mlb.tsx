    ...
    export type MlbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mlb = React.forwardRef<SVGSVGElement, MlbProps>(function Mlb({color = 'currentColor', size = 24, title = "mlb", ...others}, ref) {
