    ...
    export type KiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kia = React.forwardRef<SVGSVGElement, KiaProps>(function Kia({color = 'currentColor', size = 24, title = "kia", ...others}, ref) {
