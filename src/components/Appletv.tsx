    ...
    export type AppletvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Appletv = React.forwardRef<SVGSVGElement, AppletvProps>(function Appletv({color = 'currentColor', size = 24, title = "appletv", ...others}, ref) {
