...
export type TrpcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Trpc = React.forwardRef<SVGSVGElement, TrpcProps>(function Trpc({color = 'currentColor', size = 24, title = "trpc", ...others}, ref) {
