    ...
    export type GradleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gradle = React.forwardRef<SVGSVGElement, GradleProps>(function Gradle({color = 'currentColor', size = 24, title = "gradle", ...others}, ref) {
