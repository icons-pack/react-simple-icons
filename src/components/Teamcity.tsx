    ...
    export type TeamcityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Teamcity = React.forwardRef<SVGSVGElement, TeamcityProps>(function Teamcity({color = 'currentColor', size = 24, title = "teamcity", ...others}, ref) {
