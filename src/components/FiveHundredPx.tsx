    ...
    export type FiveHundredPxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const FiveHundredPx = React.forwardRef<SVGSVGElement, FiveHundredPxProps>(function FiveHundredPx({color = 'currentColor', size = 24, title = "500px", ...others}, ref) {
