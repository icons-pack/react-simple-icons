    ...
    export type ChatbotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Chatbot = React.forwardRef<SVGSVGElement, ChatbotProps>(function Chatbot({color = 'currentColor', size = 24, title = "chatbot", ...others}, ref) {
