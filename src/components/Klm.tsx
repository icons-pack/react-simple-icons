    ...
    export type KlmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Klm = React.forwardRef<SVGSVGElement, KlmProps>(function Klm({color = 'currentColor', size = 24, title = "klm", ...others}, ref) {
