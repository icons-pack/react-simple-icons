    ...
    export type GoogleearthProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googleearth = React.forwardRef<SVGSVGElement, GoogleearthProps>(function Googleearth({color = 'currentColor', size = 24, title = "googleearth", ...others}, ref) {
