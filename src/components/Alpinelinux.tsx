    ...
    export type AlpinelinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Alpinelinux = React.forwardRef<SVGSVGElement, AlpinelinuxProps>(function Alpinelinux({color = 'currentColor', size = 24, title = "alpinelinux", ...others}, ref) {
