...
const Stackedit = React.forwardRef<SVGSVGElement, StackeditProps>(function Stackedit(
  { color = 'currentColor', size = 24, title = 'stackedit', ...others },
  ref,
) {
  return (
    <svg
