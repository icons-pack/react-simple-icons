...
export type IbeaconProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ibeacon = React.forwardRef<SVGSVGElement, IbeaconProps>(function Ibeacon({color = 'currentColor', size = 24, title = "ibeacon", ...others}, ref) {
