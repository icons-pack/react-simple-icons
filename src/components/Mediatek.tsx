    ...
    export type MediatekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mediatek = React.forwardRef<SVGSVGElement, MediatekProps>(function Mediatek({color = 'currentColor', size = 24, title = "mediatek", ...others}, ref) {
