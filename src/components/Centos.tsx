    ...
    export type CentosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Centos = React.forwardRef<SVGSVGElement, CentosProps>(function Centos({color = 'currentColor', size = 24, title = "centos", ...others}, ref) {
