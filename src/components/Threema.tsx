    ...
    export type ThreemaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Threema = React.forwardRef<SVGSVGElement, ThreemaProps>(function Threema({color = 'currentColor', size = 24, title = "threema", ...others}, ref) {
