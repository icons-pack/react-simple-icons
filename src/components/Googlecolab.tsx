    ...
    export type GooglecolabProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlecolab = React.forwardRef<SVGSVGElement, GooglecolabProps>(function Googlecolab({color = 'currentColor', size = 24, title = "googlecolab", ...others}, ref) {
