    ...
    export type DunkedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dunked = React.forwardRef<SVGSVGElement, DunkedProps>(function Dunked({color = 'currentColor', size = 24, title = "dunked", ...others}, ref) {
