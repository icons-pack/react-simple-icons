    ...
    export type ImagejProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Imagej = React.forwardRef<SVGSVGElement, ImagejProps>(function Imagej({color = 'currentColor', size = 24, title = "imagej", ...others}, ref) {
