    ...
    export type VivinoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vivino = React.forwardRef<SVGSVGElement, VivinoProps>(function Vivino({color = 'currentColor', size = 24, title = "vivino", ...others}, ref) {
