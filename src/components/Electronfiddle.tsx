...
export type ElectronfiddleProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Electronfiddle = React.forwardRef<SVGSVGElement, ElectronfiddleProps>(function Electronfiddle({color = 'currentColor', size = 24, title = "electronfiddle", ...others}, ref) {
