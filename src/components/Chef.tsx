...
export type ChefProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Chef = React.forwardRef<SVGSVGElement, ChefProps>(function Chef({color = 'currentColor', size = 24, title = "chef", ...others}, ref) {
