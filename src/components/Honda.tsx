    ...
    export type HondaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Honda = React.forwardRef<SVGSVGElement, HondaProps>(function Honda({color = 'currentColor', size = 24, title = "honda", ...others}, ref) {
