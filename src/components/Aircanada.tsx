...
const Aircanada = React.forwardRef<SVGSVGElement, AircanadaProps>(function Aircanada(
  { color = 'currentColor', size = 24, title = 'aircanada', ...others },
  ref,
) {
  return (
    <svg
