...
export type CbsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cbs = React.forwardRef<SVGSVGElement, CbsProps>(function Cbs({color = 'currentColor', size = 24, title = "cbs", ...others}, ref) {
