    ...
    export type PagerdutyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pagerduty = React.forwardRef<SVGSVGElement, PagerdutyProps>(function Pagerduty({color = 'currentColor', size = 24, title = "pagerduty", ...others}, ref) {
