    ...
    export type RescuetimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rescuetime = React.forwardRef<SVGSVGElement, RescuetimeProps>(function Rescuetime({color = 'currentColor', size = 24, title = "rescuetime", ...others}, ref) {
