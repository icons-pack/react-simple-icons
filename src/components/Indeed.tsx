    ...
    export type IndeedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Indeed = React.forwardRef<SVGSVGElement, IndeedProps>(function Indeed({color = 'currentColor', size = 24, title = "indeed", ...others}, ref) {
