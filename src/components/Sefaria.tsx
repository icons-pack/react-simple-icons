    ...
    export type SefariaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sefaria = React.forwardRef<SVGSVGElement, SefariaProps>(function Sefaria({color = 'currentColor', size = 24, title = "sefaria", ...others}, ref) {
