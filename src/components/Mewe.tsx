    ...
    export type MeweProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mewe = React.forwardRef<SVGSVGElement, MeweProps>(function Mewe({color = 'currentColor', size = 24, title = "mewe", ...others}, ref) {
