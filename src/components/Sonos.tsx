...
export type SonosProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sonos = React.forwardRef<SVGSVGElement, SonosProps>(function Sonos({color = 'currentColor', size = 24, title = "sonos", ...others}, ref) {
