    ...
    export type KdeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kde = React.forwardRef<SVGSVGElement, KdeProps>(function Kde({color = 'currentColor', size = 24, title = "kde", ...others}, ref) {
