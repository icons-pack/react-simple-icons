...
export type WireProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Wire = React.forwardRef<SVGSVGElement, WireProps>(function Wire({color = 'currentColor', size = 24, title = "wire", ...others}, ref) {
