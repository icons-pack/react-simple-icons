    ...
    export type TripdotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tripdotcom = React.forwardRef<SVGSVGElement, TripdotcomProps>(function Tripdotcom({color = 'currentColor', size = 24, title = "tripdotcom", ...others}, ref) {
