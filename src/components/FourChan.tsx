    ...
    export type FourChanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const FourChan = React.forwardRef<SVGSVGElement, FourChanProps>(function FourChan({color = 'currentColor', size = 24, title = "4chan", ...others}, ref) {
