    ...
    export type NorcoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Norco = React.forwardRef<SVGSVGElement, NorcoProps>(function Norco({color = 'currentColor', size = 24, title = "norco", ...others}, ref) {
