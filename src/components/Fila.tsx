    ...
    export type FilaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fila = React.forwardRef<SVGSVGElement, FilaProps>(function Fila({color = 'currentColor', size = 24, title = "fila", ...others}, ref) {
