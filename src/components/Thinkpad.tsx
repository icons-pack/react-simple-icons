    ...
    export type ThinkpadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Thinkpad = React.forwardRef<SVGSVGElement, ThinkpadProps>(function Thinkpad({color = 'currentColor', size = 24, title = "thinkpad", ...others}, ref) {
