...
export type LoopProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Loop = React.forwardRef<SVGSVGElement, LoopProps>(function Loop({color = 'currentColor', size = 24, title = "loop", ...others}, ref) {
