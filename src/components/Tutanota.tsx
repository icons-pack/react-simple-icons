    ...
    export type TutanotaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tutanota = React.forwardRef<SVGSVGElement, TutanotaProps>(function Tutanota({color = 'currentColor', size = 24, title = "tutanota", ...others}, ref) {
