...
const Transportforireland = forwardRef(function Transportforireland(
  { color = 'currentColor', size = 24, title = 'Transport for Ireland', ...others },
  ref
) {
  return (
    <svg
