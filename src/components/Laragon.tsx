...
export type LaragonProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Laragon = React.forwardRef<SVGSVGElement, LaragonProps>(function Laragon({color = 'currentColor', size = 24, title = "laragon", ...others}, ref) {
