...
export type NativescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nativescript = React.forwardRef<SVGSVGElement, NativescriptProps>(function Nativescript({color = 'currentColor', size = 24, title = "nativescript", ...others}, ref) {
