    ...
    const Youtubestudio = React.forwardRef<SVGSVGElement, YoutubestudioProps>(function Youtubestudio({color = 'currentColor', size = 24, title = "youtubestudio", ...others}, ref) {
