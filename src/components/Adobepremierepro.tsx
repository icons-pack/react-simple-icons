...
const Adobepremierepro = React.forwardRef<SVGSVGElement, IconProps>(function Adobepremierepro({color = 'currentColor', size = 24, title = "adobepremierepro", ...others}, ref) {
