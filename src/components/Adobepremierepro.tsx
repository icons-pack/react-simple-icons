...
export type AdobepremiereproProps = {
  /**
...
const Adobepremierepro = React.forwardRef<SVGSVGElement, AdobepremiereproProps>(function Adobepremierepro(
  { color = 'currentColor', size = 24, title = 'adobepremierepro', ...others },
  ref,
) {
  return (
    <svg
