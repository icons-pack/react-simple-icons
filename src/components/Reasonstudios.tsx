...
export type ReasonstudiosProps = {
  /**
...
const Reasonstudios = React.forwardRef<SVGSVGElement, ReasonstudiosProps>(function Reasonstudios(
  { color = 'currentColor', size = 24, title = 'reasonstudios', ...others },
  ref,
) {
  return (
    <svg
