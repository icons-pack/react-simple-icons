...
export type AlltrailsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Alltrails = React.forwardRef<SVGSVGElement, AlltrailsProps>(function Alltrails({color = 'currentColor', size = 24, title = "alltrails", ...others}, ref) {
