...
export type ResharperProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Resharper = React.forwardRef<SVGSVGElement, ResharperProps>(function Resharper({color = 'currentColor', size = 24, title = "resharper", ...others}, ref) {
