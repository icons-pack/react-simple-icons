...
export type ApachedruidProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Apachedruid = React.forwardRef<SVGSVGElement, ApachedruidProps>(function Apachedruid({color = 'currentColor', size = 24, title = "apachedruid", ...others}, ref) {
