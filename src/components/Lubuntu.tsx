    ...
    export type LubuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lubuntu = React.forwardRef<SVGSVGElement, LubuntuProps>(function Lubuntu({color = 'currentColor', size = 24, title = "lubuntu", ...others}, ref) {
