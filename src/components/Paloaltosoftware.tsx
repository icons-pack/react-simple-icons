...
const Paloaltosoftware = React.forwardRef<SVGSVGElement, IconProps>(function Paloaltosoftware({color = 'currentColor', size = 24, title = "paloaltosoftware", ...others}, ref) {
