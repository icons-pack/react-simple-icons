    ...
    export type PaloaltosoftwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Paloaltosoftware = React.forwardRef<SVGSVGElement, PaloaltosoftwareProps>(function Paloaltosoftware({color = 'currentColor', size = 24, title = "paloaltosoftware", ...others}, ref) {
