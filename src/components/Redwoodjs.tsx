    ...
    export type RedwoodjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Redwoodjs = React.forwardRef<SVGSVGElement, RedwoodjsProps>(function Redwoodjs({color = 'currentColor', size = 24, title = "redwoodjs", ...others}, ref) {
