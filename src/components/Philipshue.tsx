    ...
    export type PhilipshueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Philipshue = React.forwardRef<SVGSVGElement, PhilipshueProps>(function Philipshue({color = 'currentColor', size = 24, title = "philipshue", ...others}, ref) {
