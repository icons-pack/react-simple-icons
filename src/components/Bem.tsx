...
export type BemProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bem = React.forwardRef<SVGSVGElement, BemProps>(function Bem({color = 'currentColor', size = 24, title = "bem", ...others}, ref) {
