...
export type FontawesomeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fontawesome = React.forwardRef<SVGSVGElement, FontawesomeProps>(function Fontawesome({color = 'currentColor', size = 24, title = "fontawesome", ...others}, ref) {
