    ...
    export type AdobeillustratorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobeillustrator = React.forwardRef<SVGSVGElement, AdobeillustratorProps>(function Adobeillustrator({color = 'currentColor', size = 24, title = "adobeillustrator", ...others}, ref) {
