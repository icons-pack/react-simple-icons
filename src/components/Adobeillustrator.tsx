...
const Adobeillustrator = React.forwardRef<SVGSVGElement, IconProps>(function Adobeillustrator({color = 'currentColor', size = 24, title = "adobeillustrator", ...others}, ref) {
