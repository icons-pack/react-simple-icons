    ...
    export type RetroarchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Retroarch = React.forwardRef<SVGSVGElement, RetroarchProps>(function Retroarch({color = 'currentColor', size = 24, title = "retroarch", ...others}, ref) {
