    ...
    export type LaravelnovaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Laravelnova = React.forwardRef<SVGSVGElement, LaravelnovaProps>(function Laravelnova({color = 'currentColor', size = 24, title = "laravelnova", ...others}, ref) {
