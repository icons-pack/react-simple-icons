    ...
    export type AdobecreativecloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobecreativecloud = React.forwardRef<SVGSVGElement, AdobecreativecloudProps>(function Adobecreativecloud({color = 'currentColor', size = 24, title = "adobecreativecloud", ...others}, ref) {
