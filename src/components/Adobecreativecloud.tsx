...
const Adobecreativecloud = React.forwardRef<SVGSVGElement, AdobecreativecloudProps>(function Adobecreativecloud(
  { color = 'currentColor', size = 24, title = 'adobecreativecloud', ...others },
  ref,
) {
  return (
    <svg
