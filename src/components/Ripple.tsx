    ...
    export type RippleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ripple = React.forwardRef<SVGSVGElement, RippleProps>(function Ripple({color = 'currentColor', size = 24, title = "ripple", ...others}, ref) {
