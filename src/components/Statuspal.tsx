...
export type StatuspalProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Statuspal = React.forwardRef<SVGSVGElement, StatuspalProps>(function Statuspal({color = 'currentColor', size = 24, title = "statuspal", ...others}, ref) {
