...
export type EpsonProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Epson = React.forwardRef<SVGSVGElement, EpsonProps>(function Epson({color = 'currentColor', size = 24, title = "epson", ...others}, ref) {
