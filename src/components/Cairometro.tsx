...
export type CairometroProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cairometro = React.forwardRef<SVGSVGElement, CairometroProps>(function Cairometro({color = 'currentColor', size = 24, title = "cairometro", ...others}, ref) {
