...
export type HandshakeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Handshake = React.forwardRef<SVGSVGElement, HandshakeProps>(function Handshake({color = 'currentColor', size = 24, title = "handshake", ...others}, ref) {
