...
export type ZdfProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Zdf = React.forwardRef<SVGSVGElement, ZdfProps>(function Zdf({color = 'currentColor', size = 24, title = "zdf", ...others}, ref) {
