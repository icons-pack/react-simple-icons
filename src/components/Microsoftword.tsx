...
export type MicrosoftwordProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Microsoftword = React.forwardRef<SVGSVGElement, MicrosoftwordProps>(function Microsoftword({color = 'currentColor', size = 24, title = "microsoftword", ...others}, ref) {
