...
export type GooglecalendarProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Googlecalendar = React.forwardRef<SVGSVGElement, GooglecalendarProps>(function Googlecalendar({color = 'currentColor', size = 24, title = "googlecalendar", ...others}, ref) {
