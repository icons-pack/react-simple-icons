...
const Apacheopenoffice = React.forwardRef<SVGSVGElement, IconProps>(function Apacheopenoffice({color = 'currentColor', size = 24, title = "apacheopenoffice", ...others}, ref) {
