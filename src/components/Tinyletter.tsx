    ...
    export type TinyletterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tinyletter = React.forwardRef<SVGSVGElement, TinyletterProps>(function Tinyletter({color = 'currentColor', size = 24, title = "tinyletter", ...others}, ref) {
