    ...
    export type BitlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bitly = React.forwardRef<SVGSVGElement, BitlyProps>(function Bitly({color = 'currentColor', size = 24, title = "bitly", ...others}, ref) {
