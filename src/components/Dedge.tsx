    ...
    export type DedgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dedge = React.forwardRef<SVGSVGElement, DedgeProps>(function Dedge({color = 'currentColor', size = 24, title = "dedge", ...others}, ref) {
