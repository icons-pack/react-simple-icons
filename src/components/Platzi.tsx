    ...
    export type PlatziProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Platzi = React.forwardRef<SVGSVGElement, PlatziProps>(function Platzi({color = 'currentColor', size = 24, title = "platzi", ...others}, ref) {
