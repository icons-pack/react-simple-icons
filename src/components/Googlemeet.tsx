...
export type GooglemeetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Googlemeet = React.forwardRef<SVGSVGElement, GooglemeetProps>(function Googlemeet({color = 'currentColor', size = 24, title = "googlemeet", ...others}, ref) {
