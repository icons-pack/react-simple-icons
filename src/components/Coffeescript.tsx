    ...
    export type CoffeescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Coffeescript = React.forwardRef<SVGSVGElement, CoffeescriptProps>(function Coffeescript({color = 'currentColor', size = 24, title = "coffeescript", ...others}, ref) {
