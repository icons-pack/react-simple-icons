...
const Tryitonline = React.forwardRef<SVGSVGElement, TryitonlineProps>(function Tryitonline(
  { color = 'currentColor', size = 24, title = 'tryitonline', ...others },
  ref,
) {
  return (
    <svg
