...
export type ArtstationProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Artstation = React.forwardRef<SVGSVGElement, ArtstationProps>(function Artstation({color = 'currentColor', size = 24, title = "artstation", ...others}, ref) {
