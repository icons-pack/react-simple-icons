    ...
    export type NewbalanceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Newbalance = React.forwardRef<SVGSVGElement, NewbalanceProps>(function Newbalance({color = 'currentColor', size = 24, title = "newbalance", ...others}, ref) {
