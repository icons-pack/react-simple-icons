...
export type TsnodeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Tsnode = React.forwardRef<SVGSVGElement, TsnodeProps>(function Tsnode({color = 'currentColor', size = 24, title = "tsnode", ...others}, ref) {
