    ...
    export type FreelancerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Freelancer = React.forwardRef<SVGSVGElement, FreelancerProps>(function Freelancer({color = 'currentColor', size = 24, title = "freelancer", ...others}, ref) {
