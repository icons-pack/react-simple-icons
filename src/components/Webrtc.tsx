...
export type WebrtcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Webrtc = React.forwardRef<SVGSVGElement, WebrtcProps>(function Webrtc({color = 'currentColor', size = 24, title = "webrtc", ...others}, ref) {
