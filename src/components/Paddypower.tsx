    ...
    export type PaddypowerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Paddypower = React.forwardRef<SVGSVGElement, PaddypowerProps>(function Paddypower({color = 'currentColor', size = 24, title = "paddypower", ...others}, ref) {
