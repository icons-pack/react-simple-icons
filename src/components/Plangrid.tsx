...
export type PlangridProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Plangrid = React.forwardRef<SVGSVGElement, PlangridProps>(function Plangrid({color = 'currentColor', size = 24, title = "plangrid", ...others}, ref) {
