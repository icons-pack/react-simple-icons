    ...
    export type PingdomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pingdom = React.forwardRef<SVGSVGElement, PingdomProps>(function Pingdom({color = 'currentColor', size = 24, title = "pingdom", ...others}, ref) {
