    ...
    export type AdafruitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adafruit = React.forwardRef<SVGSVGElement, AdafruitProps>(function Adafruit({color = 'currentColor', size = 24, title = "adafruit", ...others}, ref) {
