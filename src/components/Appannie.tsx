    ...
    export type AppannieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Appannie = React.forwardRef<SVGSVGElement, AppannieProps>(function Appannie({color = 'currentColor', size = 24, title = "appannie", ...others}, ref) {
