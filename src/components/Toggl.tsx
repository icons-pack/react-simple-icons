    ...
    export type TogglProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Toggl = React.forwardRef<SVGSVGElement, TogglProps>(function Toggl({color = 'currentColor', size = 24, title = "toggl", ...others}, ref) {
