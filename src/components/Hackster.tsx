    ...
    export type HacksterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hackster = React.forwardRef<SVGSVGElement, HacksterProps>(function Hackster({color = 'currentColor', size = 24, title = "hackster", ...others}, ref) {
