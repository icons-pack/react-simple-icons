...
export type KirbyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Kirby = React.forwardRef<SVGSVGElement, KirbyProps>(function Kirby({color = 'currentColor', size = 24, title = "kirby", ...others}, ref) {
