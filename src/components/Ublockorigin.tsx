...
export type UblockoriginProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ublockorigin = React.forwardRef<SVGSVGElement, UblockoriginProps>(function Ublockorigin({color = 'currentColor', size = 24, title = "ublockorigin", ...others}, ref) {
