...
const Nintendonetwork = React.forwardRef<SVGSVGElement, NintendonetworkProps>(function Nintendonetwork(
  { color = 'currentColor', size = 24, title = 'nintendonetwork', ...others },
  ref,
) {
  return (
    <svg
