...
const Angularjs = React.forwardRef<SVGSVGElement, AngularjsProps>(function Angularjs(
  { color = 'currentColor', size = 24, title = 'angularjs', ...others },
  ref,
) {
  return (
    <svg
