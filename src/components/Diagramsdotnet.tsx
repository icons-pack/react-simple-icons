...
export type DiagramsdotnetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Diagramsdotnet = React.forwardRef<SVGSVGElement, DiagramsdotnetProps>(function Diagramsdotnet({color = 'currentColor', size = 24, title = "diagramsdotnet", ...others}, ref) {
