    ...
    export type PantheonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pantheon = React.forwardRef<SVGSVGElement, PantheonProps>(function Pantheon({color = 'currentColor', size = 24, title = "pantheon", ...others}, ref) {
