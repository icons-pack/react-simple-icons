    ...
    export type DgraphProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dgraph = React.forwardRef<SVGSVGElement, DgraphProps>(function Dgraph({color = 'currentColor', size = 24, title = "dgraph", ...others}, ref) {
