    ...
    export type WasmcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wasmcloud = React.forwardRef<SVGSVGElement, WasmcloudProps>(function Wasmcloud({color = 'currentColor', size = 24, title = "wasmcloud", ...others}, ref) {
