    ...
    export type PumaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Puma = React.forwardRef<SVGSVGElement, PumaProps>(function Puma({color = 'currentColor', size = 24, title = "puma", ...others}, ref) {
