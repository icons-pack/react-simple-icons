    ...
    export type HackerearthProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hackerearth = React.forwardRef<SVGSVGElement, HackerearthProps>(function Hackerearth({color = 'currentColor', size = 24, title = "hackerearth", ...others}, ref) {
