...
const Googlemarketingplatform = React.forwardRef<SVGSVGElement, IconProps>(function Googlemarketingplatform({color = 'currentColor', size = 24, title = "googlemarketingplatform", ...others}, ref) {
