...
export type GooglemarketingplatformProps = {
  /**
...
const Googlemarketingplatform = React.forwardRef<SVGSVGElement, GooglemarketingplatformProps>(
  function Googlemarketingplatform(
    { color = 'currentColor', size = 24, title = 'googlemarketingplatform', ...others },
    ref,
  ) {
    return (
      <svg
