...
export type ZyteProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Zyte = React.forwardRef<SVGSVGElement, ZyteProps>(function Zyte({color = 'currentColor', size = 24, title = "zyte", ...others}, ref) {
