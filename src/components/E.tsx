    ...
    export type EProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const E = React.forwardRef<SVGSVGElement, EProps>(function E({color = 'currentColor', size = 24, title = "e", ...others}, ref) {
