    ...
    export type CypressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cypress = React.forwardRef<SVGSVGElement, CypressProps>(function Cypress({color = 'currentColor', size = 24, title = "cypress", ...others}, ref) {
