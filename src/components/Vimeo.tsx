...
export type VimeoProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Vimeo = React.forwardRef<SVGSVGElement, VimeoProps>(function Vimeo({color = 'currentColor', size = 24, title = "vimeo", ...others}, ref) {
