    ...
    export type EventstoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Eventstore = React.forwardRef<SVGSVGElement, EventstoreProps>(function Eventstore({color = 'currentColor', size = 24, title = "eventstore", ...others}, ref) {
