    ...
    export type SpyderideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Spyderide = React.forwardRef<SVGSVGElement, SpyderideProps>(function Spyderide({color = 'currentColor', size = 24, title = "spyderide", ...others}, ref) {
