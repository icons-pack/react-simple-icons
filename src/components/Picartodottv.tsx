    ...
    export type PicartodottvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Picartodottv = React.forwardRef<SVGSVGElement, PicartodottvProps>(function Picartodottv({color = 'currentColor', size = 24, title = "picartodottv", ...others}, ref) {
