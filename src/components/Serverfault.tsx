    ...
    export type ServerfaultProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Serverfault = React.forwardRef<SVGSVGElement, ServerfaultProps>(function Serverfault({color = 'currentColor', size = 24, title = "serverfault", ...others}, ref) {
