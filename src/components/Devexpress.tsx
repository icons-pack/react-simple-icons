...
const Devexpress = React.forwardRef<SVGSVGElement, DevexpressProps>(function Devexpress(
  { color = 'currentColor', size = 24, title = 'devexpress', ...others },
  ref,
) {
  return (
    <svg
