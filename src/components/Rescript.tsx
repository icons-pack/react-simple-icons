...
export type RescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Rescript = React.forwardRef<SVGSVGElement, RescriptProps>(function Rescript({color = 'currentColor', size = 24, title = "rescript", ...others}, ref) {
