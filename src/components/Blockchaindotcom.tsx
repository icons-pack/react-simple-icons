...
const Blockchaindotcom = React.forwardRef<SVGSVGElement, IconProps>(function Blockchaindotcom({color = 'currentColor', size = 24, title = "blockchaindotcom", ...others}, ref) {
