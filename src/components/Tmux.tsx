    ...
    export type TmuxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tmux = React.forwardRef<SVGSVGElement, TmuxProps>(function Tmux({color = 'currentColor', size = 24, title = "tmux", ...others}, ref) {
