    ...
    export type CodenewbieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codenewbie = React.forwardRef<SVGSVGElement, CodenewbieProps>(function Codenewbie({color = 'currentColor', size = 24, title = "codenewbie", ...others}, ref) {
