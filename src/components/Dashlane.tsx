    ...
    export type DashlaneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dashlane = React.forwardRef<SVGSVGElement, DashlaneProps>(function Dashlane({color = 'currentColor', size = 24, title = "dashlane", ...others}, ref) {
