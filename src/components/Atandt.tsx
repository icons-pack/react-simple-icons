...
export type AtandtProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Atandt = React.forwardRef<SVGSVGElement, AtandtProps>(function Atandt({color = 'currentColor', size = 24, title = "atandt", ...others}, ref) {
