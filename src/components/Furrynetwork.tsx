    ...
    export type FurrynetworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Furrynetwork = React.forwardRef<SVGSVGElement, FurrynetworkProps>(function Furrynetwork({color = 'currentColor', size = 24, title = "furrynetwork", ...others}, ref) {
