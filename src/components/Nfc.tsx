...
export type NfcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nfc = React.forwardRef<SVGSVGElement, NfcProps>(function Nfc({color = 'currentColor', size = 24, title = "nfc", ...others}, ref) {
