    ...
    export type WarpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Warp = React.forwardRef<SVGSVGElement, WarpProps>(function Warp({color = 'currentColor', size = 24, title = "warp", ...others}, ref) {
