    ...
    export type KenticoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kentico = React.forwardRef<SVGSVGElement, KenticoProps>(function Kentico({color = 'currentColor', size = 24, title = "kentico", ...others}, ref) {
