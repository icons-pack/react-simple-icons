...
export type JpegProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Jpeg = React.forwardRef<SVGSVGElement, JpegProps>(function Jpeg({color = 'currentColor', size = 24, title = "jpeg", ...others}, ref) {
