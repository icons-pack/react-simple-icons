    ...
    export type HyundaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hyundai = React.forwardRef<SVGSVGElement, HyundaiProps>(function Hyundai({color = 'currentColor', size = 24, title = "hyundai", ...others}, ref) {
