    ...
    export type WolframmathematicaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wolframmathematica = React.forwardRef<SVGSVGElement, WolframmathematicaProps>(function Wolframmathematica({color = 'currentColor', size = 24, title = "wolframmathematica", ...others}, ref) {
