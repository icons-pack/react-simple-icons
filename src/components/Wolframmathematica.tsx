...
const Wolframmathematica = React.forwardRef<SVGSVGElement, IconProps>(function Wolframmathematica({color = 'currentColor', size = 24, title = "wolframmathematica", ...others}, ref) {
