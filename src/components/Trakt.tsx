    ...
    export type TraktProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Trakt = React.forwardRef<SVGSVGElement, TraktProps>(function Trakt({color = 'currentColor', size = 24, title = "trakt", ...others}, ref) {
