    ...
    export type BigcommerceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bigcommerce = React.forwardRef<SVGSVGElement, BigcommerceProps>(function Bigcommerce({color = 'currentColor', size = 24, title = "bigcommerce", ...others}, ref) {
