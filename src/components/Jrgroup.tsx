...
export type JrgroupProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Jrgroup = React.forwardRef<SVGSVGElement, JrgroupProps>(function Jrgroup({color = 'currentColor', size = 24, title = "jrgroup", ...others}, ref) {
