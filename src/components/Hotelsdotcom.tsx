    ...
    export type HotelsdotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hotelsdotcom = React.forwardRef<SVGSVGElement, HotelsdotcomProps>(function Hotelsdotcom({color = 'currentColor', size = 24, title = "hotelsdotcom", ...others}, ref) {
