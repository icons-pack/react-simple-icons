    ...
    export type RubysinatraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rubysinatra = React.forwardRef<SVGSVGElement, RubysinatraProps>(function Rubysinatra({color = 'currentColor', size = 24, title = "rubysinatra", ...others}, ref) {
