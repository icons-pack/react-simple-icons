...
export type UberProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Uber = React.forwardRef<SVGSVGElement, UberProps>(function Uber({color = 'currentColor', size = 24, title = "uber", ...others}, ref) {
