    ...
    export type FortinetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fortinet = React.forwardRef<SVGSVGElement, FortinetProps>(function Fortinet({color = 'currentColor', size = 24, title = "fortinet", ...others}, ref) {
