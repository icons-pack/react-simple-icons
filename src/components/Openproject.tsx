    ...
    export type OpenprojectProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Openproject = React.forwardRef<SVGSVGElement, OpenprojectProps>(function Openproject({color = 'currentColor', size = 24, title = "openproject", ...others}, ref) {
