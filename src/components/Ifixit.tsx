    ...
    export type IfixitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ifixit = React.forwardRef<SVGSVGElement, IfixitProps>(function Ifixit({color = 'currentColor', size = 24, title = "ifixit", ...others}, ref) {
