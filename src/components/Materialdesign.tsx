    ...
    export type MaterialdesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Materialdesign = React.forwardRef<SVGSVGElement, MaterialdesignProps>(function Materialdesign({color = 'currentColor', size = 24, title = "materialdesign", ...others}, ref) {
