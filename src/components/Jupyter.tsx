    ...
    export type JupyterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jupyter = React.forwardRef<SVGSVGElement, JupyterProps>(function Jupyter({color = 'currentColor', size = 24, title = "jupyter", ...others}, ref) {
