...
export type FourDProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const FourD = React.forwardRef<SVGSVGElement, FourDProps>(function FourD({color = 'currentColor', size = 24, title = "4d", ...others}, ref) {
