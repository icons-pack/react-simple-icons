    ...
    export type SourcegraphProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sourcegraph = React.forwardRef<SVGSVGElement, SourcegraphProps>(function Sourcegraph({color = 'currentColor', size = 24, title = "sourcegraph", ...others}, ref) {
