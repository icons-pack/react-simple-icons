    ...
    export type SemanticreleaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Semanticrelease = React.forwardRef<SVGSVGElement, SemanticreleaseProps>(function Semanticrelease({color = 'currentColor', size = 24, title = "semanticrelease", ...others}, ref) {
