    ...
    export type GoogleadsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googleadsense = React.forwardRef<SVGSVGElement, GoogleadsenseProps>(function Googleadsense({color = 'currentColor', size = 24, title = "googleadsense", ...others}, ref) {
