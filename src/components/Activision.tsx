    ...
    export type ActivisionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Activision = React.forwardRef<SVGSVGElement, ActivisionProps>(function Activision({color = 'currentColor', size = 24, title = "activision", ...others}, ref) {
