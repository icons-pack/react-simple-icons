    ...
    export type SteemProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Steem = React.forwardRef<SVGSVGElement, SteemProps>(function Steem({color = 'currentColor', size = 24, title = "steem", ...others}, ref) {
