    ...
    export type XeroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Xero = React.forwardRef<SVGSVGElement, XeroProps>(function Xero({color = 'currentColor', size = 24, title = "xero", ...others}, ref) {
