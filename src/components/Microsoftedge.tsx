    ...
    export type MicrosoftedgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftedge = React.forwardRef<SVGSVGElement, MicrosoftedgeProps>(function Microsoftedge({color = 'currentColor', size = 24, title = "microsoftedge", ...others}, ref) {
