    ...
    export type NissanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nissan = React.forwardRef<SVGSVGElement, NissanProps>(function Nissan({color = 'currentColor', size = 24, title = "nissan", ...others}, ref) {
