...
export type KonamiProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Konami = React.forwardRef<SVGSVGElement, KonamiProps>(function Konami({color = 'currentColor', size = 24, title = "konami", ...others}, ref) {
