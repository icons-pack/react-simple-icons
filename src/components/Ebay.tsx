    ...
    export type EbayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ebay = React.forwardRef<SVGSVGElement, EbayProps>(function Ebay({color = 'currentColor', size = 24, title = "ebay", ...others}, ref) {
