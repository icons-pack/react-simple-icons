    ...
    export type ElasticcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Elasticcloud = React.forwardRef<SVGSVGElement, ElasticcloudProps>(function Elasticcloud({color = 'currentColor', size = 24, title = "elasticcloud", ...others}, ref) {
