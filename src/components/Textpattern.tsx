...
export type TextpatternProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Textpattern = React.forwardRef<SVGSVGElement, TextpatternProps>(function Textpattern({color = 'currentColor', size = 24, title = "textpattern", ...others}, ref) {
