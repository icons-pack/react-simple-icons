    ...
    export type JetpackcomposeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jetpackcompose = React.forwardRef<SVGSVGElement, JetpackcomposeProps>(function Jetpackcompose({color = 'currentColor', size = 24, title = "jetpackcompose", ...others}, ref) {
