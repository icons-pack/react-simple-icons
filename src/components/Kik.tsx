...
export type KikProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Kik = React.forwardRef<SVGSVGElement, KikProps>(function Kik({color = 'currentColor', size = 24, title = "kik", ...others}, ref) {
