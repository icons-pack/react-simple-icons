    ...
    export type AutomatticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Automattic = React.forwardRef<SVGSVGElement, AutomatticProps>(function Automattic({color = 'currentColor', size = 24, title = "automattic", ...others}, ref) {
