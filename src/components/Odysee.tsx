    ...
    export type OdyseeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Odysee = React.forwardRef<SVGSVGElement, OdyseeProps>(function Odysee({color = 'currentColor', size = 24, title = "odysee", ...others}, ref) {
