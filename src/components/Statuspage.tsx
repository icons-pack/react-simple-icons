    ...
    export type StatuspageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Statuspage = React.forwardRef<SVGSVGElement, StatuspageProps>(function Statuspage({color = 'currentColor', size = 24, title = "statuspage", ...others}, ref) {
