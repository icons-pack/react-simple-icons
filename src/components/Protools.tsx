    ...
    export type ProtoolsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Protools = React.forwardRef<SVGSVGElement, ProtoolsProps>(function Protools({color = 'currentColor', size = 24, title = "protools", ...others}, ref) {
