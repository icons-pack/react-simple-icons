    ...
    export type AgoraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Agora = React.forwardRef<SVGSVGElement, AgoraProps>(function Agora({color = 'currentColor', size = 24, title = "agora", ...others}, ref) {
