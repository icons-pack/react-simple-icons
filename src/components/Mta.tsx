    ...
    export type MtaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mta = React.forwardRef<SVGSVGElement, MtaProps>(function Mta({color = 'currentColor', size = 24, title = "mta", ...others}, ref) {
