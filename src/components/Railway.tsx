...
export type RailwayProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Railway = React.forwardRef<SVGSVGElement, RailwayProps>(function Railway({color = 'currentColor', size = 24, title = "railway", ...others}, ref) {
