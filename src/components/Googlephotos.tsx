    ...
    export type GooglephotosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlephotos = React.forwardRef<SVGSVGElement, GooglephotosProps>(function Googlephotos({color = 'currentColor', size = 24, title = "googlephotos", ...others}, ref) {
