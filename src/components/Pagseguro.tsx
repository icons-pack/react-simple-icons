...
export type PagseguroProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Pagseguro = React.forwardRef<SVGSVGElement, PagseguroProps>(function Pagseguro({color = 'currentColor', size = 24, title = "pagseguro", ...others}, ref) {
