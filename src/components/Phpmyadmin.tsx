    ...
    export type PhpmyadminProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Phpmyadmin = React.forwardRef<SVGSVGElement, PhpmyadminProps>(function Phpmyadmin({color = 'currentColor', size = 24, title = "phpmyadmin", ...others}, ref) {
