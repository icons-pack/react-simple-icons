...
const Framework7 = React.forwardRef<SVGSVGElement, Framework7Props>(function Framework7(
  { color = 'currentColor', size = 24, title = 'framework7', ...others },
  ref,
) {
  return (
    <svg
