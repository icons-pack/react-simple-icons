    ...
    export type FathomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fathom = React.forwardRef<SVGSVGElement, FathomProps>(function Fathom({color = 'currentColor', size = 24, title = "fathom", ...others}, ref) {
