...
export type HoppscotchProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Hoppscotch = React.forwardRef<SVGSVGElement, HoppscotchProps>(function Hoppscotch({color = 'currentColor', size = 24, title = "hoppscotch", ...others}, ref) {
