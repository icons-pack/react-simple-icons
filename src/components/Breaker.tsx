    ...
    export type BreakerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Breaker = React.forwardRef<SVGSVGElement, BreakerProps>(function Breaker({color = 'currentColor', size = 24, title = "breaker", ...others}, ref) {
