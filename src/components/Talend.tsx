...
export type TalendProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Talend = React.forwardRef<SVGSVGElement, TalendProps>(function Talend({color = 'currentColor', size = 24, title = "talend", ...others}, ref) {
