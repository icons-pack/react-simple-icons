    ...
    export type GrouponProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Groupon = React.forwardRef<SVGSVGElement, GrouponProps>(function Groupon({color = 'currentColor', size = 24, title = "groupon", ...others}, ref) {
