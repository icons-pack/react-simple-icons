    ...
    export type InstatusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Instatus = React.forwardRef<SVGSVGElement, InstatusProps>(function Instatus({color = 'currentColor', size = 24, title = "instatus", ...others}, ref) {
