...
export type SpringsecurityProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Springsecurity = React.forwardRef<SVGSVGElement, SpringsecurityProps>(function Springsecurity({color = 'currentColor', size = 24, title = "springsecurity", ...others}, ref) {
