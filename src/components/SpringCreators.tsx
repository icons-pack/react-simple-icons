    ...
    const SpringCreators = React.forwardRef<SVGSVGElement, SpringCreatorsProps>(function SpringCreators({color = 'currentColor', size = 24, title = "spring_creators", ...others}, ref) {
