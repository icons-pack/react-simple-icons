    ...
    export type BlazemeterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Blazemeter = React.forwardRef<SVGSVGElement, BlazemeterProps>(function Blazemeter({color = 'currentColor', size = 24, title = "blazemeter", ...others}, ref) {
