...
const Hurriyetemlak = React.forwardRef<SVGSVGElement, HurriyetemlakProps>(function Hurriyetemlak({color = 'currentColor', size = 24, title = "hurriyetemlak", ...others}, ref) {
