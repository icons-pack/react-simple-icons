    ...
    export type KofaxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kofax = React.forwardRef<SVGSVGElement, KofaxProps>(function Kofax({color = 'currentColor', size = 24, title = "kofax", ...others}, ref) {
