...
const Kinopoisk = React.forwardRef<SVGSVGElement, KinopoiskProps>(function Kinopoisk(
  { color = 'currentColor', size = 24, title = 'kinopoisk', ...others },
  ref,
) {
  return (
    <svg
