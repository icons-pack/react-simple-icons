    ...
    export type WesterndigitalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Westerndigital = React.forwardRef<SVGSVGElement, WesterndigitalProps>(function Westerndigital({color = 'currentColor', size = 24, title = "westerndigital", ...others}, ref) {
