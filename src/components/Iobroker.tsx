    ...
    export type IobrokerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Iobroker = React.forwardRef<SVGSVGElement, IobrokerProps>(function Iobroker({color = 'currentColor', size = 24, title = "iobroker", ...others}, ref) {
