    ...
    export type SurveymonkeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Surveymonkey = React.forwardRef<SVGSVGElement, SurveymonkeyProps>(function Surveymonkey({color = 'currentColor', size = 24, title = "surveymonkey", ...others}, ref) {
