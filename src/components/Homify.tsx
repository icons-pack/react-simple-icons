...
export type HomifyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Homify = React.forwardRef<SVGSVGElement, HomifyProps>(function Homify({color = 'currentColor', size = 24, title = "homify", ...others}, ref) {
