    ...
    export type ZelleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zelle = React.forwardRef<SVGSVGElement, ZelleProps>(function Zelle({color = 'currentColor', size = 24, title = "zelle", ...others}, ref) {
