...
export type FoodpandaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Foodpanda = React.forwardRef<SVGSVGElement, FoodpandaProps>(function Foodpanda({color = 'currentColor', size = 24, title = "foodpanda", ...others}, ref) {
