    ...
    export type QtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Qt = React.forwardRef<SVGSVGElement, QtProps>(function Qt({color = 'currentColor', size = 24, title = "qt", ...others}, ref) {
