    ...
    export type AirasiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Airasia = React.forwardRef<SVGSVGElement, AirasiaProps>(function Airasia({color = 'currentColor', size = 24, title = "airasia", ...others}, ref) {
