    ...
    export type VaadinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vaadin = React.forwardRef<SVGSVGElement, VaadinProps>(function Vaadin({color = 'currentColor', size = 24, title = "vaadin", ...others}, ref) {
