    ...
    export type PersonioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Personio = React.forwardRef<SVGSVGElement, PersonioProps>(function Personio({color = 'currentColor', size = 24, title = "personio", ...others}, ref) {
