...
export type BeijingsubwayProps = {
  /**
...
const Beijingsubway = React.forwardRef<SVGSVGElement, BeijingsubwayProps>(function Beijingsubway(
  { color = 'currentColor', size = 24, title = 'beijingsubway', ...others },
  ref,
) {
  return (
    <svg
