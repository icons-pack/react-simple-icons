    ...
    export type PocketbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pocketbase = React.forwardRef<SVGSVGElement, PocketbaseProps>(function Pocketbase({color = 'currentColor', size = 24, title = "pocketbase", ...others}, ref) {
