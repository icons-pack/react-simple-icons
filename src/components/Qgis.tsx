    ...
    export type QgisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Qgis = React.forwardRef<SVGSVGElement, QgisProps>(function Qgis({color = 'currentColor', size = 24, title = "qgis", ...others}, ref) {
