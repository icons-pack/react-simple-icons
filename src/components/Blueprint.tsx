...
export type BlueprintProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Blueprint = React.forwardRef<SVGSVGElement, BlueprintProps>(function Blueprint({color = 'currentColor', size = 24, title = "blueprint", ...others}, ref) {
