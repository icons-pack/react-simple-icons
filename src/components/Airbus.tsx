    ...
    export type AirbusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Airbus = React.forwardRef<SVGSVGElement, AirbusProps>(function Airbus({color = 'currentColor', size = 24, title = "airbus", ...others}, ref) {
