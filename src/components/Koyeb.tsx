    ...
    export type KoyebProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Koyeb = React.forwardRef<SVGSVGElement, KoyebProps>(function Koyeb({color = 'currentColor', size = 24, title = "koyeb", ...others}, ref) {
