    ...
    export type RosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ros = React.forwardRef<SVGSVGElement, RosProps>(function Ros({color = 'currentColor', size = 24, title = "ros", ...others}, ref) {
