    ...
    export type LidlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lidl = React.forwardRef<SVGSVGElement, LidlProps>(function Lidl({color = 'currentColor', size = 24, title = "lidl", ...others}, ref) {
