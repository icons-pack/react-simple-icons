...
export type PycharmProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Pycharm = React.forwardRef<SVGSVGElement, PycharmProps>(function Pycharm({color = 'currentColor', size = 24, title = "pycharm", ...others}, ref) {
