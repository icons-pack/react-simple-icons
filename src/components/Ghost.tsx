    ...
    export type GhostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ghost = React.forwardRef<SVGSVGElement, GhostProps>(function Ghost({color = 'currentColor', size = 24, title = "ghost", ...others}, ref) {
