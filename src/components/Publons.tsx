    ...
    export type PublonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Publons = React.forwardRef<SVGSVGElement, PublonsProps>(function Publons({color = 'currentColor', size = 24, title = "publons", ...others}, ref) {
