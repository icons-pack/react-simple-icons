...
const Amazonalexa = React.forwardRef<SVGSVGElement, AmazonalexaProps>(function Amazonalexa(
  { color = 'currentColor', size = 24, title = 'amazonalexa', ...others },
  ref,
) {
  return (
    <svg
