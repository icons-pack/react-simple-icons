    ...
    export type SumologicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sumologic = React.forwardRef<SVGSVGElement, SumologicProps>(function Sumologic({color = 'currentColor', size = 24, title = "sumologic", ...others}, ref) {
