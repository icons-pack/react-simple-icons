...
export type HeadlessuiProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Headlessui = React.forwardRef<SVGSVGElement, HeadlessuiProps>(function Headlessui({color = 'currentColor', size = 24, title = "headlessui", ...others}, ref) {
