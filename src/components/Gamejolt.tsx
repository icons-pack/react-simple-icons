    ...
    export type GamejoltProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gamejolt = React.forwardRef<SVGSVGElement, GamejoltProps>(function Gamejolt({color = 'currentColor', size = 24, title = "gamejolt", ...others}, ref) {
