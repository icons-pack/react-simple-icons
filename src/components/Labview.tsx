    ...
    export type LabviewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Labview = React.forwardRef<SVGSVGElement, LabviewProps>(function Labview({color = 'currentColor', size = 24, title = "labview", ...others}, ref) {
