    ...
    export type CoinmarketcapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Coinmarketcap = React.forwardRef<SVGSVGElement, CoinmarketcapProps>(function Coinmarketcap({color = 'currentColor', size = 24, title = "coinmarketcap", ...others}, ref) {
