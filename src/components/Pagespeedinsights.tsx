...
export type PagespeedinsightsProps = {
  /**
...
const Pagespeedinsights = React.forwardRef<SVGSVGElement, PagespeedinsightsProps>(function Pagespeedinsights(
  { color = 'currentColor', size = 24, title = 'pagespeedinsights', ...others },
  ref,
) {
  return (
    <svg
