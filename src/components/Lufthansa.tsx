    ...
    export type LufthansaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lufthansa = React.forwardRef<SVGSVGElement, LufthansaProps>(function Lufthansa({color = 'currentColor', size = 24, title = "lufthansa", ...others}, ref) {
