...
export type WeblateProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Weblate = React.forwardRef<SVGSVGElement, WeblateProps>(function Weblate({color = 'currentColor', size = 24, title = "weblate", ...others}, ref) {
