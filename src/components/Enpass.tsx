...
export type EnpassProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Enpass = React.forwardRef<SVGSVGElement, EnpassProps>(function Enpass({color = 'currentColor', size = 24, title = "enpass", ...others}, ref) {
