    ...
    export type VeritasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Veritas = React.forwardRef<SVGSVGElement, VeritasProps>(function Veritas({color = 'currentColor', size = 24, title = "veritas", ...others}, ref) {
