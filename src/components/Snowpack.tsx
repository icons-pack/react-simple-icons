...
const Snowpack = React.forwardRef<SVGSVGElement, SnowpackProps>(function Snowpack(
  { color = 'currentColor', size = 24, title = 'snowpack', ...others },
  ref,
) {
  return (
    <svg
