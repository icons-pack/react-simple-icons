    ...
    export type FedexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fedex = React.forwardRef<SVGSVGElement, FedexProps>(function Fedex({color = 'currentColor', size = 24, title = "fedex", ...others}, ref) {
