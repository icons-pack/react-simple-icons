...
const Transportforireland = React.forwardRef<SVGSVGElement, IconProps>(function Transportforireland({color = 'currentColor', size = 24, title = "transportforireland", ...others}, ref) {
