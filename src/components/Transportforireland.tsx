...
export type TransportforirelandProps = {
  /**
...
const Transportforireland = React.forwardRef<SVGSVGElement, TransportforirelandProps>(function Transportforireland(
  { color = 'currentColor', size = 24, title = 'transportforireland', ...others },
  ref,
) {
  return (
    <svg
