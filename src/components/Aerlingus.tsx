    ...
    export type AerlingusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aerlingus = React.forwardRef<SVGSVGElement, AerlingusProps>(function Aerlingus({color = 'currentColor', size = 24, title = "aerlingus", ...others}, ref) {
