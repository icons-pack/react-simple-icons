...
const Googletagmanager = React.forwardRef<SVGSVGElement, IconProps>(function Googletagmanager({color = 'currentColor', size = 24, title = "googletagmanager", ...others}, ref) {
