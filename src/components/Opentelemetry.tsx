    ...
    export type OpentelemetryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Opentelemetry = React.forwardRef<SVGSVGElement, OpentelemetryProps>(function Opentelemetry({color = 'currentColor', size = 24, title = "opentelemetry", ...others}, ref) {
