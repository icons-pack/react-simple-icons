...
export type MochaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mocha = React.forwardRef<SVGSVGElement, MochaProps>(function Mocha({color = 'currentColor', size = 24, title = "mocha", ...others}, ref) {
