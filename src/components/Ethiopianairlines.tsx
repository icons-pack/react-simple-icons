...
const Ethiopianairlines = React.forwardRef<SVGSVGElement, IconProps>(function Ethiopianairlines({color = 'currentColor', size = 24, title = "ethiopianairlines", ...others}, ref) {
