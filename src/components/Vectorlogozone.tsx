...
const Vectorlogozone = React.forwardRef<SVGSVGElement, VectorlogozoneProps>(function Vectorlogozone({color = 'currentColor', size = 24, title = "vectorlogozone", ...others}, ref) {
