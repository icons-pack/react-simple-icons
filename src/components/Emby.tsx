    ...
    export type EmbyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Emby = React.forwardRef<SVGSVGElement, EmbyProps>(function Emby({color = 'currentColor', size = 24, title = "emby", ...others}, ref) {
