    ...
    export type FreedesktopdotorgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Freedesktopdotorg = React.forwardRef<SVGSVGElement, FreedesktopdotorgProps>(function Freedesktopdotorg({color = 'currentColor', size = 24, title = "freedesktopdotorg", ...others}, ref) {
