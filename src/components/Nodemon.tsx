    ...
    export type NodemonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nodemon = React.forwardRef<SVGSVGElement, NodemonProps>(function Nodemon({color = 'currentColor', size = 24, title = "nodemon", ...others}, ref) {
