    ...
    export type PfsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pfsense = React.forwardRef<SVGSVGElement, PfsenseProps>(function Pfsense({color = 'currentColor', size = 24, title = "pfsense", ...others}, ref) {
