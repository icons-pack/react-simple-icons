    ...
    export type HetznerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hetzner = React.forwardRef<SVGSVGElement, HetznerProps>(function Hetzner({color = 'currentColor', size = 24, title = "hetzner", ...others}, ref) {
