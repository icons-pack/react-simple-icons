    ...
    export type MagasinsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Magasinsu = React.forwardRef<SVGSVGElement, MagasinsuProps>(function Magasinsu({color = 'currentColor', size = 24, title = "magasinsu", ...others}, ref) {
