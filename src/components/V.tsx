    ...
    export type VProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const V = React.forwardRef<SVGSVGElement, VProps>(function V({color = 'currentColor', size = 24, title = "v", ...others}, ref) {
