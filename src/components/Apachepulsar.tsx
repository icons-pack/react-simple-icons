...
export type ApachepulsarProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Apachepulsar = React.forwardRef<SVGSVGElement, ApachepulsarProps>(function Apachepulsar({color = 'currentColor', size = 24, title = "apachepulsar", ...others}, ref) {
