    ...
    export type VexxhostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vexxhost = React.forwardRef<SVGSVGElement, VexxhostProps>(function Vexxhost({color = 'currentColor', size = 24, title = "vexxhost", ...others}, ref) {
