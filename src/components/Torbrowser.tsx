    ...
    export type TorbrowserProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Torbrowser = React.forwardRef<SVGSVGElement, TorbrowserProps>(function Torbrowser({color = 'currentColor', size = 24, title = "torbrowser", ...others}, ref) {
