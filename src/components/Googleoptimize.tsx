...
export type GoogleoptimizeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Googleoptimize = React.forwardRef<SVGSVGElement, GoogleoptimizeProps>(function Googleoptimize({color = 'currentColor', size = 24, title = "googleoptimize", ...others}, ref) {
