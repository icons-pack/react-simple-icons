...
export type SparkfunProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sparkfun = React.forwardRef<SVGSVGElement, SparkfunProps>(function Sparkfun({color = 'currentColor', size = 24, title = "sparkfun", ...others}, ref) {
