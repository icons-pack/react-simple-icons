    ...
    const Countingworkspro = React.forwardRef<SVGSVGElement, CountingworksproProps>(function Countingworkspro({color = 'currentColor', size = 24, title = "countingworkspro", ...others}, ref) {
