    ...
    export type PaytmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Paytm = React.forwardRef<SVGSVGElement, PaytmProps>(function Paytm({color = 'currentColor', size = 24, title = "paytm", ...others}, ref) {
