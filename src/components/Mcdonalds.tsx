    ...
    export type McdonaldsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mcdonalds = React.forwardRef<SVGSVGElement, McdonaldsProps>(function Mcdonalds({color = 'currentColor', size = 24, title = "mcdonalds", ...others}, ref) {
