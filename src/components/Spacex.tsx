...
export type SpacexProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Spacex = React.forwardRef<SVGSVGElement, SpacexProps>(function Spacex({color = 'currentColor', size = 24, title = "spacex", ...others}, ref) {
