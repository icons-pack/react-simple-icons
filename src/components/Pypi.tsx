    ...
    export type PypiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pypi = React.forwardRef<SVGSVGElement, PypiProps>(function Pypi({color = 'currentColor', size = 24, title = "pypi", ...others}, ref) {
