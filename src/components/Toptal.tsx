...
export type ToptalProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Toptal = React.forwardRef<SVGSVGElement, ToptalProps>(function Toptal({color = 'currentColor', size = 24, title = "toptal", ...others}, ref) {
