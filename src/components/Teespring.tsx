...
export type TeespringProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Teespring = React.forwardRef<SVGSVGElement, TeespringProps>(function Teespring({color = 'currentColor', size = 24, title = "teespring", ...others}, ref) {
