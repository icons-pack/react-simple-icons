...
export type FluentbitProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fluentbit = React.forwardRef<SVGSVGElement, FluentbitProps>(function Fluentbit({color = 'currentColor', size = 24, title = "fluentbit", ...others}, ref) {
