...
const Carrefour = React.forwardRef<SVGSVGElement, CarrefourProps>(function Carrefour(
  { color = 'currentColor', size = 24, title = 'carrefour', ...others },
  ref,
) {
  return (
    <svg
