    ...
    export type GriddotaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Griddotai = React.forwardRef<SVGSVGElement, GriddotaiProps>(function Griddotai({color = 'currentColor', size = 24, title = "griddotai", ...others}, ref) {
