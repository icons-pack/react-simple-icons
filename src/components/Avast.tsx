    ...
    export type AvastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Avast = React.forwardRef<SVGSVGElement, AvastProps>(function Avast({color = 'currentColor', size = 24, title = "avast", ...others}, ref) {
