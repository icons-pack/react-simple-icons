    ...
    export type ZerplyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zerply = React.forwardRef<SVGSVGElement, ZerplyProps>(function Zerply({color = 'currentColor', size = 24, title = "zerply", ...others}, ref) {
