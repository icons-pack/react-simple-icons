    ...
    export type BoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Box = React.forwardRef<SVGSVGElement, BoxProps>(function Box({color = 'currentColor', size = 24, title = "box", ...others}, ref) {
