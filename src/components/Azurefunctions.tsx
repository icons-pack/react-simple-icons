...
const Azurefunctions = React.forwardRef<SVGSVGElement, AzurefunctionsProps>(function Azurefunctions({color = 'currentColor', size = 24, title = "azurefunctions", ...others}, ref) {
