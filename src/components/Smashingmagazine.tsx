    ...
    export type SmashingmagazineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Smashingmagazine = React.forwardRef<SVGSVGElement, SmashingmagazineProps>(function Smashingmagazine({color = 'currentColor', size = 24, title = "smashingmagazine", ...others}, ref) {
