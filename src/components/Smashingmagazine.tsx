...
const Smashingmagazine = React.forwardRef<SVGSVGElement, IconProps>(function Smashingmagazine({color = 'currentColor', size = 24, title = "smashingmagazine", ...others}, ref) {
