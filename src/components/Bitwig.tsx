...
export type BitwigProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bitwig = React.forwardRef<SVGSVGElement, BitwigProps>(function Bitwig({color = 'currentColor', size = 24, title = "bitwig", ...others}, ref) {
