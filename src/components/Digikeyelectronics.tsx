    ...
    const Digikeyelectronics = React.forwardRef<SVGSVGElement, DigikeyelectronicsProps>(function Digikeyelectronics({color = 'currentColor', size = 24, title = "digikeyelectronics", ...others}, ref) {
