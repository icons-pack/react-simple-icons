...
const Digikeyelectronics = React.forwardRef<SVGSVGElement, IconProps>(function Digikeyelectronics({color = 'currentColor', size = 24, title = "digikeyelectronics", ...others}, ref) {
