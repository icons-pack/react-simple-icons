    ...
    export type AudacityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Audacity = React.forwardRef<SVGSVGElement, AudacityProps>(function Audacity({color = 'currentColor', size = 24, title = "audacity", ...others}, ref) {
