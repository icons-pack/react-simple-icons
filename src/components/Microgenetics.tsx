    ...
    export type MicrogeneticsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microgenetics = React.forwardRef<SVGSVGElement, MicrogeneticsProps>(function Microgenetics({color = 'currentColor', size = 24, title = "microgenetics", ...others}, ref) {
