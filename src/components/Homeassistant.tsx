...
export type HomeassistantProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Homeassistant = React.forwardRef<SVGSVGElement, HomeassistantProps>(function Homeassistant({color = 'currentColor', size = 24, title = "homeassistant", ...others}, ref) {
