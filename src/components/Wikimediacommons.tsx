    ...
    export type WikimediacommonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wikimediacommons = React.forwardRef<SVGSVGElement, WikimediacommonsProps>(function Wikimediacommons({color = 'currentColor', size = 24, title = "wikimediacommons", ...others}, ref) {
