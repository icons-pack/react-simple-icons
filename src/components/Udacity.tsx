...
export type UdacityProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Udacity = React.forwardRef<SVGSVGElement, UdacityProps>(function Udacity({color = 'currentColor', size = 24, title = "udacity", ...others}, ref) {
