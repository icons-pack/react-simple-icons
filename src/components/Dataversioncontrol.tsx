...
const Dataversioncontrol = React.forwardRef<SVGSVGElement, IconProps>(function Dataversioncontrol({color = 'currentColor', size = 24, title = "dataversioncontrol", ...others}, ref) {
