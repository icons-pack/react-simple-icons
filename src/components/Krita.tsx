    ...
    export type KritaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Krita = React.forwardRef<SVGSVGElement, KritaProps>(function Krita({color = 'currentColor', size = 24, title = "krita", ...others}, ref) {
