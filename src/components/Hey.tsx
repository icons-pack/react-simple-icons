...
export type HeyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Hey = React.forwardRef<SVGSVGElement, HeyProps>(function Hey({color = 'currentColor', size = 24, title = "hey", ...others}, ref) {
