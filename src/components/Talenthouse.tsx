    ...
    export type TalenthouseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Talenthouse = React.forwardRef<SVGSVGElement, TalenthouseProps>(function Talenthouse({color = 'currentColor', size = 24, title = "talenthouse", ...others}, ref) {
