...
export type CucumberProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cucumber = React.forwardRef<SVGSVGElement, CucumberProps>(function Cucumber({color = 'currentColor', size = 24, title = "cucumber", ...others}, ref) {
