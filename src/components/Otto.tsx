    ...
    export type OttoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Otto = React.forwardRef<SVGSVGElement, OttoProps>(function Otto({color = 'currentColor', size = 24, title = "otto", ...others}, ref) {
