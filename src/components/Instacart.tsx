    ...
    export type InstacartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Instacart = React.forwardRef<SVGSVGElement, InstacartProps>(function Instacart({color = 'currentColor', size = 24, title = "instacart", ...others}, ref) {
