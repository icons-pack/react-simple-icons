    ...
    export type AmazoncloudwatchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Amazoncloudwatch = React.forwardRef<SVGSVGElement, AmazoncloudwatchProps>(function Amazoncloudwatch({color = 'currentColor', size = 24, title = "amazoncloudwatch", ...others}, ref) {
