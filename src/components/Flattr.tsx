...
export type FlattrProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Flattr = React.forwardRef<SVGSVGElement, FlattrProps>(function Flattr({color = 'currentColor', size = 24, title = "flattr", ...others}, ref) {
