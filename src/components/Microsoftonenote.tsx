...
const Microsoftonenote = React.forwardRef<SVGSVGElement, IconProps>(function Microsoftonenote({color = 'currentColor', size = 24, title = "microsoftonenote", ...others}, ref) {
