    ...
    export type SpeakerdeckProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Speakerdeck = React.forwardRef<SVGSVGElement, SpeakerdeckProps>(function Speakerdeck({color = 'currentColor', size = 24, title = "speakerdeck", ...others}, ref) {
