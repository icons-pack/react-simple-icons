    ...
    export type MatternetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Matternet = React.forwardRef<SVGSVGElement, MatternetProps>(function Matternet({color = 'currentColor', size = 24, title = "matternet", ...others}, ref) {
