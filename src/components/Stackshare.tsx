...
export type StackshareProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Stackshare = React.forwardRef<SVGSVGElement, StackshareProps>(function Stackshare({color = 'currentColor', size = 24, title = "stackshare", ...others}, ref) {
