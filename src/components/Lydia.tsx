    ...
    export type LydiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lydia = React.forwardRef<SVGSVGElement, LydiaProps>(function Lydia({color = 'currentColor', size = 24, title = "lydia", ...others}, ref) {
