    ...
    export type CodeshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codeship = React.forwardRef<SVGSVGElement, CodeshipProps>(function Codeship({color = 'currentColor', size = 24, title = "codeship", ...others}, ref) {
