...
export type MacosProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Macos = React.forwardRef<SVGSVGElement, MacosProps>(function Macos({color = 'currentColor', size = 24, title = "macos", ...others}, ref) {
