    ...
    export type RacketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Racket = React.forwardRef<SVGSVGElement, RacketProps>(function Racket({color = 'currentColor', size = 24, title = "racket", ...others}, ref) {
