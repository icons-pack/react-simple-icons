    ...
    export type AssemblyscriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Assemblyscript = React.forwardRef<SVGSVGElement, AssemblyscriptProps>(function Assemblyscript({color = 'currentColor', size = 24, title = "assemblyscript", ...others}, ref) {
