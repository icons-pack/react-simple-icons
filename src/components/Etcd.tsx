    ...
    export type EtcdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Etcd = React.forwardRef<SVGSVGElement, EtcdProps>(function Etcd({color = 'currentColor', size = 24, title = "etcd", ...others}, ref) {
