    ...
    export type LitecoinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Litecoin = React.forwardRef<SVGSVGElement, LitecoinProps>(function Litecoin({color = 'currentColor', size = 24, title = "litecoin", ...others}, ref) {
