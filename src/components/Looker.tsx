...
export type LookerProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Looker = React.forwardRef<SVGSVGElement, LookerProps>(function Looker({color = 'currentColor', size = 24, title = "looker", ...others}, ref) {
