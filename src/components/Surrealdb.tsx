...
export type SurrealdbProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Surrealdb = React.forwardRef<SVGSVGElement, SurrealdbProps>(function Surrealdb({color = 'currentColor', size = 24, title = "surrealdb", ...others}, ref) {
