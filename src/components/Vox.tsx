    ...
    export type VoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vox = React.forwardRef<SVGSVGElement, VoxProps>(function Vox({color = 'currentColor', size = 24, title = "vox", ...others}, ref) {
