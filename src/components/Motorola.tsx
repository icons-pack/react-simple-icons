    ...
    export type MotorolaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Motorola = React.forwardRef<SVGSVGElement, MotorolaProps>(function Motorola({color = 'currentColor', size = 24, title = "motorola", ...others}, ref) {
