    ...
    export type ProxmoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Proxmox = React.forwardRef<SVGSVGElement, ProxmoxProps>(function Proxmox({color = 'currentColor', size = 24, title = "proxmox", ...others}, ref) {
