...
export type GeocachingProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Geocaching = React.forwardRef<SVGSVGElement, GeocachingProps>(function Geocaching({color = 'currentColor', size = 24, title = "geocaching", ...others}, ref) {
