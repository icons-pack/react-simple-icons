...
export type BitcoincashProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Bitcoincash = React.forwardRef<SVGSVGElement, BitcoincashProps>(function Bitcoincash({color = 'currentColor', size = 24, title = "bitcoincash", ...others}, ref) {
