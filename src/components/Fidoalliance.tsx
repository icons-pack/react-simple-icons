    ...
    export type FidoallianceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fidoalliance = React.forwardRef<SVGSVGElement, FidoallianceProps>(function Fidoalliance({color = 'currentColor', size = 24, title = "fidoalliance", ...others}, ref) {
