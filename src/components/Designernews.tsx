    ...
    export type DesignernewsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Designernews = React.forwardRef<SVGSVGElement, DesignernewsProps>(function Designernews({color = 'currentColor', size = 24, title = "designernews", ...others}, ref) {
