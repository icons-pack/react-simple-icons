    ...
    export type SepaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sepa = React.forwardRef<SVGSVGElement, SepaProps>(function Sepa({color = 'currentColor', size = 24, title = "sepa", ...others}, ref) {
