...
export type WebcomponentsdotorgProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Webcomponentsdotorg = React.forwardRef<SVGSVGElement, WebcomponentsdotorgProps>(function Webcomponentsdotorg({color = 'currentColor', size = 24, title = "webcomponentsdotorg", ...others}, ref) {
