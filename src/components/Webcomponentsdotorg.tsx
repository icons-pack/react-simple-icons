...
const Webcomponentsdotorg = React.forwardRef<SVGSVGElement, IconProps>(function Webcomponentsdotorg({color = 'currentColor', size = 24, title = "webcomponentsdotorg", ...others}, ref) {
