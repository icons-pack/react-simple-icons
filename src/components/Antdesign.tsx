    ...
    export type AntdesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Antdesign = React.forwardRef<SVGSVGElement, AntdesignProps>(function Antdesign({color = 'currentColor', size = 24, title = "antdesign", ...others}, ref) {
