    ...
    export type EslgamingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Eslgaming = React.forwardRef<SVGSVGElement, EslgamingProps>(function Eslgaming({color = 'currentColor', size = 24, title = "eslgaming", ...others}, ref) {
