    ...
    export type HexoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hexo = React.forwardRef<SVGSVGElement, HexoProps>(function Hexo({color = 'currentColor', size = 24, title = "hexo", ...others}, ref) {
