...
export type CiliumProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cilium = React.forwardRef<SVGSVGElement, CiliumProps>(function Cilium({color = 'currentColor', size = 24, title = "cilium", ...others}, ref) {
