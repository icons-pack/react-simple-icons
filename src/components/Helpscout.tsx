...
const Helpscout = React.forwardRef<SVGSVGElement, HelpscoutProps>(function Helpscout(
  { color = 'currentColor', size = 24, title = 'helpscout', ...others },
  ref,
) {
  return (
    <svg
