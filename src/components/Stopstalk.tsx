...
export type StopstalkProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Stopstalk = React.forwardRef<SVGSVGElement, StopstalkProps>(function Stopstalk({color = 'currentColor', size = 24, title = "stopstalk", ...others}, ref) {
