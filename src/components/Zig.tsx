...
export type ZigProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Zig = React.forwardRef<SVGSVGElement, ZigProps>(function Zig({color = 'currentColor', size = 24, title = "zig", ...others}, ref) {
