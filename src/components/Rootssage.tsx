...
export type RootssageProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Rootssage = React.forwardRef<SVGSVGElement, RootssageProps>(function Rootssage({color = 'currentColor', size = 24, title = "rootssage", ...others}, ref) {
