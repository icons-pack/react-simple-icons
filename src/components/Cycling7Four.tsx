...
export type Cycling7FourProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cycling7Four = React.forwardRef<SVGSVGElement, Cycling7FourProps>(function Cycling7Four({color = 'currentColor', size = 24, title = "cycling74", ...others}, ref) {
