    ...
    export type PowervirtualagentsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Powervirtualagents = React.forwardRef<SVGSVGElement, PowervirtualagentsProps>(function Powervirtualagents({color = 'currentColor', size = 24, title = "powervirtualagents", ...others}, ref) {
