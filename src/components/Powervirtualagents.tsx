...
const Powervirtualagents = React.forwardRef<SVGSVGElement, IconProps>(function Powervirtualagents({color = 'currentColor', size = 24, title = "powervirtualagents", ...others}, ref) {
