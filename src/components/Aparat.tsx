    ...
    export type AparatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aparat = React.forwardRef<SVGSVGElement, AparatProps>(function Aparat({color = 'currentColor', size = 24, title = "aparat", ...others}, ref) {
