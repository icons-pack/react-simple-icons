...
export type XmppProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Xmpp = React.forwardRef<SVGSVGElement, XmppProps>(function Xmpp({color = 'currentColor', size = 24, title = "xmpp", ...others}, ref) {
