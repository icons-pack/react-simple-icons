    ...
    export type PennyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Penny = React.forwardRef<SVGSVGElement, PennyProps>(function Penny({color = 'currentColor', size = 24, title = "penny", ...others}, ref) {
