    ...
    export type HboProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hbo = React.forwardRef<SVGSVGElement, HboProps>(function Hbo({color = 'currentColor', size = 24, title = "hbo", ...others}, ref) {
