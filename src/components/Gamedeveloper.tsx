    ...
    export type GamedeveloperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gamedeveloper = React.forwardRef<SVGSVGElement, GamedeveloperProps>(function Gamedeveloper({color = 'currentColor', size = 24, title = "gamedeveloper", ...others}, ref) {
