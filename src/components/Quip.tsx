    ...
    export type QuipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Quip = React.forwardRef<SVGSVGElement, QuipProps>(function Quip({color = 'currentColor', size = 24, title = "quip", ...others}, ref) {
