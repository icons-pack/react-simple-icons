    ...
    export type ParitysubstrateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Paritysubstrate = React.forwardRef<SVGSVGElement, ParitysubstrateProps>(function Paritysubstrate({color = 'currentColor', size = 24, title = "paritysubstrate", ...others}, ref) {
