    ...
    export type SpondProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Spond = React.forwardRef<SVGSVGElement, SpondProps>(function Spond({color = 'currentColor', size = 24, title = "spond", ...others}, ref) {
