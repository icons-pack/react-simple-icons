    ...
    export type DogecoinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dogecoin = React.forwardRef<SVGSVGElement, DogecoinProps>(function Dogecoin({color = 'currentColor', size = 24, title = "dogecoin", ...others}, ref) {
