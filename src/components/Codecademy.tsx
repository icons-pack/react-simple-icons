    ...
    export type CodecademyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codecademy = React.forwardRef<SVGSVGElement, CodecademyProps>(function Codecademy({color = 'currentColor', size = 24, title = "codecademy", ...others}, ref) {
