    ...
    export type LivechatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Livechat = React.forwardRef<SVGSVGElement, LivechatProps>(function Livechat({color = 'currentColor', size = 24, title = "livechat", ...others}, ref) {
