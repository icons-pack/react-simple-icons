...
export type ScreencastifyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Screencastify = React.forwardRef<SVGSVGElement, ScreencastifyProps>(function Screencastify({color = 'currentColor', size = 24, title = "screencastify", ...others}, ref) {
