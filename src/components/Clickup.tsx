    ...
    export type ClickupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Clickup = React.forwardRef<SVGSVGElement, ClickupProps>(function Clickup({color = 'currentColor', size = 24, title = "clickup", ...others}, ref) {
