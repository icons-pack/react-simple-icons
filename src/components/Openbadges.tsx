...
export type OpenbadgesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Openbadges = React.forwardRef<SVGSVGElement, OpenbadgesProps>(function Openbadges({color = 'currentColor', size = 24, title = "openbadges", ...others}, ref) {
