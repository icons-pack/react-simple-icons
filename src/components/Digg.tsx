    ...
    export type DiggProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Digg = React.forwardRef<SVGSVGElement, DiggProps>(function Digg({color = 'currentColor', size = 24, title = "digg", ...others}, ref) {
