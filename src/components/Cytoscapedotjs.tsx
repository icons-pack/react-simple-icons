    ...
    export type CytoscapedotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cytoscapedotjs = React.forwardRef<SVGSVGElement, CytoscapedotjsProps>(function Cytoscapedotjs({color = 'currentColor', size = 24, title = "cytoscapedotjs", ...others}, ref) {
