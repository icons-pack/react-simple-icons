    ...
    export type FormstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Formstack = React.forwardRef<SVGSVGElement, FormstackProps>(function Formstack({color = 'currentColor', size = 24, title = "formstack", ...others}, ref) {
