...
export type ManProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Man = React.forwardRef<SVGSVGElement, ManProps>(function Man({color = 'currentColor', size = 24, title = "man", ...others}, ref) {
