...
export type ApachenetbeansideProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Apachenetbeanside = React.forwardRef<SVGSVGElement, ApachenetbeansideProps>(function Apachenetbeanside({color = 'currentColor', size = 24, title = "apachenetbeanside", ...others}, ref) {
...
export default Apachenetbeanside;
