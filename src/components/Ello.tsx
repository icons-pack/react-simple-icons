    ...
    export type ElloProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ello = React.forwardRef<SVGSVGElement, ElloProps>(function Ello({color = 'currentColor', size = 24, title = "ello", ...others}, ref) {
