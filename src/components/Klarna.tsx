    ...
    export type KlarnaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Klarna = React.forwardRef<SVGSVGElement, KlarnaProps>(function Klarna({color = 'currentColor', size = 24, title = "klarna", ...others}, ref) {
