    ...
    export type ScratchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Scratch = React.forwardRef<SVGSVGElement, ScratchProps>(function Scratch({color = 'currentColor', size = 24, title = "scratch", ...others}, ref) {
