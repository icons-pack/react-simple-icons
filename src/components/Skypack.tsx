...
export type SkypackProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Skypack = React.forwardRef<SVGSVGElement, SkypackProps>(function Skypack({color = 'currentColor', size = 24, title = "skypack", ...others}, ref) {
