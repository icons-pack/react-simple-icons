...
export type CoronaengineProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Coronaengine = React.forwardRef<SVGSVGElement, CoronaengineProps>(function Coronaengine({color = 'currentColor', size = 24, title = "coronaengine", ...others}, ref) {
