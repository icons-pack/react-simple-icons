...
export type HatenabookmarkProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Hatenabookmark = React.forwardRef<SVGSVGElement, HatenabookmarkProps>(function Hatenabookmark({color = 'currentColor', size = 24, title = "hatenabookmark", ...others}, ref) {
