...
export type GitpodProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Gitpod = React.forwardRef<SVGSVGElement, GitpodProps>(function Gitpod({color = 'currentColor', size = 24, title = "gitpod", ...others}, ref) {
