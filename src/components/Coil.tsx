...
export type CoilProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Coil = React.forwardRef<SVGSVGElement, CoilProps>(function Coil({color = 'currentColor', size = 24, title = "coil", ...others}, ref) {
