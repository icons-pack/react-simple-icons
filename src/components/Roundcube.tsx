    ...
    export type RoundcubeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Roundcube = React.forwardRef<SVGSVGElement, RoundcubeProps>(function Roundcube({color = 'currentColor', size = 24, title = "roundcube", ...others}, ref) {
