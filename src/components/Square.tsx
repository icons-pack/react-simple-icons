    ...
    export type SquareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Square = React.forwardRef<SVGSVGElement, SquareProps>(function Square({color = 'currentColor', size = 24, title = "square", ...others}, ref) {
