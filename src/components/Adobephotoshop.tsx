    ...
    export type AdobephotoshopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobephotoshop = React.forwardRef<SVGSVGElement, AdobephotoshopProps>(function Adobephotoshop({color = 'currentColor', size = 24, title = "adobephotoshop", ...others}, ref) {
