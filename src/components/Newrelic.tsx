...
export type NewrelicProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Newrelic = React.forwardRef<SVGSVGElement, NewrelicProps>(function Newrelic({color = 'currentColor', size = 24, title = "newrelic", ...others}, ref) {
