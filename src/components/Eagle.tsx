    ...
    export type EagleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Eagle = React.forwardRef<SVGSVGElement, EagleProps>(function Eagle({color = 'currentColor', size = 24, title = "eagle", ...others}, ref) {
