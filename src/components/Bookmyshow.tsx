    ...
    export type BookmyshowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bookmyshow = React.forwardRef<SVGSVGElement, BookmyshowProps>(function Bookmyshow({color = 'currentColor', size = 24, title = "bookmyshow", ...others}, ref) {
