...
export type NecProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nec = React.forwardRef<SVGSVGElement, NecProps>(function Nec({color = 'currentColor', size = 24, title = "nec", ...others}, ref) {
