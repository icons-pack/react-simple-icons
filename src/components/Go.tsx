...
export type GoProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Go = React.forwardRef<SVGSVGElement, GoProps>(function Go({color = 'currentColor', size = 24, title = "go", ...others}, ref) {
