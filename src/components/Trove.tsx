    ...
    export type TroveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Trove = React.forwardRef<SVGSVGElement, TroveProps>(function Trove({color = 'currentColor', size = 24, title = "trove", ...others}, ref) {
