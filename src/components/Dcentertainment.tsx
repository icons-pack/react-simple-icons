    ...
    export type DcentertainmentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dcentertainment = React.forwardRef<SVGSVGElement, DcentertainmentProps>(function Dcentertainment({color = 'currentColor', size = 24, title = "dcentertainment", ...others}, ref) {
