...
const Relianceindustrieslimited = React.forwardRef<SVGSVGElement, IconProps>(function Relianceindustrieslimited({color = 'currentColor', size = 24, title = "relianceindustrieslimited", ...others}, ref) {
