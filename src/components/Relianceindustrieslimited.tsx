...
const Relianceindustrieslimited = React.forwardRef<SVGSVGElement, RelianceindustrieslimitedProps>(
  function Relianceindustrieslimited(
    { color = 'currentColor', size = 24, title = 'relianceindustrieslimited', ...others },
    ref,
  ) {
    return (
      <svg
