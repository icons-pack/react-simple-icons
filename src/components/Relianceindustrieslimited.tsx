    ...
    export type RelianceindustrieslimitedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Relianceindustrieslimited = React.forwardRef<SVGSVGElement, RelianceindustrieslimitedProps>(function Relianceindustrieslimited({color = 'currentColor', size = 24, title = "relianceindustrieslimited", ...others}, ref) {
    ...
    export default Relianceindustrieslimited
