...
export type HoudiniProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Houdini = React.forwardRef<SVGSVGElement, HoudiniProps>(function Houdini({color = 'currentColor', size = 24, title = "houdini", ...others}, ref) {
