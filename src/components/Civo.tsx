    ...
    export type CivoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Civo = React.forwardRef<SVGSVGElement, CivoProps>(function Civo({color = 'currentColor', size = 24, title = "civo", ...others}, ref) {
