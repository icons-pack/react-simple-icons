    ...
    export type LineageosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lineageos = React.forwardRef<SVGSVGElement, LineageosProps>(function Lineageos({color = 'currentColor', size = 24, title = "lineageos", ...others}, ref) {
