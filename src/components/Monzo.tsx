    ...
    export type MonzoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Monzo = React.forwardRef<SVGSVGElement, MonzoProps>(function Monzo({color = 'currentColor', size = 24, title = "monzo", ...others}, ref) {
