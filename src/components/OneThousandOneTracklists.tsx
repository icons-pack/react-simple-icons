...
const OneThousandOneTracklists = React.forwardRef<SVGSVGElement, IconProps>(function OneThousandOneTracklists({color = 'currentColor', size = 24, title = "1001tracklists", ...others}, ref) {
