...
const OneThousandOneTracklists = React.forwardRef<SVGSVGElement, OneThousandOneTracklistsProps>(
  function OneThousandOneTracklists({ color = 'currentColor', size = 24, title = '1001tracklists', ...others }, ref) {
    return (
      <svg
