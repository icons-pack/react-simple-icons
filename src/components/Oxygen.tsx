    ...
    export type OxygenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Oxygen = React.forwardRef<SVGSVGElement, OxygenProps>(function Oxygen({color = 'currentColor', size = 24, title = "oxygen", ...others}, ref) {
