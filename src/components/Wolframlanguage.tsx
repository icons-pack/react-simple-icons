...
const Wolframlanguage = React.forwardRef<SVGSVGElement, WolframlanguageProps>(function Wolframlanguage(
  { color = 'currentColor', size = 24, title = 'wolframlanguage', ...others },
  ref,
) {
  return (
    <svg
