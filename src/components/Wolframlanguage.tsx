    ...
    export type WolframlanguageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wolframlanguage = React.forwardRef<SVGSVGElement, WolframlanguageProps>(function Wolframlanguage({color = 'currentColor', size = 24, title = "wolframlanguage", ...others}, ref) {
