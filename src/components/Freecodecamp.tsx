    ...
    export type FreecodecampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Freecodecamp = React.forwardRef<SVGSVGElement, FreecodecampProps>(function Freecodecamp({color = 'currentColor', size = 24, title = "freecodecamp", ...others}, ref) {
