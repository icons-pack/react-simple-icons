    ...
    export type IntelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Intel = React.forwardRef<SVGSVGElement, IntelProps>(function Intel({color = 'currentColor', size = 24, title = "intel", ...others}, ref) {
