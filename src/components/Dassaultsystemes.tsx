...
const Dassaultsystemes = React.forwardRef<SVGSVGElement, DassaultsystemesProps>(function Dassaultsystemes(
  { color = 'currentColor', size = 24, title = 'dassaultsystemes', ...others },
  ref,
) {
  return (
    <svg
