    ...
    export type DassaultsystemesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dassaultsystemes = React.forwardRef<SVGSVGElement, DassaultsystemesProps>(function Dassaultsystemes({color = 'currentColor', size = 24, title = "dassaultsystemes", ...others}, ref) {
