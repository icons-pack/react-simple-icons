    ...
    export type SuperuserProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Superuser = React.forwardRef<SVGSVGElement, SuperuserProps>(function Superuser({color = 'currentColor', size = 24, title = "superuser", ...others}, ref) {
