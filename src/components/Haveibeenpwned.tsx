    ...
    export type HaveibeenpwnedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Haveibeenpwned = React.forwardRef<SVGSVGElement, HaveibeenpwnedProps>(function Haveibeenpwned({color = 'currentColor', size = 24, title = "haveibeenpwned", ...others}, ref) {
