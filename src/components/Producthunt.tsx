...
export type ProducthuntProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Producthunt = React.forwardRef<SVGSVGElement, ProducthuntProps>(function Producthunt({color = 'currentColor', size = 24, title = "producthunt", ...others}, ref) {
