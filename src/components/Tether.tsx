    ...
    export type TetherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tether = React.forwardRef<SVGSVGElement, TetherProps>(function Tether({color = 'currentColor', size = 24, title = "tether", ...others}, ref) {
