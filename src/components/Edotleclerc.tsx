    ...
    export type EdotleclercProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Edotleclerc = React.forwardRef<SVGSVGElement, EdotleclercProps>(function Edotleclerc({color = 'currentColor', size = 24, title = "edotleclerc", ...others}, ref) {
