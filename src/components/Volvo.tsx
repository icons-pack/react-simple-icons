    ...
    export type VolvoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Volvo = React.forwardRef<SVGSVGElement, VolvoProps>(function Volvo({color = 'currentColor', size = 24, title = "volvo", ...others}, ref) {
