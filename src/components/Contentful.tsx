    ...
    export type ContentfulProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Contentful = React.forwardRef<SVGSVGElement, ContentfulProps>(function Contentful({color = 'currentColor', size = 24, title = "contentful", ...others}, ref) {
