    ...
    export type FirefoxbrowserProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Firefoxbrowser = React.forwardRef<SVGSVGElement, FirefoxbrowserProps>(function Firefoxbrowser({color = 'currentColor', size = 24, title = "firefoxbrowser", ...others}, ref) {
