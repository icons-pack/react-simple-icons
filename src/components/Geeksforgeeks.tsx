    ...
    export type GeeksforgeeksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Geeksforgeeks = React.forwardRef<SVGSVGElement, GeeksforgeeksProps>(function Geeksforgeeks({color = 'currentColor', size = 24, title = "geeksforgeeks", ...others}, ref) {
