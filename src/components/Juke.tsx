...
export type JukeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Juke = React.forwardRef<SVGSVGElement, JukeProps>(function Juke({color = 'currentColor', size = 24, title = "juke", ...others}, ref) {
