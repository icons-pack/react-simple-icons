...
export type EaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ea = React.forwardRef<SVGSVGElement, EaProps>(function Ea({color = 'currentColor', size = 24, title = "ea", ...others}, ref) {
