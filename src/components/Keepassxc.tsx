...
export type KeepassxcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Keepassxc = React.forwardRef<SVGSVGElement, KeepassxcProps>(function Keepassxc({color = 'currentColor', size = 24, title = "keepassxc", ...others}, ref) {
