    ...
    export type DolbyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dolby = React.forwardRef<SVGSVGElement, DolbyProps>(function Dolby({color = 'currentColor', size = 24, title = "dolby", ...others}, ref) {
