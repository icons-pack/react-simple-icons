    ...
    export type DhlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dhl = React.forwardRef<SVGSVGElement, DhlProps>(function Dhl({color = 'currentColor', size = 24, title = "dhl", ...others}, ref) {
