...
export type NoderedProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nodered = React.forwardRef<SVGSVGElement, NoderedProps>(function Nodered({color = 'currentColor', size = 24, title = "nodered", ...others}, ref) {
