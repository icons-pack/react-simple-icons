...
export type BattledotnetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Battledotnet = React.forwardRef<SVGSVGElement, BattledotnetProps>(function Battledotnet({color = 'currentColor', size = 24, title = "battledotnet", ...others}, ref) {
