    ...
    export type IconjarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Iconjar = React.forwardRef<SVGSVGElement, IconjarProps>(function Iconjar({color = 'currentColor', size = 24, title = "iconjar", ...others}, ref) {
