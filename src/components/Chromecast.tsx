...
export type ChromecastProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Chromecast = React.forwardRef<SVGSVGElement, ChromecastProps>(function Chromecast({color = 'currentColor', size = 24, title = "chromecast", ...others}, ref) {
