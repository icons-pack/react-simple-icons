    ...
    export type DatagripProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Datagrip = React.forwardRef<SVGSVGElement, DatagripProps>(function Datagrip({color = 'currentColor', size = 24, title = "datagrip", ...others}, ref) {
