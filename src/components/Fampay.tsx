    ...
    export type FampayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fampay = React.forwardRef<SVGSVGElement, FampayProps>(function Fampay({color = 'currentColor', size = 24, title = "fampay", ...others}, ref) {
