    ...
    export type SqliteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sqlite = React.forwardRef<SVGSVGElement, SqliteProps>(function Sqlite({color = 'currentColor', size = 24, title = "sqlite", ...others}, ref) {
