    ...
    export type AstroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Astro = React.forwardRef<SVGSVGElement, AstroProps>(function Astro({color = 'currentColor', size = 24, title = "astro", ...others}, ref) {
