    ...
    export type ExercismProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Exercism = React.forwardRef<SVGSVGElement, ExercismProps>(function Exercism({color = 'currentColor', size = 24, title = "exercism", ...others}, ref) {
