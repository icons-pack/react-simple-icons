...
export type WorkplaceProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Workplace = React.forwardRef<SVGSVGElement, WorkplaceProps>(function Workplace({color = 'currentColor', size = 24, title = "workplace", ...others}, ref) {
