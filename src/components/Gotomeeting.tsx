    ...
    export type GotomeetingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gotomeeting = React.forwardRef<SVGSVGElement, GotomeetingProps>(function Gotomeeting({color = 'currentColor', size = 24, title = "gotomeeting", ...others}, ref) {
