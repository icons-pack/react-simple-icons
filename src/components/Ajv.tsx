...
export type AjvProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ajv = React.forwardRef<SVGSVGElement, AjvProps>(function Ajv({color = 'currentColor', size = 24, title = "ajv", ...others}, ref) {
