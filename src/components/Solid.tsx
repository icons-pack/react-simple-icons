    ...
    export type SolidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Solid = React.forwardRef<SVGSVGElement, SolidProps>(function Solid({color = 'currentColor', size = 24, title = "solid", ...others}, ref) {
