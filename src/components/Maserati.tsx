...
const Maserati = React.forwardRef<SVGSVGElement, MaseratiProps>(function Maserati(
  { color = 'currentColor', size = 24, title = 'maserati', ...others },
  ref,
) {
  return (
    <svg
