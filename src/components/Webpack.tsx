    ...
    export type WebpackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Webpack = React.forwardRef<SVGSVGElement, WebpackProps>(function Webpack({color = 'currentColor', size = 24, title = "webpack", ...others}, ref) {
