    ...
    export type UbiquitiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ubiquiti = React.forwardRef<SVGSVGElement, UbiquitiProps>(function Ubiquiti({color = 'currentColor', size = 24, title = "ubiquiti", ...others}, ref) {
