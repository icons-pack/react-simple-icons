    ...
    export type TraefikproxyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Traefikproxy = React.forwardRef<SVGSVGElement, TraefikproxyProps>(function Traefikproxy({color = 'currentColor', size = 24, title = "traefikproxy", ...others}, ref) {
