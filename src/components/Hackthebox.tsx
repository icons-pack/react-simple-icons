    ...
    export type HacktheboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hackthebox = React.forwardRef<SVGSVGElement, HacktheboxProps>(function Hackthebox({color = 'currentColor', size = 24, title = "hackthebox", ...others}, ref) {
