    ...
    export type RenaultProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Renault = React.forwardRef<SVGSVGElement, RenaultProps>(function Renault({color = 'currentColor', size = 24, title = "renault", ...others}, ref) {
