    ...
    export type RubyonrailsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rubyonrails = React.forwardRef<SVGSVGElement, RubyonrailsProps>(function Rubyonrails({color = 'currentColor', size = 24, title = "rubyonrails", ...others}, ref) {
