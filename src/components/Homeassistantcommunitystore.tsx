    ...
    export type HomeassistantcommunitystoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Homeassistantcommunitystore = React.forwardRef<SVGSVGElement, HomeassistantcommunitystoreProps>(function Homeassistantcommunitystore({color = 'currentColor', size = 24, title = "homeassistantcommunitystore", ...others}, ref) {
