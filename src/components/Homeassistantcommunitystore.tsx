...
const Homeassistantcommunitystore = React.forwardRef<SVGSVGElement, IconProps>(function Homeassistantcommunitystore({color = 'currentColor', size = 24, title = "homeassistantcommunitystore", ...others}, ref) {
