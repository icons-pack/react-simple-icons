...
export type SteamdeckProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Steamdeck = React.forwardRef<SVGSVGElement, SteamdeckProps>(function Steamdeck({color = 'currentColor', size = 24, title = "steamdeck", ...others}, ref) {
