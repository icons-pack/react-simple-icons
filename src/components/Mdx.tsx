...
export type MdxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mdx = React.forwardRef<SVGSVGElement, MdxProps>(function Mdx({color = 'currentColor', size = 24, title = "mdx", ...others}, ref) {
