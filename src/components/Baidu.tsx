    ...
    export type BaiduProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Baidu = React.forwardRef<SVGSVGElement, BaiduProps>(function Baidu({color = 'currentColor', size = 24, title = "baidu", ...others}, ref) {
