...
export type EclipsevertdotxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Eclipsevertdotx = React.forwardRef<SVGSVGElement, EclipsevertdotxProps>(function Eclipsevertdotx({color = 'currentColor', size = 24, title = "eclipsevertdotx", ...others}, ref) {
