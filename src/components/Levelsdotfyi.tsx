...
const Levelsdotfyi = React.forwardRef<SVGSVGElement, LevelsdotfyiProps>(function Levelsdotfyi(
  { color = 'currentColor', size = 24, title = 'levelsdotfyi', ...others },
  ref,
) {
  return (
    <svg
