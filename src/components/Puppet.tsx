    ...
    export type PuppetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Puppet = React.forwardRef<SVGSVGElement, PuppetProps>(function Puppet({color = 'currentColor', size = 24, title = "puppet", ...others}, ref) {
