    ...
    export type CouchbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Couchbase = React.forwardRef<SVGSVGElement, CouchbaseProps>(function Couchbase({color = 'currentColor', size = 24, title = "couchbase", ...others}, ref) {
