    ...
    export type UnderarmourProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Underarmour = React.forwardRef<SVGSVGElement, UnderarmourProps>(function Underarmour({color = 'currentColor', size = 24, title = "underarmour", ...others}, ref) {
