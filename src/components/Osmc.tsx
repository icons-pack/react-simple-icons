...
export type OsmcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Osmc = React.forwardRef<SVGSVGElement, OsmcProps>(function Osmc({color = 'currentColor', size = 24, title = "osmc", ...others}, ref) {
