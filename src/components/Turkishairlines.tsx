...
const Turkishairlines = React.forwardRef<SVGSVGElement, TurkishairlinesProps>(function Turkishairlines(
  { color = 'currentColor', size = 24, title = 'turkishairlines', ...others },
  ref,
) {
  return (
    <svg
