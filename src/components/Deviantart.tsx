...
const Deviantart = React.forwardRef<SVGSVGElement, DeviantartProps>(function Deviantart(
  { color = 'currentColor', size = 24, title = 'deviantart', ...others },
  ref,
) {
  return (
    <svg
