    ...
    export type NucleoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nucleo = React.forwardRef<SVGSVGElement, NucleoProps>(function Nucleo({color = 'currentColor', size = 24, title = "nucleo", ...others}, ref) {
