...
export type WolframProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Wolfram = React.forwardRef<SVGSVGElement, WolframProps>(function Wolfram({color = 'currentColor', size = 24, title = "wolfram", ...others}, ref) {
