...
const Opencontainersinitiative = React.forwardRef<SVGSVGElement, IconProps>(function Opencontainersinitiative({color = 'currentColor', size = 24, title = "opencontainersinitiative", ...others}, ref) {
