...
export type ElementProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Element = React.forwardRef<SVGSVGElement, ElementProps>(function Element({color = 'currentColor', size = 24, title = "element", ...others}, ref) {
