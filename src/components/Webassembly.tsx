...
export type WebassemblyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Webassembly = React.forwardRef<SVGSVGElement, WebassemblyProps>(function Webassembly({color = 'currentColor', size = 24, title = "webassembly", ...others}, ref) {
