...
const Thewashingtonpost = React.forwardRef<SVGSVGElement, IconProps>(function Thewashingtonpost({color = 'currentColor', size = 24, title = "thewashingtonpost", ...others}, ref) {
