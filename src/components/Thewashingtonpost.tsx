...
export type ThewashingtonpostProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Thewashingtonpost = React.forwardRef<SVGSVGElement, ThewashingtonpostProps>(function Thewashingtonpost({color = 'currentColor', size = 24, title = "thewashingtonpost", ...others}, ref) {
