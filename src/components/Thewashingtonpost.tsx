...
const Thewashingtonpost = React.forwardRef<SVGSVGElement, ThewashingtonpostProps>(function Thewashingtonpost(
  { color = 'currentColor', size = 24, title = 'thewashingtonpost', ...others },
  ref,
) {
  return (
    <svg
