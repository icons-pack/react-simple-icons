    ...
    export type BoseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bose = React.forwardRef<SVGSVGElement, BoseProps>(function Bose({color = 'currentColor', size = 24, title = "bose", ...others}, ref) {
