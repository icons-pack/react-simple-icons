...
export type JetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Jet = React.forwardRef<SVGSVGElement, JetProps>(function Jet({color = 'currentColor', size = 24, title = "jet", ...others}, ref) {
