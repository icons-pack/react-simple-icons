...
export type IonicProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ionic = React.forwardRef<SVGSVGElement, IonicProps>(function Ionic({color = 'currentColor', size = 24, title = "ionic", ...others}, ref) {
