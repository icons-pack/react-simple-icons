...
export type UplabsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Uplabs = React.forwardRef<SVGSVGElement, UplabsProps>(function Uplabs({color = 'currentColor', size = 24, title = "uplabs", ...others}, ref) {
