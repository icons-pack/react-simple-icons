...
export type AzureartifactsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Azureartifacts = React.forwardRef<SVGSVGElement, AzureartifactsProps>(function Azureartifacts({color = 'currentColor', size = 24, title = "azureartifacts", ...others}, ref) {
