    ...
    export type AlipayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Alipay = React.forwardRef<SVGSVGElement, AlipayProps>(function Alipay({color = 'currentColor', size = 24, title = "alipay", ...others}, ref) {
