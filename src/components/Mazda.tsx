...
export type MazdaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mazda = React.forwardRef<SVGSVGElement, MazdaProps>(function Mazda({color = 'currentColor', size = 24, title = "mazda", ...others}, ref) {
