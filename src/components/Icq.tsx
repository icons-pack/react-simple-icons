    ...
    export type IcqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Icq = React.forwardRef<SVGSVGElement, IcqProps>(function Icq({color = 'currentColor', size = 24, title = "icq", ...others}, ref) {
