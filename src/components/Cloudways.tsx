...
export type CloudwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cloudways = React.forwardRef<SVGSVGElement, CloudwaysProps>(function Cloudways({color = 'currentColor', size = 24, title = "cloudways", ...others}, ref) {
