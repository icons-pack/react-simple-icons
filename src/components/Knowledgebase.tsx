    ...
    const Knowledgebase = React.forwardRef<SVGSVGElement, KnowledgebaseProps>(function Knowledgebase({color = 'currentColor', size = 24, title = "knowledgebase", ...others}, ref) {
