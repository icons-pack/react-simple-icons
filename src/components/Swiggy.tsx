...
export type SwiggyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Swiggy = React.forwardRef<SVGSVGElement, SwiggyProps>(function Swiggy({color = 'currentColor', size = 24, title = "swiggy", ...others}, ref) {
