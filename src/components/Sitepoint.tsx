...
export type SitepointProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sitepoint = React.forwardRef<SVGSVGElement, SitepointProps>(function Sitepoint({color = 'currentColor', size = 24, title = "sitepoint", ...others}, ref) {
