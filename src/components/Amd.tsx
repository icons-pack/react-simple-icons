...
export type AmdProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Amd = React.forwardRef<SVGSVGElement, AmdProps>(function Amd({color = 'currentColor', size = 24, title = "amd", ...others}, ref) {
