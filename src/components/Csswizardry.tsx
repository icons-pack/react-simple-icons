...
export type CsswizardryProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Csswizardry = React.forwardRef<SVGSVGElement, CsswizardryProps>(function Csswizardry({color = 'currentColor', size = 24, title = "csswizardry", ...others}, ref) {
