...
export type UfcProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ufc = React.forwardRef<SVGSVGElement, UfcProps>(function Ufc({color = 'currentColor', size = 24, title = "ufc", ...others}, ref) {
