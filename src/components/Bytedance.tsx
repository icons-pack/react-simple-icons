...
const Bytedance = React.forwardRef<SVGSVGElement, BytedanceProps>(function Bytedance(
  { color = 'currentColor', size = 24, title = 'bytedance', ...others },
  ref,
) {
  return (
    <svg
