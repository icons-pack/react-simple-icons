    ...
    export type KickstarterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kickstarter = React.forwardRef<SVGSVGElement, KickstarterProps>(function Kickstarter({color = 'currentColor', size = 24, title = "kickstarter", ...others}, ref) {
