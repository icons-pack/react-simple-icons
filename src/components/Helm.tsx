...
export type HelmProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Helm = React.forwardRef<SVGSVGElement, HelmProps>(function Helm({color = 'currentColor', size = 24, title = "helm", ...others}, ref) {
