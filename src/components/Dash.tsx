    ...
    export type DashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dash = React.forwardRef<SVGSVGElement, DashProps>(function Dash({color = 'currentColor', size = 24, title = "dash", ...others}, ref) {
