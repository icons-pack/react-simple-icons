...
export type AmazonapigatewayProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Amazonapigateway = React.forwardRef<SVGSVGElement, AmazonapigatewayProps>(function Amazonapigateway({color = 'currentColor', size = 24, title = "amazonapigateway", ...others}, ref) {
...
export default Amazonapigateway;
