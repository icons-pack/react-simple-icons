...
const Amazonapigateway = React.forwardRef<SVGSVGElement, IconProps>(function Amazonapigateway({color = 'currentColor', size = 24, title = "amazonapigateway", ...others}, ref) {
