    ...
    export type RubygemsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rubygems = React.forwardRef<SVGSVGElement, RubygemsProps>(function Rubygems({color = 'currentColor', size = 24, title = "rubygems", ...others}, ref) {
