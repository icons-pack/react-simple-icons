    ...
    export type NumpyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Numpy = React.forwardRef<SVGSVGElement, NumpyProps>(function Numpy({color = 'currentColor', size = 24, title = "numpy", ...others}, ref) {
