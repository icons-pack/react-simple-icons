    ...
    export type DlibProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dlib = React.forwardRef<SVGSVGElement, DlibProps>(function Dlib({color = 'currentColor', size = 24, title = "dlib", ...others}, ref) {
