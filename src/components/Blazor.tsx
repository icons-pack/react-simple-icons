    ...
    export type BlazorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Blazor = React.forwardRef<SVGSVGElement, BlazorProps>(function Blazor({color = 'currentColor', size = 24, title = "blazor", ...others}, ref) {
