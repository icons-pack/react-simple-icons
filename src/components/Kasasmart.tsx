    ...
    export type KasasmartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kasasmart = React.forwardRef<SVGSVGElement, KasasmartProps>(function Kasasmart({color = 'currentColor', size = 24, title = "kasasmart", ...others}, ref) {
