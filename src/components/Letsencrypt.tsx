...
export type LetsencryptProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Letsencrypt = React.forwardRef<SVGSVGElement, LetsencryptProps>(function Letsencrypt({color = 'currentColor', size = 24, title = "letsencrypt", ...others}, ref) {
