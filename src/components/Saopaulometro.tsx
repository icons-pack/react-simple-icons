    ...
    export type SaopaulometroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Saopaulometro = React.forwardRef<SVGSVGElement, SaopaulometroProps>(function Saopaulometro({color = 'currentColor', size = 24, title = "saopaulometro", ...others}, ref) {
