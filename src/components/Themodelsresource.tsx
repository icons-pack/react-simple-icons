    ...
    export type ThemodelsresourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Themodelsresource = React.forwardRef<SVGSVGElement, ThemodelsresourceProps>(function Themodelsresource({color = 'currentColor', size = 24, title = "themodelsresource", ...others}, ref) {
