...
const Themodelsresource = React.forwardRef<SVGSVGElement, ThemodelsresourceProps>(function Themodelsresource(
  { color = 'currentColor', size = 24, title = 'themodelsresource', ...others },
  ref,
) {
  return (
    <svg
