...
const Themodelsresource = React.forwardRef<SVGSVGElement, IconProps>(function Themodelsresource({color = 'currentColor', size = 24, title = "themodelsresource", ...others}, ref) {
