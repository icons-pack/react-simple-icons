    ...
    export type SubaruProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Subaru = React.forwardRef<SVGSVGElement, SubaruProps>(function Subaru({color = 'currentColor', size = 24, title = "subaru", ...others}, ref) {
