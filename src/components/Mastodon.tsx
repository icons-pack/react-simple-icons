    ...
    export type MastodonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mastodon = React.forwardRef<SVGSVGElement, MastodonProps>(function Mastodon({color = 'currentColor', size = 24, title = "mastodon", ...others}, ref) {
