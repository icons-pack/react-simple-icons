    ...
    export type CapacitorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Capacitor = React.forwardRef<SVGSVGElement, CapacitorProps>(function Capacitor({color = 'currentColor', size = 24, title = "capacitor", ...others}, ref) {
