    ...
    export type TrillerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Triller = React.forwardRef<SVGSVGElement, TrillerProps>(function Triller({color = 'currentColor', size = 24, title = "triller", ...others}, ref) {
