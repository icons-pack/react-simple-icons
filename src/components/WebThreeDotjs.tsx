    ...
    export type WebThreeDotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const WebThreeDotjs = React.forwardRef<SVGSVGElement, WebThreeDotjsProps>(function WebThreeDotjs({color = 'currentColor', size = 24, title = "web3dotjs", ...others}, ref) {
