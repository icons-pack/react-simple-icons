...
export type ImmerProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Immer = React.forwardRef<SVGSVGElement, ImmerProps>(function Immer({color = 'currentColor', size = 24, title = "immer", ...others}, ref) {
