...
export type DocsdotrsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Docsdotrs = React.forwardRef<SVGSVGElement, DocsdotrsProps>(function Docsdotrs({color = 'currentColor', size = 24, title = "docsdotrs", ...others}, ref) {
