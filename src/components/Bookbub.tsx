    ...
    export type BookbubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bookbub = React.forwardRef<SVGSVGElement, BookbubProps>(function Bookbub({color = 'currentColor', size = 24, title = "bookbub", ...others}, ref) {
