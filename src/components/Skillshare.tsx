    ...
    export type SkillshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Skillshare = React.forwardRef<SVGSVGElement, SkillshareProps>(function Skillshare({color = 'currentColor', size = 24, title = "skillshare", ...others}, ref) {
