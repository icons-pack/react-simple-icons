    ...
    export type CashappProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cashapp = React.forwardRef<SVGSVGElement, CashappProps>(function Cashapp({color = 'currentColor', size = 24, title = "cashapp", ...others}, ref) {
