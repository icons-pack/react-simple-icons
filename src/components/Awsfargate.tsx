    ...
    export type AwsfargateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Awsfargate = React.forwardRef<SVGSVGElement, AwsfargateProps>(function Awsfargate({color = 'currentColor', size = 24, title = "awsfargate", ...others}, ref) {
