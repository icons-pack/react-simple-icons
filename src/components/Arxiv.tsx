...
export type ArxivProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Arxiv = React.forwardRef<SVGSVGElement, ArxivProps>(function Arxiv({color = 'currentColor', size = 24, title = "arxiv", ...others}, ref) {
