    ...
    export type OpenstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Openstack = React.forwardRef<SVGSVGElement, OpenstackProps>(function Openstack({color = 'currentColor', size = 24, title = "openstack", ...others}, ref) {
