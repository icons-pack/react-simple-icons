...
export type AldinordProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Aldinord = React.forwardRef<SVGSVGElement, AldinordProps>(function Aldinord({color = 'currentColor', size = 24, title = "aldinord", ...others}, ref) {
