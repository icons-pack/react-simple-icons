    ...
    export type TheconversationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Theconversation = React.forwardRef<SVGSVGElement, TheconversationProps>(function Theconversation({color = 'currentColor', size = 24, title = "theconversation", ...others}, ref) {
