    ...
    export type KnativeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Knative = React.forwardRef<SVGSVGElement, KnativeProps>(function Knative({color = 'currentColor', size = 24, title = "knative", ...others}, ref) {
