    ...
    export type GraylogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Graylog = React.forwardRef<SVGSVGElement, GraylogProps>(function Graylog({color = 'currentColor', size = 24, title = "graylog", ...others}, ref) {
