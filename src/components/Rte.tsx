    ...
    export type RteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rte = React.forwardRef<SVGSVGElement, RteProps>(function Rte({color = 'currentColor', size = 24, title = "rte", ...others}, ref) {
