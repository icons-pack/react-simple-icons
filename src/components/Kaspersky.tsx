    ...
    export type KasperskyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kaspersky = React.forwardRef<SVGSVGElement, KasperskyProps>(function Kaspersky({color = 'currentColor', size = 24, title = "kaspersky", ...others}, ref) {
