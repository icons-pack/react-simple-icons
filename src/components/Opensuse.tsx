...
export type OpensuseProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Opensuse = React.forwardRef<SVGSVGElement, OpensuseProps>(function Opensuse({color = 'currentColor', size = 24, title = "opensuse", ...others}, ref) {
