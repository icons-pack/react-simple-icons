    ...
    export type BoeingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Boeing = React.forwardRef<SVGSVGElement, BoeingProps>(function Boeing({color = 'currentColor', size = 24, title = "boeing", ...others}, ref) {
