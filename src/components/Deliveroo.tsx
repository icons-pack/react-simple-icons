...
export type DeliverooProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Deliveroo = React.forwardRef<SVGSVGElement, DeliverooProps>(function Deliveroo({color = 'currentColor', size = 24, title = "deliveroo", ...others}, ref) {
