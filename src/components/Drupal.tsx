    ...
    export type DrupalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Drupal = React.forwardRef<SVGSVGElement, DrupalProps>(function Drupal({color = 'currentColor', size = 24, title = "drupal", ...others}, ref) {
