    ...
    const Commonworkflowlanguage = React.forwardRef<SVGSVGElement, CommonworkflowlanguageProps>(function Commonworkflowlanguage({color = 'currentColor', size = 24, title = "commonworkflowlanguage", ...others}, ref) {
