    ...
    export type SonarcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sonarcloud = React.forwardRef<SVGSVGElement, SonarcloudProps>(function Sonarcloud({color = 'currentColor', size = 24, title = "sonarcloud", ...others}, ref) {
