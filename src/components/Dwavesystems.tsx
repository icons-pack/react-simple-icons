    ...
    export type DwavesystemsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dwavesystems = React.forwardRef<SVGSVGElement, DwavesystemsProps>(function Dwavesystems({color = 'currentColor', size = 24, title = "dwavesystems", ...others}, ref) {
