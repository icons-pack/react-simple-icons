...
export type GolandProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Goland = React.forwardRef<SVGSVGElement, GolandProps>(function Goland({color = 'currentColor', size = 24, title = "goland", ...others}, ref) {
