    ...
    export type DlnaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dlna = React.forwardRef<SVGSVGElement, DlnaProps>(function Dlna({color = 'currentColor', size = 24, title = "dlna", ...others}, ref) {
