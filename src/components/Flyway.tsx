...
export type FlywayProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Flyway = React.forwardRef<SVGSVGElement, FlywayProps>(function Flyway({color = 'currentColor', size = 24, title = "flyway", ...others}, ref) {
