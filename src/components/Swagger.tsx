    ...
    export type SwaggerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Swagger = React.forwardRef<SVGSVGElement, SwaggerProps>(function Swagger({color = 'currentColor', size = 24, title = "swagger", ...others}, ref) {
