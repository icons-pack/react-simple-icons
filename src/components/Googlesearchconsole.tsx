    ...
    export type GooglesearchconsoleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlesearchconsole = React.forwardRef<SVGSVGElement, GooglesearchconsoleProps>(function Googlesearchconsole({color = 'currentColor', size = 24, title = "googlesearchconsole", ...others}, ref) {
