    ...
    export type MetafilterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Metafilter = React.forwardRef<SVGSVGElement, MetafilterProps>(function Metafilter({color = 'currentColor', size = 24, title = "metafilter", ...others}, ref) {
