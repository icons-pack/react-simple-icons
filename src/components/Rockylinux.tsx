...
export type RockylinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Rockylinux = React.forwardRef<SVGSVGElement, RockylinuxProps>(function Rockylinux({color = 'currentColor', size = 24, title = "rockylinux", ...others}, ref) {
