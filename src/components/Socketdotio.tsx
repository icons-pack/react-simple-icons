...
export type SocketdotioProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Socketdotio = React.forwardRef<SVGSVGElement, SocketdotioProps>(function Socketdotio({color = 'currentColor', size = 24, title = "socketdotio", ...others}, ref) {
