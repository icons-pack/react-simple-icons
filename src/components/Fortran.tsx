    ...
    export type FortranProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fortran = React.forwardRef<SVGSVGElement, FortranProps>(function Fortran({color = 'currentColor', size = 24, title = "fortran", ...others}, ref) {
