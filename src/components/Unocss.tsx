...
export type UnocssProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Unocss = React.forwardRef<SVGSVGElement, UnocssProps>(function Unocss({color = 'currentColor', size = 24, title = "unocss", ...others}, ref) {
