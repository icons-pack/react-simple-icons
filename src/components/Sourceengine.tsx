    ...
    export type SourceengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sourceengine = React.forwardRef<SVGSVGElement, SourceengineProps>(function Sourceengine({color = 'currentColor', size = 24, title = "sourceengine", ...others}, ref) {
