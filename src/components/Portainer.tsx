    ...
    export type PortainerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Portainer = React.forwardRef<SVGSVGElement, PortainerProps>(function Portainer({color = 'currentColor', size = 24, title = "portainer", ...others}, ref) {
