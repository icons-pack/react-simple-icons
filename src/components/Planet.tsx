...
export type PlanetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Planet = React.forwardRef<SVGSVGElement, PlanetProps>(function Planet({color = 'currentColor', size = 24, title = "planet", ...others}, ref) {
