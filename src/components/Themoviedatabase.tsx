    ...
    export type ThemoviedatabaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Themoviedatabase = React.forwardRef<SVGSVGElement, ThemoviedatabaseProps>(function Themoviedatabase({color = 'currentColor', size = 24, title = "themoviedatabase", ...others}, ref) {
