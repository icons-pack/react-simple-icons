...
export type DeutschebahnProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Deutschebahn = React.forwardRef<SVGSVGElement, DeutschebahnProps>(function Deutschebahn({color = 'currentColor', size = 24, title = "deutschebahn", ...others}, ref) {
