...
export type OctanerenderProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Octanerender = React.forwardRef<SVGSVGElement, OctanerenderProps>(function Octanerender({color = 'currentColor', size = 24, title = "octanerender", ...others}, ref) {
