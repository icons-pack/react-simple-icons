    ...
    export type DevrantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Devrant = React.forwardRef<SVGSVGElement, DevrantProps>(function Devrant({color = 'currentColor', size = 24, title = "devrant", ...others}, ref) {
