    ...
    export type PlausibleanalyticsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Plausibleanalytics = React.forwardRef<SVGSVGElement, PlausibleanalyticsProps>(function Plausibleanalytics({color = 'currentColor', size = 24, title = "plausibleanalytics", ...others}, ref) {
