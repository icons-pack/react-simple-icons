...
const Plausibleanalytics = React.forwardRef<SVGSVGElement, PlausibleanalyticsProps>(function Plausibleanalytics(
  { color = 'currentColor', size = 24, title = 'plausibleanalytics', ...others },
  ref,
) {
  return (
    <svg
