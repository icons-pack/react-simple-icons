    ...
    export type GunicornProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gunicorn = React.forwardRef<SVGSVGElement, GunicornProps>(function Gunicorn({color = 'currentColor', size = 24, title = "gunicorn", ...others}, ref) {
