...
export type LgProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Lg = React.forwardRef<SVGSVGElement, LgProps>(function Lg({color = 'currentColor', size = 24, title = "lg", ...others}, ref) {
