    ...
    export type StackpathProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Stackpath = React.forwardRef<SVGSVGElement, StackpathProps>(function Stackpath({color = 'currentColor', size = 24, title = "stackpath", ...others}, ref) {
