...
export type ElasticstackProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Elasticstack = React.forwardRef<SVGSVGElement, ElasticstackProps>(function Elasticstack({color = 'currentColor', size = 24, title = "elasticstack", ...others}, ref) {
