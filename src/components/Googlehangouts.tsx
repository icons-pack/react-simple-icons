    ...
    const Googlehangouts = React.forwardRef<SVGSVGElement, GooglehangoutsProps>(function Googlehangouts({color = 'currentColor', size = 24, title = "googlehangouts", ...others}, ref) {
