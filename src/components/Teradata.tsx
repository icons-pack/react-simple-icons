    ...
    export type TeradataProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Teradata = React.forwardRef<SVGSVGElement, TeradataProps>(function Teradata({color = 'currentColor', size = 24, title = "teradata", ...others}, ref) {
