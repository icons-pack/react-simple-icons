    ...
    export type CheckioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Checkio = React.forwardRef<SVGSVGElement, CheckioProps>(function Checkio({color = 'currentColor', size = 24, title = "checkio", ...others}, ref) {
