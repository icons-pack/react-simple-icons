...
export type BritishairwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Britishairways = React.forwardRef<SVGSVGElement, BritishairwaysProps>(function Britishairways({color = 'currentColor', size = 24, title = "britishairways", ...others}, ref) {
