    ...
    export type JfrogbintrayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jfrogbintray = React.forwardRef<SVGSVGElement, JfrogbintrayProps>(function Jfrogbintray({color = 'currentColor', size = 24, title = "jfrogbintray", ...others}, ref) {
