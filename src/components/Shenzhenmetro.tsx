    ...
    export type ShenzhenmetroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Shenzhenmetro = React.forwardRef<SVGSVGElement, ShenzhenmetroProps>(function Shenzhenmetro({color = 'currentColor', size = 24, title = "shenzhenmetro", ...others}, ref) {
