    ...
    export type UdemyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Udemy = React.forwardRef<SVGSVGElement, UdemyProps>(function Udemy({color = 'currentColor', size = 24, title = "udemy", ...others}, ref) {
