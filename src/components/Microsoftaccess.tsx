    ...
    export type MicrosoftaccessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftaccess = React.forwardRef<SVGSVGElement, MicrosoftaccessProps>(function Microsoftaccess({color = 'currentColor', size = 24, title = "microsoftaccess", ...others}, ref) {
