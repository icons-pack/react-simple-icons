...
export type GreenhouseProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Greenhouse = React.forwardRef<SVGSVGElement, GreenhouseProps>(function Greenhouse({color = 'currentColor', size = 24, title = "greenhouse", ...others}, ref) {
