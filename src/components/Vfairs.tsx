...
export type VfairsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Vfairs = React.forwardRef<SVGSVGElement, VfairsProps>(function Vfairs({color = 'currentColor', size = 24, title = "vfairs", ...others}, ref) {
