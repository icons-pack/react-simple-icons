    ...
    export type CourseraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Coursera = React.forwardRef<SVGSVGElement, CourseraProps>(function Coursera({color = 'currentColor', size = 24, title = "coursera", ...others}, ref) {
