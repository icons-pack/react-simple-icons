    ...
    export type StencylProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Stencyl = React.forwardRef<SVGSVGElement, StencylProps>(function Stencyl({color = 'currentColor', size = 24, title = "stencyl", ...others}, ref) {
