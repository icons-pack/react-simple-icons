    ...
    export type AccusoftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Accusoft = React.forwardRef<SVGSVGElement, AccusoftProps>(function Accusoft({color = 'currentColor', size = 24, title = "accusoft", ...others}, ref) {
