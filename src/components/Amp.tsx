...
export type AmpProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Amp = React.forwardRef<SVGSVGElement, AmpProps>(function Amp({color = 'currentColor', size = 24, title = "amp", ...others}, ref) {
