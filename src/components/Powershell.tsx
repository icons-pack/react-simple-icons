    ...
    export type PowershellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Powershell = React.forwardRef<SVGSVGElement, PowershellProps>(function Powershell({color = 'currentColor', size = 24, title = "powershell", ...others}, ref) {
