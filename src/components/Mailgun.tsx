    ...
    export type MailgunProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mailgun = React.forwardRef<SVGSVGElement, MailgunProps>(function Mailgun({color = 'currentColor', size = 24, title = "mailgun", ...others}, ref) {
