    ...
    export type TemporalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Temporal = React.forwardRef<SVGSVGElement, TemporalProps>(function Temporal({color = 'currentColor', size = 24, title = "temporal", ...others}, ref) {
