...
const Skypeforbusiness = React.forwardRef<SVGSVGElement, IconProps>(function Skypeforbusiness({color = 'currentColor', size = 24, title = "skypeforbusiness", ...others}, ref) {
