    ...
    export type SkypeforbusinessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Skypeforbusiness = React.forwardRef<SVGSVGElement, SkypeforbusinessProps>(function Skypeforbusiness({color = 'currentColor', size = 24, title = "skypeforbusiness", ...others}, ref) {
