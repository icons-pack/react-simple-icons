    ...
    export type CrunchyrollProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Crunchyroll = React.forwardRef<SVGSVGElement, CrunchyrollProps>(function Crunchyroll({color = 'currentColor', size = 24, title = "crunchyroll", ...others}, ref) {
