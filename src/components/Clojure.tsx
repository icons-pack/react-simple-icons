    ...
    export type ClojureProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Clojure = React.forwardRef<SVGSVGElement, ClojureProps>(function Clojure({color = 'currentColor', size = 24, title = "clojure", ...others}, ref) {
