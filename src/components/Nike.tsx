    ...
    export type NikeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nike = React.forwardRef<SVGSVGElement, NikeProps>(function Nike({color = 'currentColor', size = 24, title = "nike", ...others}, ref) {
