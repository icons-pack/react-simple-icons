    ...
    export type NixosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nixos = React.forwardRef<SVGSVGElement, NixosProps>(function Nixos({color = 'currentColor', size = 24, title = "nixos", ...others}, ref) {
