...
export type WakatimeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Wakatime = React.forwardRef<SVGSVGElement, WakatimeProps>(function Wakatime({color = 'currentColor', size = 24, title = "wakatime", ...others}, ref) {
