...
export type GitkrakenProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Gitkraken = React.forwardRef<SVGSVGElement, GitkrakenProps>(function Gitkraken({color = 'currentColor', size = 24, title = "gitkraken", ...others}, ref) {
