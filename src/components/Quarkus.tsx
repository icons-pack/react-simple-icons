...
export type QuarkusProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Quarkus = React.forwardRef<SVGSVGElement, QuarkusProps>(function Quarkus({color = 'currentColor', size = 24, title = "quarkus", ...others}, ref) {
