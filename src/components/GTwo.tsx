...
export type GTwoProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const GTwo = React.forwardRef<SVGSVGElement, GTwoProps>(function GTwo({color = 'currentColor', size = 24, title = "g2", ...others}, ref) {
