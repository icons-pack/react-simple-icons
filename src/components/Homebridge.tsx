...
export type HomebridgeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Homebridge = React.forwardRef<SVGSVGElement, HomebridgeProps>(function Homebridge({color = 'currentColor', size = 24, title = "homebridge", ...others}, ref) {
