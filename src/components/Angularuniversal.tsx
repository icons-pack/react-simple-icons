    ...
    const Angularuniversal = React.forwardRef<SVGSVGElement, AngularuniversalProps>(function Angularuniversal({color = 'currentColor', size = 24, title = "angularuniversal", ...others}, ref) {
