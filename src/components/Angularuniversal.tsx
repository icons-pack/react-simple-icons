...
const Angularuniversal = React.forwardRef<SVGSVGElement, IconProps>(function Angularuniversal({color = 'currentColor', size = 24, title = "angularuniversal", ...others}, ref) {
