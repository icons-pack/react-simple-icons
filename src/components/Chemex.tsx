    ...
    export type ChemexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Chemex = React.forwardRef<SVGSVGElement, ChemexProps>(function Chemex({color = 'currentColor', size = 24, title = "chemex", ...others}, ref) {
