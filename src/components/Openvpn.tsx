...
export type OpenvpnProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Openvpn = React.forwardRef<SVGSVGElement, OpenvpnProps>(function Openvpn({color = 'currentColor', size = 24, title = "openvpn", ...others}, ref) {
