...
const Welcometothejungle = React.forwardRef<SVGSVGElement, WelcometothejungleProps>(function Welcometothejungle(
  { color = 'currentColor', size = 24, title = 'welcometothejungle', ...others },
  ref,
) {
  return (
    <svg
