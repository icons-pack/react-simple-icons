    ...
    export type WelcometothejungleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Welcometothejungle = React.forwardRef<SVGSVGElement, WelcometothejungleProps>(function Welcometothejungle({color = 'currentColor', size = 24, title = "welcometothejungle", ...others}, ref) {
