...
const Welcometothejungle = React.forwardRef<SVGSVGElement, IconProps>(function Welcometothejungle({color = 'currentColor', size = 24, title = "welcometothejungle", ...others}, ref) {
