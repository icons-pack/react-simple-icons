    ...
    export type PercyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Percy = React.forwardRef<SVGSVGElement, PercyProps>(function Percy({color = 'currentColor', size = 24, title = "percy", ...others}, ref) {
