    ...
    export type S7airlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const S7airlines = React.forwardRef<SVGSVGElement, S7airlinesProps>(function S7airlines({color = 'currentColor', size = 24, title = "s7airlines", ...others}, ref) {
