...
const Franprix = React.forwardRef<SVGSVGElement, FranprixProps>(function Franprix(
  { color = 'currentColor', size = 24, title = 'franprix', ...others },
  ref,
) {
  return (
    <svg
