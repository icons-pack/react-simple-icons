    ...
    export type ApachecordovaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Apachecordova = React.forwardRef<SVGSVGElement, ApachecordovaProps>(function Apachecordova({color = 'currentColor', size = 24, title = "apachecordova", ...others}, ref) {
