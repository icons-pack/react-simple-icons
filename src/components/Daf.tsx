    ...
    export type DafProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Daf = React.forwardRef<SVGSVGElement, DafProps>(function Daf({color = 'currentColor', size = 24, title = "daf", ...others}, ref) {
