...
const PlaystationFour = React.forwardRef<SVGSVGElement, PlaystationFourProps>(function PlaystationFour(
  { color = 'currentColor', size = 24, title = 'playstation4', ...others },
  ref,
) {
  return (
    <svg
