    ...
    const Gitignoredotio = React.forwardRef<SVGSVGElement, GitignoredotioProps>(function Gitignoredotio({color = 'currentColor', size = 24, title = "gitignoredotio", ...others}, ref) {
