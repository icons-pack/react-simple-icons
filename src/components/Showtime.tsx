    ...
    export type ShowtimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Showtime = React.forwardRef<SVGSVGElement, ShowtimeProps>(function Showtime({color = 'currentColor', size = 24, title = "showtime", ...others}, ref) {
