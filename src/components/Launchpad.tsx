...
export type LaunchpadProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Launchpad = React.forwardRef<SVGSVGElement, LaunchpadProps>(function Launchpad({color = 'currentColor', size = 24, title = "launchpad", ...others}, ref) {
