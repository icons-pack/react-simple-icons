...
export type PowerpagesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Powerpages = React.forwardRef<SVGSVGElement, PowerpagesProps>(function Powerpages({color = 'currentColor', size = 24, title = "powerpages", ...others}, ref) {
