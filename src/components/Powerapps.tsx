...
const Powerapps = React.forwardRef<SVGSVGElement, PowerappsProps>(function Powerapps(
  { color = 'currentColor', size = 24, title = 'powerapps', ...others },
  ref,
) {
  return (
    <svg
