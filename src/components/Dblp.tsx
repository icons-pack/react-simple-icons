    ...
    export type DblpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dblp = React.forwardRef<SVGSVGElement, DblpProps>(function Dblp({color = 'currentColor', size = 24, title = "dblp", ...others}, ref) {
