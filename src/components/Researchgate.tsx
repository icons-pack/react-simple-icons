    ...
    export type ResearchgateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Researchgate = React.forwardRef<SVGSVGElement, ResearchgateProps>(function Researchgate({color = 'currentColor', size = 24, title = "researchgate", ...others}, ref) {
