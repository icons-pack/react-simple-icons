    ...
    export type SegaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sega = React.forwardRef<SVGSVGElement, SegaProps>(function Sega({color = 'currentColor', size = 24, title = "sega", ...others}, ref) {
