...
export type SketchupProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sketchup = React.forwardRef<SVGSVGElement, SketchupProps>(function Sketchup({color = 'currentColor', size = 24, title = "sketchup", ...others}, ref) {
