    ...
    export type PiwigoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Piwigo = React.forwardRef<SVGSVGElement, PiwigoProps>(function Piwigo({color = 'currentColor', size = 24, title = "piwigo", ...others}, ref) {
