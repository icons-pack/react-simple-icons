    ...
    export type WazeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Waze = React.forwardRef<SVGSVGElement, WazeProps>(function Waze({color = 'currentColor', size = 24, title = "waze", ...others}, ref) {
