    ...
    export type ClionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Clion = React.forwardRef<SVGSVGElement, ClionProps>(function Clion({color = 'currentColor', size = 24, title = "clion", ...others}, ref) {
