...
export type ValveProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Valve = React.forwardRef<SVGSVGElement, ValveProps>(function Valve({color = 'currentColor', size = 24, title = "valve", ...others}, ref) {
