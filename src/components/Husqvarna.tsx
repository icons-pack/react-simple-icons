    ...
    export type HusqvarnaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Husqvarna = React.forwardRef<SVGSVGElement, HusqvarnaProps>(function Husqvarna({color = 'currentColor', size = 24, title = "husqvarna", ...others}, ref) {
