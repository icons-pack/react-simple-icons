...
const Adobelightroom = React.forwardRef<SVGSVGElement, AdobelightroomProps>(function Adobelightroom({color = 'currentColor', size = 24, title = "adobelightroom", ...others}, ref) {
