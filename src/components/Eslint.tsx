...
export type EslintProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Eslint = React.forwardRef<SVGSVGElement, EslintProps>(function Eslint({color = 'currentColor', size = 24, title = "eslint", ...others}, ref) {
