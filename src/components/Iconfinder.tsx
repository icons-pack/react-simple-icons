    ...
    export type IconfinderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Iconfinder = React.forwardRef<SVGSVGElement, IconfinderProps>(function Iconfinder({color = 'currentColor', size = 24, title = "iconfinder", ...others}, ref) {
