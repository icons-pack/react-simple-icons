    ...
    export type SwiftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Swift = React.forwardRef<SVGSVGElement, SwiftProps>(function Swift({color = 'currentColor', size = 24, title = "swift", ...others}, ref) {
