...
export type FraunhofergesellschaftProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fraunhofergesellschaft = React.forwardRef<SVGSVGElement, FraunhofergesellschaftProps>(function Fraunhofergesellschaft({color = 'currentColor', size = 24, title = "fraunhofergesellschaft", ...others}, ref) {
