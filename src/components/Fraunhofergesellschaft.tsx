...
const Fraunhofergesellschaft = React.forwardRef<SVGSVGElement, IconProps>(function Fraunhofergesellschaft({color = 'currentColor', size = 24, title = "fraunhofergesellschaft", ...others}, ref) {
