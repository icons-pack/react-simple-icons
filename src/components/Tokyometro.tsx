...
export type TokyometroProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Tokyometro = React.forwardRef<SVGSVGElement, TokyometroProps>(function Tokyometro({color = 'currentColor', size = 24, title = "tokyometro", ...others}, ref) {
