    ...
    export type SmugmugProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Smugmug = React.forwardRef<SVGSVGElement, SmugmugProps>(function Smugmug({color = 'currentColor', size = 24, title = "smugmug", ...others}, ref) {
