    ...
    export type KongregateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kongregate = React.forwardRef<SVGSVGElement, KongregateProps>(function Kongregate({color = 'currentColor', size = 24, title = "kongregate", ...others}, ref) {
