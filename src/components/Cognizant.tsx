    ...
    export type CognizantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cognizant = React.forwardRef<SVGSVGElement, CognizantProps>(function Cognizant({color = 'currentColor', size = 24, title = "cognizant", ...others}, ref) {
