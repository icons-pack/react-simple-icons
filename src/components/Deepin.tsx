    ...
    export type DeepinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Deepin = React.forwardRef<SVGSVGElement, DeepinProps>(function Deepin({color = 'currentColor', size = 24, title = "deepin", ...others}, ref) {
