...
export type StrapiProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Strapi = React.forwardRef<SVGSVGElement, StrapiProps>(function Strapi({color = 'currentColor', size = 24, title = "strapi", ...others}, ref) {
