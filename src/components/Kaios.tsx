...
export type KaiosProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Kaios = React.forwardRef<SVGSVGElement, KaiosProps>(function Kaios({color = 'currentColor', size = 24, title = "kaios", ...others}, ref) {
