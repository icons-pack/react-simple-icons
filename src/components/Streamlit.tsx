    ...
    export type StreamlitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Streamlit = React.forwardRef<SVGSVGElement, StreamlitProps>(function Streamlit({color = 'currentColor', size = 24, title = "streamlit", ...others}, ref) {
