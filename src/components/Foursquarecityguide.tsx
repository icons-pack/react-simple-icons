...
const Foursquarecityguide = React.forwardRef<SVGSVGElement, IconProps>(function Foursquarecityguide({color = 'currentColor', size = 24, title = "foursquarecityguide", ...others}, ref) {
