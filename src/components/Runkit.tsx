    ...
    export type RunkitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Runkit = React.forwardRef<SVGSVGElement, RunkitProps>(function Runkit({color = 'currentColor', size = 24, title = "runkit", ...others}, ref) {
