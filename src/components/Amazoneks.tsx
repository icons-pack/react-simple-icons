...
export type AmazoneksProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Amazoneks = React.forwardRef<SVGSVGElement, AmazoneksProps>(function Amazoneks({color = 'currentColor', size = 24, title = "amazoneks", ...others}, ref) {
