    ...
    export type DevpostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Devpost = React.forwardRef<SVGSVGElement, DevpostProps>(function Devpost({color = 'currentColor', size = 24, title = "devpost", ...others}, ref) {
