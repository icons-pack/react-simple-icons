...
export type AdobeauditionProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Adobeaudition = React.forwardRef<SVGSVGElement, AdobeauditionProps>(function Adobeaudition({color = 'currentColor', size = 24, title = "adobeaudition", ...others}, ref) {
