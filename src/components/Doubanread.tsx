    ...
    export type DoubanreadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Doubanread = React.forwardRef<SVGSVGElement, DoubanreadProps>(function Doubanread({color = 'currentColor', size = 24, title = "doubanread", ...others}, ref) {
