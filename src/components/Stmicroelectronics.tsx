...
export type StmicroelectronicsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Stmicroelectronics = React.forwardRef<SVGSVGElement, StmicroelectronicsProps>(function Stmicroelectronics({color = 'currentColor', size = 24, title = "stmicroelectronics", ...others}, ref) {
