    ...
    export type KatanaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Katana = React.forwardRef<SVGSVGElement, KatanaProps>(function Katana({color = 'currentColor', size = 24, title = "katana", ...others}, ref) {
