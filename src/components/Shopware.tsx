    ...
    export type ShopwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Shopware = React.forwardRef<SVGSVGElement, ShopwareProps>(function Shopware({color = 'currentColor', size = 24, title = "shopware", ...others}, ref) {
