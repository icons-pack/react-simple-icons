    ...
    export type SeatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Seat = React.forwardRef<SVGSVGElement, SeatProps>(function Seat({color = 'currentColor', size = 24, title = "seat", ...others}, ref) {
