    ...
    export type FloatplaneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Floatplane = React.forwardRef<SVGSVGElement, FloatplaneProps>(function Floatplane({color = 'currentColor', size = 24, title = "floatplane", ...others}, ref) {
