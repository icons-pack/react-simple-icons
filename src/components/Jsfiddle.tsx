    ...
    export type JsfiddleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jsfiddle = React.forwardRef<SVGSVGElement, JsfiddleProps>(function Jsfiddle({color = 'currentColor', size = 24, title = "jsfiddle", ...others}, ref) {
