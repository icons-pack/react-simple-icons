    ...
    export type UspsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Usps = React.forwardRef<SVGSVGElement, UspsProps>(function Usps({color = 'currentColor', size = 24, title = "usps", ...others}, ref) {
