    ...
    export type KhanacademyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Khanacademy = React.forwardRef<SVGSVGElement, KhanacademyProps>(function Khanacademy({color = 'currentColor', size = 24, title = "khanacademy", ...others}, ref) {
