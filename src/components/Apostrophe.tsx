    ...
    export type ApostropheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Apostrophe = React.forwardRef<SVGSVGElement, ApostropheProps>(function Apostrophe({color = 'currentColor', size = 24, title = "apostrophe", ...others}, ref) {
