    ...
    export type ZaraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zara = React.forwardRef<SVGSVGElement, ZaraProps>(function Zara({color = 'currentColor', size = 24, title = "zara", ...others}, ref) {
