...
export type SensuProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sensu = React.forwardRef<SVGSVGElement, SensuProps>(function Sensu({color = 'currentColor', size = 24, title = "sensu", ...others}, ref) {
