    ...
    export type PlaywrightProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Playwright = React.forwardRef<SVGSVGElement, PlaywrightProps>(function Playwright({color = 'currentColor', size = 24, title = "playwright", ...others}, ref) {
