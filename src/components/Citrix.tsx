    ...
    export type CitrixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Citrix = React.forwardRef<SVGSVGElement, CitrixProps>(function Citrix({color = 'currentColor', size = 24, title = "citrix", ...others}, ref) {
