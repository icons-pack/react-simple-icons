...
const Facepunch = React.forwardRef<SVGSVGElement, FacepunchProps>(function Facepunch(
  { color = 'currentColor', size = 24, title = 'facepunch', ...others },
  ref,
) {
  return (
    <svg
