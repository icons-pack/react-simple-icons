...
const Insomnia = React.forwardRef<SVGSVGElement, InsomniaProps>(function Insomnia(
  { color = 'currentColor', size = 24, title = 'insomnia', ...others },
  ref,
) {
  return (
    <svg
