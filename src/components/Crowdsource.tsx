    ...
    export type CrowdsourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Crowdsource = React.forwardRef<SVGSVGElement, CrowdsourceProps>(function Crowdsource({color = 'currentColor', size = 24, title = "crowdsource", ...others}, ref) {
