...
const Compropago = forwardRef(function Compropago(
  { color = 'currentColor', size = 24, title = 'ComproPago', ...others },
  ref
) {
  return (
    <svg
