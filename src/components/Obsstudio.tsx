...
export type ObsstudioProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Obsstudio = React.forwardRef<SVGSVGElement, ObsstudioProps>(function Obsstudio({color = 'currentColor', size = 24, title = "obsstudio", ...others}, ref) {
