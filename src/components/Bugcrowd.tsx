    ...
    export type BugcrowdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bugcrowd = React.forwardRef<SVGSVGElement, BugcrowdProps>(function Bugcrowd({color = 'currentColor', size = 24, title = "bugcrowd", ...others}, ref) {
