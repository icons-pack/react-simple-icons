    ...
    export type DvcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dvc = React.forwardRef<SVGSVGElement, DvcProps>(function Dvc({color = 'currentColor', size = 24, title = "dvc", ...others}, ref) {
