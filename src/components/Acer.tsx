    ...
    export type AcerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Acer = React.forwardRef<SVGSVGElement, AcerProps>(function Acer({color = 'currentColor', size = 24, title = "acer", ...others}, ref) {
