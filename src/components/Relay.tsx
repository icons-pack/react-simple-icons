    ...
    export type RelayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Relay = React.forwardRef<SVGSVGElement, RelayProps>(function Relay({color = 'currentColor', size = 24, title = "relay", ...others}, ref) {
