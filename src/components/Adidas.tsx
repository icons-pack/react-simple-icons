    ...
    export type AdidasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adidas = React.forwardRef<SVGSVGElement, AdidasProps>(function Adidas({color = 'currentColor', size = 24, title = "adidas", ...others}, ref) {
