...
const Affinityphoto = React.forwardRef<SVGSVGElement, AffinityphotoProps>(function Affinityphoto({color = 'currentColor', size = 24, title = "affinityphoto", ...others}, ref) {
