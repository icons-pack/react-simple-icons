    ...
    export type ThreedotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Threedotjs = React.forwardRef<SVGSVGElement, ThreedotjsProps>(function Threedotjs({color = 'currentColor', size = 24, title = "threedotjs", ...others}, ref) {
