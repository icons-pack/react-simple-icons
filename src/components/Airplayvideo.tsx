...
export type AirplayvideoProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Airplayvideo = React.forwardRef<SVGSVGElement, AirplayvideoProps>(function Airplayvideo({color = 'currentColor', size = 24, title = "airplayvideo", ...others}, ref) {
