    ...
    export type FnacProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fnac = React.forwardRef<SVGSVGElement, FnacProps>(function Fnac({color = 'currentColor', size = 24, title = "fnac", ...others}, ref) {
