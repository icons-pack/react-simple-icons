...
const Expressvpn = React.forwardRef<SVGSVGElement, ExpressvpnProps>(function Expressvpn(
  { color = 'currentColor', size = 24, title = 'expressvpn', ...others },
  ref,
) {
  return (
    <svg
