    ...
    export type SymfonyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Symfony = React.forwardRef<SVGSVGElement, SymfonyProps>(function Symfony({color = 'currentColor', size = 24, title = "symfony", ...others}, ref) {
