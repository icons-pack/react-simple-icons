    ...
    export type ThenorthfaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Thenorthface = React.forwardRef<SVGSVGElement, ThenorthfaceProps>(function Thenorthface({color = 'currentColor', size = 24, title = "thenorthface", ...others}, ref) {
