    ...
    export type MariadbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mariadb = React.forwardRef<SVGSVGElement, MariadbProps>(function Mariadb({color = 'currentColor', size = 24, title = "mariadb", ...others}, ref) {
