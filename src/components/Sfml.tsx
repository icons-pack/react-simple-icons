    ...
    export type SfmlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sfml = React.forwardRef<SVGSVGElement, SfmlProps>(function Sfml({color = 'currentColor', size = 24, title = "sfml", ...others}, ref) {
