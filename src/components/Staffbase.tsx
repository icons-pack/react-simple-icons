...
export type StaffbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Staffbase = React.forwardRef<SVGSVGElement, StaffbaseProps>(function Staffbase({color = 'currentColor', size = 24, title = "staffbase", ...others}, ref) {
