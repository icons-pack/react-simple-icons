    ...
    export type ScipyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Scipy = React.forwardRef<SVGSVGElement, ScipyProps>(function Scipy({color = 'currentColor', size = 24, title = "scipy", ...others}, ref) {
