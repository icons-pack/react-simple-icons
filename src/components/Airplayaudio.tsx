    ...
    export type AirplayaudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Airplayaudio = React.forwardRef<SVGSVGElement, AirplayaudioProps>(function Airplayaudio({color = 'currentColor', size = 24, title = "airplayaudio", ...others}, ref) {
