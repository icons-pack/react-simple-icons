    ...
    export type GooglefitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlefit = React.forwardRef<SVGSVGElement, GooglefitProps>(function Googlefit({color = 'currentColor', size = 24, title = "googlefit", ...others}, ref) {
