    ...
    export type BudibaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Budibase = React.forwardRef<SVGSVGElement, BudibaseProps>(function Budibase({color = 'currentColor', size = 24, title = "budibase", ...others}, ref) {
