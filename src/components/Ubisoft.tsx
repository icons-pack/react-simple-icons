    ...
    export type UbisoftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ubisoft = React.forwardRef<SVGSVGElement, UbisoftProps>(function Ubisoft({color = 'currentColor', size = 24, title = "ubisoft", ...others}, ref) {
