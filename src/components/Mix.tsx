...
export type MixProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mix = React.forwardRef<SVGSVGElement, MixProps>(function Mix({color = 'currentColor', size = 24, title = "mix", ...others}, ref) {
