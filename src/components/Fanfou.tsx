    ...
    export type FanfouProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fanfou = React.forwardRef<SVGSVGElement, FanfouProps>(function Fanfou({color = 'currentColor', size = 24, title = "fanfou", ...others}, ref) {
