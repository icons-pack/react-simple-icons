    ...
    export type TedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ted = React.forwardRef<SVGSVGElement, TedProps>(function Ted({color = 'currentColor', size = 24, title = "ted", ...others}, ref) {
