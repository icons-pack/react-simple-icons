...
export type ShazamProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Shazam = React.forwardRef<SVGSVGElement, ShazamProps>(function Shazam({color = 'currentColor', size = 24, title = "shazam", ...others}, ref) {
