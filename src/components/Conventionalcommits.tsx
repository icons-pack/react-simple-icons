...
const Conventionalcommits = React.forwardRef<SVGSVGElement, IconProps>(function Conventionalcommits({color = 'currentColor', size = 24, title = "conventionalcommits", ...others}, ref) {
