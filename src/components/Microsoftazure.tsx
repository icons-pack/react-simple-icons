    ...
    export type MicrosoftazureProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftazure = React.forwardRef<SVGSVGElement, MicrosoftazureProps>(function Microsoftazure({color = 'currentColor', size = 24, title = "microsoftazure", ...others}, ref) {
