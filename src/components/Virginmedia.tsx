    ...
    export type VirginmediaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Virginmedia = React.forwardRef<SVGSVGElement, VirginmediaProps>(function Virginmedia({color = 'currentColor', size = 24, title = "virginmedia", ...others}, ref) {
