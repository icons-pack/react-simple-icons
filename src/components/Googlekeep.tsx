    ...
    export type GooglekeepProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlekeep = React.forwardRef<SVGSVGElement, GooglekeepProps>(function Googlekeep({color = 'currentColor', size = 24, title = "googlekeep", ...others}, ref) {
