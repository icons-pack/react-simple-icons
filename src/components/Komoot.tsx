    ...
    export type KomootProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Komoot = React.forwardRef<SVGSVGElement, KomootProps>(function Komoot({color = 'currentColor', size = 24, title = "komoot", ...others}, ref) {
