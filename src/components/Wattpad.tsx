...
export type WattpadProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Wattpad = React.forwardRef<SVGSVGElement, WattpadProps>(function Wattpad({color = 'currentColor', size = 24, title = "wattpad", ...others}, ref) {
