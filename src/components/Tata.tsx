...
export type TataProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Tata = React.forwardRef<SVGSVGElement, TataProps>(function Tata({color = 'currentColor', size = 24, title = "tata", ...others}, ref) {
