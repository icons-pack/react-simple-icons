    ...
    export type MicrobitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microbit = React.forwardRef<SVGSVGElement, MicrobitProps>(function Microbit({color = 'currentColor', size = 24, title = "microbit", ...others}, ref) {
