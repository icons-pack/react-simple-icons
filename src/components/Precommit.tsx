    ...
    export type PrecommitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Precommit = React.forwardRef<SVGSVGElement, PrecommitProps>(function Precommit({color = 'currentColor', size = 24, title = "precommit", ...others}, ref) {
