    ...
    export type PolyworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Polywork = React.forwardRef<SVGSVGElement, PolyworkProps>(function Polywork({color = 'currentColor', size = 24, title = "polywork", ...others}, ref) {
