    ...
    export type PluralsightProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pluralsight = React.forwardRef<SVGSVGElement, PluralsightProps>(function Pluralsight({color = 'currentColor', size = 24, title = "pluralsight", ...others}, ref) {
