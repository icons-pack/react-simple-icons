    ...
    export type GravatarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gravatar = React.forwardRef<SVGSVGElement, GravatarProps>(function Gravatar({color = 'currentColor', size = 24, title = "gravatar", ...others}, ref) {
