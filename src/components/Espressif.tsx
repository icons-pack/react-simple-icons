...
export type EspressifProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Espressif = React.forwardRef<SVGSVGElement, EspressifProps>(function Espressif({color = 'currentColor', size = 24, title = "espressif", ...others}, ref) {
