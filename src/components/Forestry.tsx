...
export type ForestryProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Forestry = React.forwardRef<SVGSVGElement, ForestryProps>(function Forestry({color = 'currentColor', size = 24, title = "forestry", ...others}, ref) {
