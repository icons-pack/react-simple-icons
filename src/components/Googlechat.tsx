...
const Googlechat = React.forwardRef<SVGSVGElement, GooglechatProps>(function Googlechat(
  { color = 'currentColor', size = 24, title = 'googlechat', ...others },
  ref,
) {
  return (
    <svg
