    ...
    export type KocProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Koc = React.forwardRef<SVGSVGElement, KocProps>(function Koc({color = 'currentColor', size = 24, title = "koc", ...others}, ref) {
