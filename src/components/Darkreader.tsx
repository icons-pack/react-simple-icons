    ...
    export type DarkreaderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Darkreader = React.forwardRef<SVGSVGElement, DarkreaderProps>(function Darkreader({color = 'currentColor', size = 24, title = "darkreader", ...others}, ref) {
