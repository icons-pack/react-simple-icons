    ...
    export type AdobeindesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobeindesign = React.forwardRef<SVGSVGElement, AdobeindesignProps>(function Adobeindesign({color = 'currentColor', size = 24, title = "adobeindesign", ...others}, ref) {
