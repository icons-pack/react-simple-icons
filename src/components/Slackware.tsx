    ...
    export type SlackwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Slackware = React.forwardRef<SVGSVGElement, SlackwareProps>(function Slackware({color = 'currentColor', size = 24, title = "slackware", ...others}, ref) {
