    ...
    export type ShellyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Shelly = React.forwardRef<SVGSVGElement, ShellyProps>(function Shelly({color = 'currentColor', size = 24, title = "shelly", ...others}, ref) {
