    ...
    export type BankofamericaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bankofamerica = React.forwardRef<SVGSVGElement, BankofamericaProps>(function Bankofamerica({color = 'currentColor', size = 24, title = "bankofamerica", ...others}, ref) {
