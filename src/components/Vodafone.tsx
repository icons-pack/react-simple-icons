    ...
    export type VodafoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vodafone = React.forwardRef<SVGSVGElement, VodafoneProps>(function Vodafone({color = 'currentColor', size = 24, title = "vodafone", ...others}, ref) {
