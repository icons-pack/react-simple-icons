...
export type RedhatopenshiftProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Redhatopenshift = React.forwardRef<SVGSVGElement, RedhatopenshiftProps>(function Redhatopenshift({color = 'currentColor', size = 24, title = "redhatopenshift", ...others}, ref) {
