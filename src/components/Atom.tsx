    ...
    export type AtomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Atom = React.forwardRef<SVGSVGElement, AtomProps>(function Atom({color = 'currentColor', size = 24, title = "atom", ...others}, ref) {
