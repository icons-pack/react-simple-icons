...
export type CommitlintProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Commitlint = React.forwardRef<SVGSVGElement, CommitlintProps>(function Commitlint({color = 'currentColor', size = 24, title = "commitlint", ...others}, ref) {
