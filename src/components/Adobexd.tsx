    ...
    export type AdobexdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobexd = React.forwardRef<SVGSVGElement, AdobexdProps>(function Adobexd({color = 'currentColor', size = 24, title = "adobexd", ...others}, ref) {
