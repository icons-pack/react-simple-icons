    ...
    export type WprocketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wprocket = React.forwardRef<SVGSVGElement, WprocketProps>(function Wprocket({color = 'currentColor', size = 24, title = "wprocket", ...others}, ref) {
