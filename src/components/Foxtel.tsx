    ...
    export type FoxtelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Foxtel = React.forwardRef<SVGSVGElement, FoxtelProps>(function Foxtel({color = 'currentColor', size = 24, title = "foxtel", ...others}, ref) {
