...
const Playerdotme = React.forwardRef<SVGSVGElement, PlayerdotmeProps>(function Playerdotme(
  { color = 'currentColor', size = 24, title = 'playerdotme', ...others },
  ref,
) {
  return (
    <svg
