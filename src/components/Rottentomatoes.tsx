    ...
    export type RottentomatoesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rottentomatoes = React.forwardRef<SVGSVGElement, RottentomatoesProps>(function Rottentomatoes({color = 'currentColor', size = 24, title = "rottentomatoes", ...others}, ref) {
