...
const Expertsexchange = React.forwardRef<SVGSVGElement, ExpertsexchangeProps>(function Expertsexchange({color = 'currentColor', size = 24, title = "expertsexchange", ...others}, ref) {
