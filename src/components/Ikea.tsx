...
export type IkeaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ikea = React.forwardRef<SVGSVGElement, IkeaProps>(function Ikea({color = 'currentColor', size = 24, title = "ikea", ...others}, ref) {
