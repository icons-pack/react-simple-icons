    ...
    export type SolusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Solus = React.forwardRef<SVGSVGElement, SolusProps>(function Solus({color = 'currentColor', size = 24, title = "solus", ...others}, ref) {
