    ...
    export type NuxtdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nuxtdotjs = React.forwardRef<SVGSVGElement, NuxtdotjsProps>(function Nuxtdotjs({color = 'currentColor', size = 24, title = "nuxtdotjs", ...others}, ref) {
