...
export type BeatportProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Beatport = React.forwardRef<SVGSVGElement, BeatportProps>(function Beatport({color = 'currentColor', size = 24, title = "beatport", ...others}, ref) {
