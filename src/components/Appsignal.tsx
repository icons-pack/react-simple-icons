    ...
    export type AppsignalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Appsignal = React.forwardRef<SVGSVGElement, AppsignalProps>(function Appsignal({color = 'currentColor', size = 24, title = "appsignal", ...others}, ref) {
