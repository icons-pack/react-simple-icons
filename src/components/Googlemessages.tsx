    ...
    export type GooglemessagesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlemessages = React.forwardRef<SVGSVGElement, GooglemessagesProps>(function Googlemessages({color = 'currentColor', size = 24, title = "googlemessages", ...others}, ref) {
