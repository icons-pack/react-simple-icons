...
const Openaccess = React.forwardRef<SVGSVGElement, OpenaccessProps>(function Openaccess(
  { color = 'currentColor', size = 24, title = 'openaccess', ...others },
  ref,
) {
  return (
    <svg
