    ...
    export type LinuxmintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Linuxmint = React.forwardRef<SVGSVGElement, LinuxmintProps>(function Linuxmint({color = 'currentColor', size = 24, title = "linuxmint", ...others}, ref) {
