...
export type JssProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Jss = React.forwardRef<SVGSVGElement, JssProps>(function Jss({color = 'currentColor', size = 24, title = "jss", ...others}, ref) {
