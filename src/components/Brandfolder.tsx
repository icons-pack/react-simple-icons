    ...
    export type BrandfolderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Brandfolder = React.forwardRef<SVGSVGElement, BrandfolderProps>(function Brandfolder({color = 'currentColor', size = 24, title = "brandfolder", ...others}, ref) {
