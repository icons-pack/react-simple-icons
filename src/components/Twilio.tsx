    ...
    export type TwilioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Twilio = React.forwardRef<SVGSVGElement, TwilioProps>(function Twilio({color = 'currentColor', size = 24, title = "twilio", ...others}, ref) {
