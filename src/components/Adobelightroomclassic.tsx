    ...
    export type AdobelightroomclassicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adobelightroomclassic = React.forwardRef<SVGSVGElement, AdobelightroomclassicProps>(function Adobelightroomclassic({color = 'currentColor', size = 24, title = "adobelightroomclassic", ...others}, ref) {
