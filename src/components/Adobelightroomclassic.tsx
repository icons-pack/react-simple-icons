...
const Adobelightroomclassic = React.forwardRef<SVGSVGElement, IconProps>(function Adobelightroomclassic({color = 'currentColor', size = 24, title = "adobelightroomclassic", ...others}, ref) {
