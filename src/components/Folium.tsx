    ...
    export type FoliumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Folium = React.forwardRef<SVGSVGElement, FoliumProps>(function Folium({color = 'currentColor', size = 24, title = "folium", ...others}, ref) {
