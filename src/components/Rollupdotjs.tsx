    ...
    export type RollupdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rollupdotjs = React.forwardRef<SVGSVGElement, RollupdotjsProps>(function Rollupdotjs({color = 'currentColor', size = 24, title = "rollupdotjs", ...others}, ref) {
