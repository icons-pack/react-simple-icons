...
const Nextbilliondotai = React.forwardRef<SVGSVGElement, IconProps>(function Nextbilliondotai({color = 'currentColor', size = 24, title = "nextbilliondotai", ...others}, ref) {
