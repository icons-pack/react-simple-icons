    ...
    export type PimcoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Pimcore = React.forwardRef<SVGSVGElement, PimcoreProps>(function Pimcore({color = 'currentColor', size = 24, title = "pimcore", ...others}, ref) {
