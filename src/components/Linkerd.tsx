...
export type LinkerdProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Linkerd = React.forwardRef<SVGSVGElement, LinkerdProps>(function Linkerd({color = 'currentColor', size = 24, title = "linkerd", ...others}, ref) {
