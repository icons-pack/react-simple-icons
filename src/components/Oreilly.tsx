    ...
    export type OreillyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Oreilly = React.forwardRef<SVGSVGElement, OreillyProps>(function Oreilly({color = 'currentColor', size = 24, title = "oreilly", ...others}, ref) {
