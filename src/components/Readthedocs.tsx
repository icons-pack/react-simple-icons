...
export type ReadthedocsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Readthedocs = React.forwardRef<SVGSVGElement, ReadthedocsProps>(function Readthedocs({color = 'currentColor', size = 24, title = "readthedocs", ...others}, ref) {
