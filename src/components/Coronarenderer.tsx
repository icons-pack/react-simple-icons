    ...
    export type CoronarendererProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Coronarenderer = React.forwardRef<SVGSVGElement, CoronarendererProps>(function Coronarenderer({color = 'currentColor', size = 24, title = "coronarenderer", ...others}, ref) {
