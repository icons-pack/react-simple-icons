...
export type SeleniumProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Selenium = React.forwardRef<SVGSVGElement, SeleniumProps>(function Selenium({color = 'currentColor', size = 24, title = "selenium", ...others}, ref) {
