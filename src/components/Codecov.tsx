...
export type CodecovProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Codecov = React.forwardRef<SVGSVGElement, CodecovProps>(function Codecov({color = 'currentColor', size = 24, title = "codecov", ...others}, ref) {
