    ...
    export type PrometheusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Prometheus = React.forwardRef<SVGSVGElement, PrometheusProps>(function Prometheus({color = 'currentColor', size = 24, title = "prometheus", ...others}, ref) {
