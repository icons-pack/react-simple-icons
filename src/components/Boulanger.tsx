    ...
    export type BoulangerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Boulanger = React.forwardRef<SVGSVGElement, BoulangerProps>(function Boulanger({color = 'currentColor', size = 24, title = "boulanger", ...others}, ref) {
