...
export type CodepenProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Codepen = React.forwardRef<SVGSVGElement, CodepenProps>(function Codepen({color = 'currentColor', size = 24, title = "codepen", ...others}, ref) {
