...
export type MclarenProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mclaren = React.forwardRef<SVGSVGElement, MclarenProps>(function Mclaren({color = 'currentColor', size = 24, title = "mclaren", ...others}, ref) {
