    ...
    export type ChocolateyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Chocolatey = React.forwardRef<SVGSVGElement, ChocolateyProps>(function Chocolatey({color = 'currentColor', size = 24, title = "chocolatey", ...others}, ref) {
