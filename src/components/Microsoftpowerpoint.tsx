...
export type MicrosoftpowerpointProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Microsoftpowerpoint = React.forwardRef<SVGSVGElement, MicrosoftpowerpointProps>(function Microsoftpowerpoint({color = 'currentColor', size = 24, title = "microsoftpowerpoint", ...others}, ref) {
