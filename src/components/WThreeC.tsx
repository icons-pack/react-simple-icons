    ...
    export type WThreeCProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const WThreeC = React.forwardRef<SVGSVGElement, WThreeCProps>(function WThreeC({color = 'currentColor', size = 24, title = "w3c", ...others}, ref) {
