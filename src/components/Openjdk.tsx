    ...
    export type OpenjdkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Openjdk = React.forwardRef<SVGSVGElement, OpenjdkProps>(function Openjdk({color = 'currentColor', size = 24, title = "openjdk", ...others}, ref) {
