    ...
    export type ExpensifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Expensify = React.forwardRef<SVGSVGElement, ExpensifyProps>(function Expensify({color = 'currentColor', size = 24, title = "expensify", ...others}, ref) {
