    ...
    export type SapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sap = React.forwardRef<SVGSVGElement, SapProps>(function Sap({color = 'currentColor', size = 24, title = "sap", ...others}, ref) {
