    ...
    export type GnuprivacyguardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gnuprivacyguard = React.forwardRef<SVGSVGElement, GnuprivacyguardProps>(function Gnuprivacyguard({color = 'currentColor', size = 24, title = "gnuprivacyguard", ...others}, ref) {
    ...
    export default Gnuprivacyguard
