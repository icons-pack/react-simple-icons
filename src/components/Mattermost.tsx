    ...
    export type MattermostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mattermost = React.forwardRef<SVGSVGElement, MattermostProps>(function Mattermost({color = 'currentColor', size = 24, title = "mattermost", ...others}, ref) {
