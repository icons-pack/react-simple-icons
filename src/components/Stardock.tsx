    ...
    export type StardockProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Stardock = React.forwardRef<SVGSVGElement, StardockProps>(function Stardock({color = 'currentColor', size = 24, title = "stardock", ...others}, ref) {
