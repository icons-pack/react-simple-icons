    ...
    export type AmazondynamodbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Amazondynamodb = React.forwardRef<SVGSVGElement, AmazondynamodbProps>(function Amazondynamodb({color = 'currentColor', size = 24, title = "amazondynamodb", ...others}, ref) {
