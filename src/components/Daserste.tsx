...
const Daserste = React.forwardRef<SVGSVGElement, DasersteProps>(function Daserste(
  { color = 'currentColor', size = 24, title = 'daserste', ...others },
  ref,
) {
  return (
    <svg
