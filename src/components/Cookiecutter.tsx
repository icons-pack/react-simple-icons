...
export type CookiecutterProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Cookiecutter = React.forwardRef<SVGSVGElement, CookiecutterProps>(function Cookiecutter({color = 'currentColor', size = 24, title = "cookiecutter", ...others}, ref) {
