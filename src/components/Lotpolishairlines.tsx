...
const Lotpolishairlines = React.forwardRef<SVGSVGElement, IconProps>(function Lotpolishairlines({color = 'currentColor', size = 24, title = "lotpolishairlines", ...others}, ref) {
