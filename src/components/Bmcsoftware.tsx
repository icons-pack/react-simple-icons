    ...
    export type BmcsoftwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bmcsoftware = React.forwardRef<SVGSVGElement, BmcsoftwareProps>(function Bmcsoftware({color = 'currentColor', size = 24, title = "bmcsoftware", ...others}, ref) {
