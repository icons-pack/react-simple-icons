...
export type FaunaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fauna = React.forwardRef<SVGSVGElement, FaunaProps>(function Fauna({color = 'currentColor', size = 24, title = "fauna", ...others}, ref) {
