...
export type CockroachlabsProps = {
  /**
...
const Cockroachlabs = React.forwardRef<SVGSVGElement, CockroachlabsProps>(function Cockroachlabs(
  { color = 'currentColor', size = 24, title = 'cockroachlabs', ...others },
  ref,
) {
  return (
    <svg
