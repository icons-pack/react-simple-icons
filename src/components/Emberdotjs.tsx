    ...
    export type EmberdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Emberdotjs = React.forwardRef<SVGSVGElement, EmberdotjsProps>(function Emberdotjs({color = 'currentColor', size = 24, title = "emberdotjs", ...others}, ref) {
