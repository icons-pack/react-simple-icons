    ...
    export type UmbracoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Umbraco = React.forwardRef<SVGSVGElement, UmbracoProps>(function Umbraco({color = 'currentColor', size = 24, title = "umbraco", ...others}, ref) {
