    ...
    export type OhdearProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ohdear = React.forwardRef<SVGSVGElement, OhdearProps>(function Ohdear({color = 'currentColor', size = 24, title = "ohdear", ...others}, ref) {
