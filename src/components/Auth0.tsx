    ...
    export type Auth0Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Auth0 = React.forwardRef<SVGSVGElement, Auth0Props>(function Auth0({color = 'currentColor', size = 24, title = "auth0", ...others}, ref) {
