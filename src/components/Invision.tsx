    ...
    export type InvisionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Invision = React.forwardRef<SVGSVGElement, InvisionProps>(function Invision({color = 'currentColor', size = 24, title = "invision", ...others}, ref) {
