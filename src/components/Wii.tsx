    ...
    export type WiiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wii = React.forwardRef<SVGSVGElement, WiiProps>(function Wii({color = 'currentColor', size = 24, title = "wii", ...others}, ref) {
