    ...
    export type UploadedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Uploaded = React.forwardRef<SVGSVGElement, UploadedProps>(function Uploaded({color = 'currentColor', size = 24, title = "uploaded", ...others}, ref) {
