...
export type ReduxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Redux = React.forwardRef<SVGSVGElement, ReduxProps>(function Redux({color = 'currentColor', size = 24, title = "redux", ...others}, ref) {
