...
export type AtlassianProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Atlassian = React.forwardRef<SVGSVGElement, AtlassianProps>(function Atlassian({color = 'currentColor', size = 24, title = "atlassian", ...others}, ref) {
