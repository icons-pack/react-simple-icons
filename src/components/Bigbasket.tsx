    ...
    export type BigbasketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bigbasket = React.forwardRef<SVGSVGElement, BigbasketProps>(function Bigbasket({color = 'currentColor', size = 24, title = "bigbasket", ...others}, ref) {
