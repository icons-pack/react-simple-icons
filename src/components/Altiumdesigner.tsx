...
export type AltiumdesignerProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Altiumdesigner = React.forwardRef<SVGSVGElement, AltiumdesignerProps>(function Altiumdesigner({color = 'currentColor', size = 24, title = "altiumdesigner", ...others}, ref) {
