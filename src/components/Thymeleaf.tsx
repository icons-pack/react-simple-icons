...
export type ThymeleafProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Thymeleaf = React.forwardRef<SVGSVGElement, ThymeleafProps>(function Thymeleaf({color = 'currentColor', size = 24, title = "thymeleaf", ...others}, ref) {
