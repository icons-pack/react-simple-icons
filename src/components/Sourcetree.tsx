...
const Sourcetree = React.forwardRef<SVGSVGElement, SourcetreeProps>(function Sourcetree(
  { color = 'currentColor', size = 24, title = 'sourcetree', ...others },
  ref,
) {
  return (
    <svg
