    ...
    export type VlcmediaplayerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vlcmediaplayer = React.forwardRef<SVGSVGElement, VlcmediaplayerProps>(function Vlcmediaplayer({color = 'currentColor', size = 24, title = "vlcmediaplayer", ...others}, ref) {
