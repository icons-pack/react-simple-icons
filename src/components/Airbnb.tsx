...
export type AirbnbProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Airbnb = React.forwardRef<SVGSVGElement, AirbnbProps>(function Airbnb({color = 'currentColor', size = 24, title = "airbnb", ...others}, ref) {
