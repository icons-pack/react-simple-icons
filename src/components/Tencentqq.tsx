    ...
    export type TencentqqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tencentqq = React.forwardRef<SVGSVGElement, TencentqqProps>(function Tencentqq({color = 'currentColor', size = 24, title = "tencentqq", ...others}, ref) {
