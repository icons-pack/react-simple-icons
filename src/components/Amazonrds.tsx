    ...
    export type AmazonrdsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Amazonrds = React.forwardRef<SVGSVGElement, AmazonrdsProps>(function Amazonrds({color = 'currentColor', size = 24, title = "amazonrds", ...others}, ref) {
