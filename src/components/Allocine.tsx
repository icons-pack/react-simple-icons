...
export type AllocineProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Allocine = React.forwardRef<SVGSVGElement, AllocineProps>(function Allocine({color = 'currentColor', size = 24, title = "allocine", ...others}, ref) {
