    ...
    export type MercedesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mercedes = React.forwardRef<SVGSVGElement, MercedesProps>(function Mercedes({color = 'currentColor', size = 24, title = "mercedes", ...others}, ref) {
