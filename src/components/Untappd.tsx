    ...
    export type UntappdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Untappd = React.forwardRef<SVGSVGElement, UntappdProps>(function Untappd({color = 'currentColor', size = 24, title = "untappd", ...others}, ref) {
