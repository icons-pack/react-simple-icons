    ...
    export type ApplenewsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Applenews = React.forwardRef<SVGSVGElement, ApplenewsProps>(function Applenews({color = 'currentColor', size = 24, title = "applenews", ...others}, ref) {
