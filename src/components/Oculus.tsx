...
export type OculusProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Oculus = React.forwardRef<SVGSVGElement, OculusProps>(function Oculus({color = 'currentColor', size = 24, title = "oculus", ...others}, ref) {
