    ...
    export type HackeroneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hackerone = React.forwardRef<SVGSVGElement, HackeroneProps>(function Hackerone({color = 'currentColor', size = 24, title = "hackerone", ...others}, ref) {
