...
const Nintendogamecube = React.forwardRef<SVGSVGElement, NintendogamecubeProps>(function Nintendogamecube(
  { color = 'currentColor', size = 24, title = 'nintendogamecube', ...others },
  ref,
) {
  return (
    <svg
