...
const Nintendogamecube = React.forwardRef<SVGSVGElement, IconProps>(function Nintendogamecube({color = 'currentColor', size = 24, title = "nintendogamecube", ...others}, ref) {
