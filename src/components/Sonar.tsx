    ...
    export type SonarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sonar = React.forwardRef<SVGSVGElement, SonarProps>(function Sonar({color = 'currentColor', size = 24, title = "sonar", ...others}, ref) {
