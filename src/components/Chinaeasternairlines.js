...
const Chinaeasternairlines = forwardRef(function Chinaeasternairlines(
  { color = 'currentColor', size = 24, title = 'China Eastern Airlines', ...others },
  ref
) {
  return (
    <svg
...
Chinaeasternairlines.propTypes = {
  /**
