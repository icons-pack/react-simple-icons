    ...
    export type ShutterstockProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Shutterstock = React.forwardRef<SVGSVGElement, ShutterstockProps>(function Shutterstock({color = 'currentColor', size = 24, title = "shutterstock", ...others}, ref) {
