...
const Hockeyapp = forwardRef(function Hockeyapp(
  { color = 'currentColor', size = 24, title = 'HockeyApp', ...others },
  ref
) {
  return (
    <svg
