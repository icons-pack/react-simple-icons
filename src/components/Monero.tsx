    ...
    export type MoneroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Monero = React.forwardRef<SVGSVGElement, MoneroProps>(function Monero({color = 'currentColor', size = 24, title = "monero", ...others}, ref) {
