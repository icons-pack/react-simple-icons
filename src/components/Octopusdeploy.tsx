...
export type OctopusdeployProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Octopusdeploy = React.forwardRef<SVGSVGElement, OctopusdeployProps>(function Octopusdeploy({color = 'currentColor', size = 24, title = "octopusdeploy", ...others}, ref) {
