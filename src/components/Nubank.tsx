    ...
    export type NubankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nubank = React.forwardRef<SVGSVGElement, NubankProps>(function Nubank({color = 'currentColor', size = 24, title = "nubank", ...others}, ref) {
