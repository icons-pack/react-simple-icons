    ...
    const Stackexchange = React.forwardRef<SVGSVGElement, StackexchangeProps>(function Stackexchange({color = 'currentColor', size = 24, title = "stackexchange", ...others}, ref) {
