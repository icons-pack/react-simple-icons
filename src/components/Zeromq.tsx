...
export type ZeromqProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Zeromq = React.forwardRef<SVGSVGElement, ZeromqProps>(function Zeromq({color = 'currentColor', size = 24, title = "zeromq", ...others}, ref) {
