    ...
    export type FugacloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fugacloud = React.forwardRef<SVGSVGElement, FugacloudProps>(function Fugacloud({color = 'currentColor', size = 24, title = "fugacloud", ...others}, ref) {
