    ...
    export type TampermonkeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tampermonkey = React.forwardRef<SVGSVGElement, TampermonkeyProps>(function Tampermonkey({color = 'currentColor', size = 24, title = "tampermonkey", ...others}, ref) {
