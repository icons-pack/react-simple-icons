...
export type PhabricatorProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Phabricator = React.forwardRef<SVGSVGElement, PhabricatorProps>(function Phabricator({color = 'currentColor', size = 24, title = "phabricator", ...others}, ref) {
