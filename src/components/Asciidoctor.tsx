    ...
    export type AsciidoctorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Asciidoctor = React.forwardRef<SVGSVGElement, AsciidoctorProps>(function Asciidoctor({color = 'currentColor', size = 24, title = "asciidoctor", ...others}, ref) {
