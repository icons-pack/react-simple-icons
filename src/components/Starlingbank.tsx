...
export type StarlingbankProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Starlingbank = React.forwardRef<SVGSVGElement, StarlingbankProps>(function Starlingbank({color = 'currentColor', size = 24, title = "starlingbank", ...others}, ref) {
