    ...
    export type TestcafeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Testcafe = React.forwardRef<SVGSVGElement, TestcafeProps>(function Testcafe({color = 'currentColor', size = 24, title = "testcafe", ...others}, ref) {
