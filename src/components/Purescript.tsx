...
const Purescript = React.forwardRef<SVGSVGElement, PurescriptProps>(function Purescript(
  { color = 'currentColor', size = 24, title = 'purescript', ...others },
  ref,
) {
  return (
    <svg
