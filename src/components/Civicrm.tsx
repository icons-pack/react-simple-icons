    ...
    export type CivicrmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Civicrm = React.forwardRef<SVGSVGElement, CivicrmProps>(function Civicrm({color = 'currentColor', size = 24, title = "civicrm", ...others}, ref) {
