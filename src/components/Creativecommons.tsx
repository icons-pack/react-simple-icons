...
export type CreativecommonsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Creativecommons = React.forwardRef<SVGSVGElement, CreativecommonsProps>(function Creativecommons({color = 'currentColor', size = 24, title = "creativecommons", ...others}, ref) {
