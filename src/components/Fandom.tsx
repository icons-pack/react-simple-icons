    ...
    export type FandomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fandom = React.forwardRef<SVGSVGElement, FandomProps>(function Fandom({color = 'currentColor', size = 24, title = "fandom", ...others}, ref) {
