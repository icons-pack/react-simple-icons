    ...
    export type MediafireProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mediafire = React.forwardRef<SVGSVGElement, MediafireProps>(function Mediafire({color = 'currentColor', size = 24, title = "mediafire", ...others}, ref) {
