    ...
    export type CastboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Castbox = React.forwardRef<SVGSVGElement, CastboxProps>(function Castbox({color = 'currentColor', size = 24, title = "castbox", ...others}, ref) {
