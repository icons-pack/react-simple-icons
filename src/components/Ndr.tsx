    ...
    export type NdrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ndr = React.forwardRef<SVGSVGElement, NdrProps>(function Ndr({color = 'currentColor', size = 24, title = "ndr", ...others}, ref) {
