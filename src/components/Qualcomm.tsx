...
export type QualcommProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Qualcomm = React.forwardRef<SVGSVGElement, QualcommProps>(function Qualcomm({color = 'currentColor', size = 24, title = "qualcomm", ...others}, ref) {
