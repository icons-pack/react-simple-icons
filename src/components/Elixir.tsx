    ...
    export type ElixirProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Elixir = React.forwardRef<SVGSVGElement, ElixirProps>(function Elixir({color = 'currentColor', size = 24, title = "elixir", ...others}, ref) {
