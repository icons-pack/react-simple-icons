...
export type AcademiaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Academia = React.forwardRef<SVGSVGElement, AcademiaProps>(function Academia({color = 'currentColor', size = 24, title = "academia", ...others}, ref) {
