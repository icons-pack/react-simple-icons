...
const Chinaeasternairlines = React.forwardRef<SVGSVGElement, IconProps>(function Chinaeasternairlines({color = 'currentColor', size = 24, title = "chinaeasternairlines", ...others}, ref) {
