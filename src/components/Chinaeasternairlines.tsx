...
export type ChinaeasternairlinesProps = {
  /**
...
const Chinaeasternairlines = React.forwardRef<SVGSVGElement, ChinaeasternairlinesProps>(function Chinaeasternairlines(
  { color = 'currentColor', size = 24, title = 'chinaeasternairlines', ...others },
  ref,
) {
  return (
    <svg
