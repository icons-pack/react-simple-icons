    ...
    export type AralProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Aral = React.forwardRef<SVGSVGElement, AralProps>(function Aral({color = 'currentColor', size = 24, title = "aral", ...others}, ref) {
