    ...
    export type PurgecssProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Purgecss = React.forwardRef<SVGSVGElement, PurgecssProps>(function Purgecss({color = 'currentColor', size = 24, title = "purgecss", ...others}, ref) {
