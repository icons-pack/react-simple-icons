    ...
    export type ElasticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Elastic = React.forwardRef<SVGSVGElement, ElasticProps>(function Elastic({color = 'currentColor', size = 24, title = "elastic", ...others}, ref) {
