    ...
    export type SonarsourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sonarsource = React.forwardRef<SVGSVGElement, SonarsourceProps>(function Sonarsource({color = 'currentColor', size = 24, title = "sonarsource", ...others}, ref) {
