    ...
    export type FilezillaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Filezilla = React.forwardRef<SVGSVGElement, FilezillaProps>(function Filezilla({color = 'currentColor', size = 24, title = "filezilla", ...others}, ref) {
