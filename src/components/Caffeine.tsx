    ...
    export type CaffeineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Caffeine = React.forwardRef<SVGSVGElement, CaffeineProps>(function Caffeine({color = 'currentColor', size = 24, title = "caffeine", ...others}, ref) {
