    ...
    export type MaxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Max = React.forwardRef<SVGSVGElement, MaxProps>(function Max({color = 'currentColor', size = 24, title = "max", ...others}, ref) {
