    ...
    export type Sat1Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sat1 = React.forwardRef<SVGSVGElement, Sat1Props>(function Sat1({color = 'currentColor', size = 24, title = "sat1", ...others}, ref) {
