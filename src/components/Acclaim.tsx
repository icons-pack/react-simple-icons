    ...
    export type AcclaimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Acclaim = React.forwardRef<SVGSVGElement, AcclaimProps>(function Acclaim({color = 'currentColor', size = 24, title = "acclaim", ...others}, ref) {
