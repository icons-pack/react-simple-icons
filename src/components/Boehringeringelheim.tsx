...
export type BoehringeringelheimProps = {
  /**
...
const Boehringeringelheim = React.forwardRef<SVGSVGElement, BoehringeringelheimProps>(function Boehringeringelheim(
  { color = 'currentColor', size = 24, title = 'boehringeringelheim', ...others },
  ref,
) {
  return (
    <svg
