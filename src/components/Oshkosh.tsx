    ...
    export type OshkoshProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Oshkosh = React.forwardRef<SVGSVGElement, OshkoshProps>(function Oshkosh({color = 'currentColor', size = 24, title = "oshkosh", ...others}, ref) {
