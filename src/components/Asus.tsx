    ...
    export type AsusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Asus = React.forwardRef<SVGSVGElement, AsusProps>(function Asus({color = 'currentColor', size = 24, title = "asus", ...others}, ref) {
