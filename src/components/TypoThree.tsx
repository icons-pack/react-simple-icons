...
export type TypoThreeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const TypoThree = React.forwardRef<SVGSVGElement, TypoThreeProps>(function TypoThree({color = 'currentColor', size = 24, title = "typo3", ...others}, ref) {
