    ...
    export type AdguardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adguard = React.forwardRef<SVGSVGElement, AdguardProps>(function Adguard({color = 'currentColor', size = 24, title = "adguard", ...others}, ref) {
