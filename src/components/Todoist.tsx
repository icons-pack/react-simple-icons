...
export type TodoistProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Todoist = React.forwardRef<SVGSVGElement, TodoistProps>(function Todoist({color = 'currentColor', size = 24, title = "todoist", ...others}, ref) {
