    ...
    export type MlflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mlflow = React.forwardRef<SVGSVGElement, MlflowProps>(function Mlflow({color = 'currentColor', size = 24, title = "mlflow", ...others}, ref) {
