    ...
    export type InkscapeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Inkscape = React.forwardRef<SVGSVGElement, InkscapeProps>(function Inkscape({color = 'currentColor', size = 24, title = "inkscape", ...others}, ref) {
