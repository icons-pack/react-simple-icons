...
export type PlayerfmProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Playerfm = React.forwardRef<SVGSVGElement, PlayerfmProps>(function Playerfm({color = 'currentColor', size = 24, title = "playerfm", ...others}, ref) {
