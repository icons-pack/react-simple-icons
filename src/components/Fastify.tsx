...
export type FastifyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fastify = React.forwardRef<SVGSVGElement, FastifyProps>(function Fastify({color = 'currentColor', size = 24, title = "fastify", ...others}, ref) {
