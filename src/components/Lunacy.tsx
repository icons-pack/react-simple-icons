...
export type LunacyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Lunacy = React.forwardRef<SVGSVGElement, LunacyProps>(function Lunacy({color = 'currentColor', size = 24, title = "lunacy", ...others}, ref) {
