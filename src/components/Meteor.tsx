    ...
    export type MeteorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Meteor = React.forwardRef<SVGSVGElement, MeteorProps>(function Meteor({color = 'currentColor', size = 24, title = "meteor", ...others}, ref) {
