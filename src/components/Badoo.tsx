...
export type BadooProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Badoo = React.forwardRef<SVGSVGElement, BadooProps>(function Badoo({color = 'currentColor', size = 24, title = "badoo", ...others}, ref) {
