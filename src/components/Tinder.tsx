    ...
    export type TinderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tinder = React.forwardRef<SVGSVGElement, TinderProps>(function Tinder({color = 'currentColor', size = 24, title = "tinder", ...others}, ref) {
