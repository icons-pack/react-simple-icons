...
export type RomeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Rome = React.forwardRef<SVGSVGElement, RomeProps>(function Rome({color = 'currentColor', size = 24, title = "rome", ...others}, ref) {
