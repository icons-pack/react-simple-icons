    ...
    export type TargetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Target = React.forwardRef<SVGSVGElement, TargetProps>(function Target({color = 'currentColor', size = 24, title = "target", ...others}, ref) {
