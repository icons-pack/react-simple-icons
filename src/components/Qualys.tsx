...
export type QualysProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Qualys = React.forwardRef<SVGSVGElement, QualysProps>(function Qualys({color = 'currentColor', size = 24, title = "qualys", ...others}, ref) {
