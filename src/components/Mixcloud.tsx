...
export type MixcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mixcloud = React.forwardRef<SVGSVGElement, MixcloudProps>(function Mixcloud({color = 'currentColor', size = 24, title = "mixcloud", ...others}, ref) {
