    ...
    export type HttpieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Httpie = React.forwardRef<SVGSVGElement, HttpieProps>(function Httpie({color = 'currentColor', size = 24, title = "httpie", ...others}, ref) {
