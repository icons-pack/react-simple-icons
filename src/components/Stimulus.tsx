    ...
    export type StimulusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Stimulus = React.forwardRef<SVGSVGElement, StimulusProps>(function Stimulus({color = 'currentColor', size = 24, title = "stimulus", ...others}, ref) {
