    ...
    export type BitcoinsvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bitcoinsv = React.forwardRef<SVGSVGElement, BitcoinsvProps>(function Bitcoinsv({color = 'currentColor', size = 24, title = "bitcoinsv", ...others}, ref) {
