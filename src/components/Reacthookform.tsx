    ...
    export type ReacthookformProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Reacthookform = React.forwardRef<SVGSVGElement, ReacthookformProps>(function Reacthookform({color = 'currentColor', size = 24, title = "reacthookform", ...others}, ref) {
