    ...
    export type MakerbotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Makerbot = React.forwardRef<SVGSVGElement, MakerbotProps>(function Makerbot({color = 'currentColor', size = 24, title = "makerbot", ...others}, ref) {
