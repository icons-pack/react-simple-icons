...
export type ScrutinizerciProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Scrutinizerci = React.forwardRef<SVGSVGElement, ScrutinizerciProps>(function Scrutinizerci({color = 'currentColor', size = 24, title = "scrutinizerci", ...others}, ref) {
