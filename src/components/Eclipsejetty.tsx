...
export type EclipsejettyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Eclipsejetty = React.forwardRef<SVGSVGElement, EclipsejettyProps>(function Eclipsejetty({color = 'currentColor', size = 24, title = "eclipsejetty", ...others}, ref) {
