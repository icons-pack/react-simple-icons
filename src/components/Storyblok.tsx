...
export type StoryblokProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Storyblok = React.forwardRef<SVGSVGElement, StoryblokProps>(function Storyblok({color = 'currentColor', size = 24, title = "storyblok", ...others}, ref) {
