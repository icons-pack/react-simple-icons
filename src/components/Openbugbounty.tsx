    ...
    export type OpenbugbountyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Openbugbounty = React.forwardRef<SVGSVGElement, OpenbugbountyProps>(function Openbugbounty({color = 'currentColor', size = 24, title = "openbugbounty", ...others}, ref) {
