    ...
    export type RubocopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rubocop = React.forwardRef<SVGSVGElement, RubocopProps>(function Rubocop({color = 'currentColor', size = 24, title = "rubocop", ...others}, ref) {
