...
export type HackclubProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Hackclub = React.forwardRef<SVGSVGElement, HackclubProps>(function Hackclub({color = 'currentColor', size = 24, title = "hackclub", ...others}, ref) {
