    ...
    export type HitachiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hitachi = React.forwardRef<SVGSVGElement, HitachiProps>(function Hitachi({color = 'currentColor', size = 24, title = "hitachi", ...others}, ref) {
