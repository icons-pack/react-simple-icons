...
export type GnuemacsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Gnuemacs = React.forwardRef<SVGSVGElement, GnuemacsProps>(function Gnuemacs({color = 'currentColor', size = 24, title = "gnuemacs", ...others}, ref) {
