    ...
    export type FrontendmentorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Frontendmentor = React.forwardRef<SVGSVGElement, FrontendmentorProps>(function Frontendmentor({color = 'currentColor', size = 24, title = "frontendmentor", ...others}, ref) {
