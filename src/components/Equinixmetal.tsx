    ...
    export type EquinixmetalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Equinixmetal = React.forwardRef<SVGSVGElement, EquinixmetalProps>(function Equinixmetal({color = 'currentColor', size = 24, title = "equinixmetal", ...others}, ref) {
