    ...
    export type FujitsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fujitsu = React.forwardRef<SVGSVGElement, FujitsuProps>(function Fujitsu({color = 'currentColor', size = 24, title = "fujitsu", ...others}, ref) {
