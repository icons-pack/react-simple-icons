...
export type PolyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Poly = React.forwardRef<SVGSVGElement, PolyProps>(function Poly({color = 'currentColor', size = 24, title = "poly", ...others}, ref) {
