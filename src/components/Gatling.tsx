    ...
    export type GatlingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gatling = React.forwardRef<SVGSVGElement, GatlingProps>(function Gatling({color = 'currentColor', size = 24, title = "gatling", ...others}, ref) {
