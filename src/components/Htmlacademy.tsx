...
const Htmlacademy = React.forwardRef<SVGSVGElement, HtmlacademyProps>(function Htmlacademy(
  { color = 'currentColor', size = 24, title = 'htmlacademy', ...others },
  ref,
) {
  return (
    <svg
