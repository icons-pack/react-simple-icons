...
export type AddthisProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Addthis = React.forwardRef<SVGSVGElement, AddthisProps>(function Addthis({color = 'currentColor', size = 24, title = "addthis", ...others}, ref) {
