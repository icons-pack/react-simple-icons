...
const Microsoftonedrive = React.forwardRef<SVGSVGElement, MicrosoftonedriveProps>(function Microsoftonedrive(
  { color = 'currentColor', size = 24, title = 'microsoftonedrive', ...others },
  ref,
) {
  return (
    <svg
