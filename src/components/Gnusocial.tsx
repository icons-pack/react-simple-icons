    ...
    export type GnusocialProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gnusocial = React.forwardRef<SVGSVGElement, GnusocialProps>(function Gnusocial({color = 'currentColor', size = 24, title = "gnusocial", ...others}, ref) {
