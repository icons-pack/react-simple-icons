    ...
    export type BoschProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bosch = React.forwardRef<SVGSVGElement, BoschProps>(function Bosch({color = 'currentColor', size = 24, title = "bosch", ...others}, ref) {
