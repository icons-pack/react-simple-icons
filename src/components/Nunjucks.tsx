...
export type NunjucksProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nunjucks = React.forwardRef<SVGSVGElement, NunjucksProps>(function Nunjucks({color = 'currentColor', size = 24, title = "nunjucks", ...others}, ref) {
