...
export type XdotorgProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Xdotorg = React.forwardRef<SVGSVGElement, XdotorgProps>(function Xdotorg({color = 'currentColor', size = 24, title = "xdotorg", ...others}, ref) {
