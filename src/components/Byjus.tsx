    ...
    export type ByjusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Byjus = React.forwardRef<SVGSVGElement, ByjusProps>(function Byjus({color = 'currentColor', size = 24, title = "byjus", ...others}, ref) {
