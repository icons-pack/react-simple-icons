    ...
    export type CodersrankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codersrank = React.forwardRef<SVGSVGElement, CodersrankProps>(function Codersrank({color = 'currentColor', size = 24, title = "codersrank", ...others}, ref) {
