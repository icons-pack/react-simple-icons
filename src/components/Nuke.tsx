    ...
    export type NukeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nuke = React.forwardRef<SVGSVGElement, NukeProps>(function Nuke({color = 'currentColor', size = 24, title = "nuke", ...others}, ref) {
