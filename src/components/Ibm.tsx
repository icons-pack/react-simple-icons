    ...
    export type IbmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ibm = React.forwardRef<SVGSVGElement, IbmProps>(function Ibm({color = 'currentColor', size = 24, title = "ibm", ...others}, ref) {
