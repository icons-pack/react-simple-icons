    ...
    export type CodebergProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codeberg = React.forwardRef<SVGSVGElement, CodebergProps>(function Codeberg({color = 'currentColor', size = 24, title = "codeberg", ...others}, ref) {
