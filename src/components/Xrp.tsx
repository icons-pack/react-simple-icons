    ...
    export type XrpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Xrp = React.forwardRef<SVGSVGElement, XrpProps>(function Xrp({color = 'currentColor', size = 24, title = "xrp", ...others}, ref) {
