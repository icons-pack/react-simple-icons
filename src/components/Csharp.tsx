...
export type CsharpProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Csharp = React.forwardRef<SVGSVGElement, CsharpProps>(function Csharp({color = 'currentColor', size = 24, title = "csharp", ...others}, ref) {
