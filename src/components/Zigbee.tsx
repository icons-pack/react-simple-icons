    ...
    export type ZigbeeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zigbee = React.forwardRef<SVGSVGElement, ZigbeeProps>(function Zigbee({color = 'currentColor', size = 24, title = "zigbee", ...others}, ref) {
