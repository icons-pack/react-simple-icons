    ...
    export type MidiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Midi = React.forwardRef<SVGSVGElement, MidiProps>(function Midi({color = 'currentColor', size = 24, title = "midi", ...others}, ref) {
