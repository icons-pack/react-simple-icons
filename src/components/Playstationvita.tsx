    ...
    export type PlaystationvitaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Playstationvita = React.forwardRef<SVGSVGElement, PlaystationvitaProps>(function Playstationvita({color = 'currentColor', size = 24, title = "playstationvita", ...others}, ref) {
