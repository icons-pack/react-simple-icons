    ...
    export type CesiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Cesium = React.forwardRef<SVGSVGElement, CesiumProps>(function Cesium({color = 'currentColor', size = 24, title = "cesium", ...others}, ref) {
