    ...
    export type DtubeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dtube = React.forwardRef<SVGSVGElement, DtubeProps>(function Dtube({color = 'currentColor', size = 24, title = "dtube", ...others}, ref) {
