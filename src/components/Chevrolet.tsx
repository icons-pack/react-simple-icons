    ...
    export type ChevroletProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Chevrolet = React.forwardRef<SVGSVGElement, ChevroletProps>(function Chevrolet({color = 'currentColor', size = 24, title = "chevrolet", ...others}, ref) {
