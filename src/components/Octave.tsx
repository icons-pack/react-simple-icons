    ...
    export type OctaveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Octave = React.forwardRef<SVGSVGElement, OctaveProps>(function Octave({color = 'currentColor', size = 24, title = "octave", ...others}, ref) {
