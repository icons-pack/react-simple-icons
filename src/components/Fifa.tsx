    ...
    export type FifaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fifa = React.forwardRef<SVGSVGElement, FifaProps>(function Fifa({color = 'currentColor', size = 24, title = "fifa", ...others}, ref) {
