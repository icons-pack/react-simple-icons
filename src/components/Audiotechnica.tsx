...
export type AudiotechnicaProps = {
  /**
...
const Audiotechnica = React.forwardRef<SVGSVGElement, AudiotechnicaProps>(function Audiotechnica(
  { color = 'currentColor', size = 24, title = 'audiotechnica', ...others },
  ref,
) {
  return (
    <svg
