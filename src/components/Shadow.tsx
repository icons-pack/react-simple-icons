    ...
    export type ShadowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Shadow = React.forwardRef<SVGSVGElement, ShadowProps>(function Shadow({color = 'currentColor', size = 24, title = "shadow", ...others}, ref) {
