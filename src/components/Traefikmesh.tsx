...
const Traefikmesh = React.forwardRef<SVGSVGElement, TraefikmeshProps>(function Traefikmesh(
  { color = 'currentColor', size = 24, title = 'traefikmesh', ...others },
  ref,
) {
  return (
    <svg
