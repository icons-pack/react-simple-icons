...
export type WetransferProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Wetransfer = React.forwardRef<SVGSVGElement, WetransferProps>(function Wetransfer({color = 'currentColor', size = 24, title = "wetransfer", ...others}, ref) {
