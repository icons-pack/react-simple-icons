    ...
    export type LoopbackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Loopback = React.forwardRef<SVGSVGElement, LoopbackProps>(function Loopback({color = 'currentColor', size = 24, title = "loopback", ...others}, ref) {
