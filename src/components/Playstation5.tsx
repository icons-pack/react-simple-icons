    ...
    export type Playstation5Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Playstation5 = React.forwardRef<SVGSVGElement, Playstation5Props>(function Playstation5({color = 'currentColor', size = 24, title = "playstation5", ...others}, ref) {
