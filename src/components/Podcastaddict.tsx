    ...
    export type PodcastaddictProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Podcastaddict = React.forwardRef<SVGSVGElement, PodcastaddictProps>(function Podcastaddict({color = 'currentColor', size = 24, title = "podcastaddict", ...others}, ref) {
