    ...
    export type GnometerminalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gnometerminal = React.forwardRef<SVGSVGElement, GnometerminalProps>(function Gnometerminal({color = 'currentColor', size = 24, title = "gnometerminal", ...others}, ref) {
