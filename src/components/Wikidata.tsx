    ...
    export type WikidataProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wikidata = React.forwardRef<SVGSVGElement, WikidataProps>(function Wikidata({color = 'currentColor', size = 24, title = "wikidata", ...others}, ref) {
