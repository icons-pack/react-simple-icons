...
export type NextcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nextcloud = React.forwardRef<SVGSVGElement, NextcloudProps>(function Nextcloud({color = 'currentColor', size = 24, title = "nextcloud", ...others}, ref) {
