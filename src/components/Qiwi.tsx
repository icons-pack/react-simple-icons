    ...
    export type QiwiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Qiwi = React.forwardRef<SVGSVGElement, QiwiProps>(function Qiwi({color = 'currentColor', size = 24, title = "qiwi", ...others}, ref) {
