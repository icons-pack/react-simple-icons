    ...
    export type ReduxsagaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Reduxsaga = React.forwardRef<SVGSVGElement, ReduxsagaProps>(function Reduxsaga({color = 'currentColor', size = 24, title = "reduxsaga", ...others}, ref) {
