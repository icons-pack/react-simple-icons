...
export type RepublicofgamersProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Republicofgamers = React.forwardRef<SVGSVGElement, RepublicofgamersProps>(function Republicofgamers({color = 'currentColor', size = 24, title = "republicofgamers", ...others}, ref) {
...
export default Republicofgamers;
