...
const Securityscorecard = React.forwardRef<SVGSVGElement, IconProps>(function Securityscorecard({color = 'currentColor', size = 24, title = "securityscorecard", ...others}, ref) {
