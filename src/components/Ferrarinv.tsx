    ...
    export type FerrarinvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ferrarinv = React.forwardRef<SVGSVGElement, FerrarinvProps>(function Ferrarinv({color = 'currentColor', size = 24, title = "ferrarinv", ...others}, ref) {
