    ...
    export type OperaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Opera = React.forwardRef<SVGSVGElement, OperaProps>(function Opera({color = 'currentColor', size = 24, title = "opera", ...others}, ref) {
