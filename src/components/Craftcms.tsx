...
export type CraftcmsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Craftcms = React.forwardRef<SVGSVGElement, CraftcmsProps>(function Craftcms({color = 'currentColor', size = 24, title = "craftcms", ...others}, ref) {
