    ...
    export type DerspiegelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Derspiegel = React.forwardRef<SVGSVGElement, DerspiegelProps>(function Derspiegel({color = 'currentColor', size = 24, title = "derspiegel", ...others}, ref) {
