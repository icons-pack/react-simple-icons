...
const Webmoney = React.forwardRef<SVGSVGElement, WebmoneyProps>(function Webmoney(
  { color = 'currentColor', size = 24, title = 'webmoney', ...others },
  ref,
) {
  return (
    <svg
