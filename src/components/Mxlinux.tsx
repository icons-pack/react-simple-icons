...
export type MxlinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mxlinux = React.forwardRef<SVGSVGElement, MxlinuxProps>(function Mxlinux({color = 'currentColor', size = 24, title = "mxlinux", ...others}, ref) {
