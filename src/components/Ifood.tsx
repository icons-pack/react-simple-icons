...
export type IfoodProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Ifood = React.forwardRef<SVGSVGElement, IfoodProps>(function Ifood({color = 'currentColor', size = 24, title = "ifood", ...others}, ref) {
