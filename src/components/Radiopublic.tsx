    ...
    export type RadiopublicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Radiopublic = React.forwardRef<SVGSVGElement, RadiopublicProps>(function Radiopublic({color = 'currentColor', size = 24, title = "radiopublic", ...others}, ref) {
