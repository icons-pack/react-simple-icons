    ...
    export type ValorantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Valorant = React.forwardRef<SVGSVGElement, ValorantProps>(function Valorant({color = 'currentColor', size = 24, title = "valorant", ...others}, ref) {
