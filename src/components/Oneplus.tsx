...
export type OneplusProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Oneplus = React.forwardRef<SVGSVGElement, OneplusProps>(function Oneplus({color = 'currentColor', size = 24, title = "oneplus", ...others}, ref) {
