    ...
    export type HiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hive = React.forwardRef<SVGSVGElement, HiveProps>(function Hive({color = 'currentColor', size = 24, title = "hive", ...others}, ref) {
