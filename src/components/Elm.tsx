...
export type ElmProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Elm = React.forwardRef<SVGSVGElement, ElmProps>(function Elm({color = 'currentColor', size = 24, title = "elm", ...others}, ref) {
