    ...
    export type JamstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jamstack = React.forwardRef<SVGSVGElement, JamstackProps>(function Jamstack({color = 'currentColor', size = 24, title = "jamstack", ...others}, ref) {
