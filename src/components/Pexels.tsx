...
export type PexelsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Pexels = React.forwardRef<SVGSVGElement, PexelsProps>(function Pexels({color = 'currentColor', size = 24, title = "pexels", ...others}, ref) {
