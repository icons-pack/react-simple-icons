...
const Sanfranciscomunicipalrailway = React.forwardRef<SVGSVGElement, SanfranciscomunicipalrailwayProps>(
  function Sanfranciscomunicipalrailway(
    { color = 'currentColor', size = 24, title = 'sanfranciscomunicipalrailway', ...others },
    ref,
  ) {
    return (
      <svg
