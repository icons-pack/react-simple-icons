...
export type MampProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Mamp = React.forwardRef<SVGSVGElement, MampProps>(function Mamp({color = 'currentColor', size = 24, title = "mamp", ...others}, ref) {
