...
export type ScalewayProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Scaleway = React.forwardRef<SVGSVGElement, ScalewayProps>(function Scaleway({color = 'currentColor', size = 24, title = "scaleway", ...others}, ref) {
