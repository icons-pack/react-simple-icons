    ...
    export type GooglepayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Googlepay = React.forwardRef<SVGSVGElement, GooglepayProps>(function Googlepay({color = 'currentColor', size = 24, title = "googlepay", ...others}, ref) {
