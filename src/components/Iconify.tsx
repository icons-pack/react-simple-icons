    ...
    export type IconifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Iconify = React.forwardRef<SVGSVGElement, IconifyProps>(function Iconify({color = 'currentColor', size = 24, title = "iconify", ...others}, ref) {
