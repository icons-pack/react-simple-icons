...
export type SogouProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Sogou = React.forwardRef<SVGSVGElement, SogouProps>(function Sogou({color = 'currentColor', size = 24, title = "sogou", ...others}, ref) {
