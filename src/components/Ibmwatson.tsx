    ...
    export type IbmwatsonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ibmwatson = React.forwardRef<SVGSVGElement, IbmwatsonProps>(function Ibmwatson({color = 'currentColor', size = 24, title = "ibmwatson", ...others}, ref) {
