...
const Transportforlondon = React.forwardRef<SVGSVGElement, IconProps>(function Transportforlondon({color = 'currentColor', size = 24, title = "transportforlondon", ...others}, ref) {
