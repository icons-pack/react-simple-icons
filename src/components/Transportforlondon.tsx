...
const Transportforlondon = React.forwardRef<SVGSVGElement, TransportforlondonProps>(function Transportforlondon({color = 'currentColor', size = 24, title = "transportforlondon", ...others}, ref) {
