    ...
    export type MobxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Mobx = React.forwardRef<SVGSVGElement, MobxProps>(function Mobx({color = 'currentColor', size = 24, title = "mobx", ...others}, ref) {
