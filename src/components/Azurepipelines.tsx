...
export type AzurepipelinesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Azurepipelines = React.forwardRef<SVGSVGElement, AzurepipelinesProps>(function Azurepipelines({color = 'currentColor', size = 24, title = "azurepipelines", ...others}, ref) {
