    ...
    export type JamesonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jameson = React.forwardRef<SVGSVGElement, JamesonProps>(function Jameson({color = 'currentColor', size = 24, title = "jameson", ...others}, ref) {
