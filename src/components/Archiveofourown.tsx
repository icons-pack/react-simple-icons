    ...
    export type ArchiveofourownProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Archiveofourown = React.forwardRef<SVGSVGElement, ArchiveofourownProps>(function Archiveofourown({color = 'currentColor', size = 24, title = "archiveofourown", ...others}, ref) {
