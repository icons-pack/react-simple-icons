...
export type ProbotProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Probot = React.forwardRef<SVGSVGElement, ProbotProps>(function Probot({color = 'currentColor', size = 24, title = "probot", ...others}, ref) {
