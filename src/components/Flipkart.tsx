    ...
    export type FlipkartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Flipkart = React.forwardRef<SVGSVGElement, FlipkartProps>(function Flipkart({color = 'currentColor', size = 24, title = "flipkart", ...others}, ref) {
