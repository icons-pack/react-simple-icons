    ...
    export type VelogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Velog = React.forwardRef<SVGSVGElement, VelogProps>(function Velog({color = 'currentColor', size = 24, title = "velog", ...others}, ref) {
