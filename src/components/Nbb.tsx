...
export type NbbProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nbb = React.forwardRef<SVGSVGElement, NbbProps>(function Nbb({color = 'currentColor', size = 24, title = "nbb", ...others}, ref) {
