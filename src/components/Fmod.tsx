    ...
    export type FmodProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fmod = React.forwardRef<SVGSVGElement, FmodProps>(function Fmod({color = 'currentColor', size = 24, title = "fmod", ...others}, ref) {
