...
export type MoleculerProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Moleculer = React.forwardRef<SVGSVGElement, MoleculerProps>(function Moleculer({color = 'currentColor', size = 24, title = "moleculer", ...others}, ref) {
