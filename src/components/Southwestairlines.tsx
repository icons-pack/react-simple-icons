...
export type SouthwestairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Southwestairlines = React.forwardRef<SVGSVGElement, SouthwestairlinesProps>(function Southwestairlines({color = 'currentColor', size = 24, title = "southwestairlines", ...others}, ref) {
