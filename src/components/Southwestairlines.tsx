...
const Southwestairlines = React.forwardRef<SVGSVGElement, IconProps>(function Southwestairlines({color = 'currentColor', size = 24, title = "southwestairlines", ...others}, ref) {
