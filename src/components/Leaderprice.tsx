    ...
    export type LeaderpriceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Leaderprice = React.forwardRef<SVGSVGElement, LeaderpriceProps>(function Leaderprice({color = 'currentColor', size = 24, title = "leaderprice", ...others}, ref) {
