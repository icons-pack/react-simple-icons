    ...
    export type DebianProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Debian = React.forwardRef<SVGSVGElement, DebianProps>(function Debian({color = 'currentColor', size = 24, title = "debian", ...others}, ref) {
