...
export type TrendmicroProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Trendmicro = React.forwardRef<SVGSVGElement, TrendmicroProps>(function Trendmicro({color = 'currentColor', size = 24, title = "trendmicro", ...others}, ref) {
