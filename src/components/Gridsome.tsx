    ...
    export type GridsomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gridsome = React.forwardRef<SVGSVGElement, GridsomeProps>(function Gridsome({color = 'currentColor', size = 24, title = "gridsome", ...others}, ref) {
