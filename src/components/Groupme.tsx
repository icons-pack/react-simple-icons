    ...
    export type GroupmeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Groupme = React.forwardRef<SVGSVGElement, GroupmeProps>(function Groupme({color = 'currentColor', size = 24, title = "groupme", ...others}, ref) {
