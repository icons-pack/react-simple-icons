    ...
    export type VenmoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Venmo = React.forwardRef<SVGSVGElement, VenmoProps>(function Venmo({color = 'currentColor', size = 24, title = "venmo", ...others}, ref) {
