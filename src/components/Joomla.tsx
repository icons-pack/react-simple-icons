    ...
    export type JoomlaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Joomla = React.forwardRef<SVGSVGElement, JoomlaProps>(function Joomla({color = 'currentColor', size = 24, title = "joomla", ...others}, ref) {
