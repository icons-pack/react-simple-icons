...
export type VimProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Vim = React.forwardRef<SVGSVGElement, VimProps>(function Vim({color = 'currentColor', size = 24, title = "vim", ...others}, ref) {
