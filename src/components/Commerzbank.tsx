    ...
    export type CommerzbankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Commerzbank = React.forwardRef<SVGSVGElement, CommerzbankProps>(function Commerzbank({color = 'currentColor', size = 24, title = "commerzbank", ...others}, ref) {
