    ...
    export type TopcoderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Topcoder = React.forwardRef<SVGSVGElement, TopcoderProps>(function Topcoder({color = 'currentColor', size = 24, title = "topcoder", ...others}, ref) {
