...
export type CeleryProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Celery = React.forwardRef<SVGSVGElement, CeleryProps>(function Celery({color = 'currentColor', size = 24, title = "celery", ...others}, ref) {
