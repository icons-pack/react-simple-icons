    ...
    export type GitlfsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Gitlfs = React.forwardRef<SVGSVGElement, GitlfsProps>(function Gitlfs({color = 'currentColor', size = 24, title = "gitlfs", ...others}, ref) {
