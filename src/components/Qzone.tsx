...
export type QzoneProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Qzone = React.forwardRef<SVGSVGElement, QzoneProps>(function Qzone({color = 'currentColor', size = 24, title = "qzone", ...others}, ref) {
