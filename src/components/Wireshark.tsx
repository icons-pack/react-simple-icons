    ...
    export type WiresharkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Wireshark = React.forwardRef<SVGSVGElement, WiresharkProps>(function Wireshark({color = 'currentColor', size = 24, title = "wireshark", ...others}, ref) {
