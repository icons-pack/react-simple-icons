    ...
    export type TrainerroadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Trainerroad = React.forwardRef<SVGSVGElement, TrainerroadProps>(function Trainerroad({color = 'currentColor', size = 24, title = "trainerroad", ...others}, ref) {
