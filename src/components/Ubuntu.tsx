    ...
    export type UbuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ubuntu = React.forwardRef<SVGSVGElement, UbuntuProps>(function Ubuntu({color = 'currentColor', size = 24, title = "ubuntu", ...others}, ref) {
