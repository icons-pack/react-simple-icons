    ...
    export type FlathubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Flathub = React.forwardRef<SVGSVGElement, FlathubProps>(function Flathub({color = 'currentColor', size = 24, title = "flathub", ...others}, ref) {
