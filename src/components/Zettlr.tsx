    ...
    export type ZettlrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zettlr = React.forwardRef<SVGSVGElement, ZettlrProps>(function Zettlr({color = 'currentColor', size = 24, title = "zettlr", ...others}, ref) {
