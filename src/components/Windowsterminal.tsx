...
export type WindowsterminalProps = {
  /**
...
const Windowsterminal = React.forwardRef<SVGSVGElement, WindowsterminalProps>(function Windowsterminal(
  { color = 'currentColor', size = 24, title = 'windowsterminal', ...others },
  ref,
) {
  return (
    <svg
