...
export type NugetProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Nuget = React.forwardRef<SVGSVGElement, NugetProps>(function Nuget({color = 'currentColor', size = 24, title = "nuget", ...others}, ref) {
