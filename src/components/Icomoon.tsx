    ...
    export type IcomoonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Icomoon = React.forwardRef<SVGSVGElement, IcomoonProps>(function Icomoon({color = 'currentColor', size = 24, title = "icomoon", ...others}, ref) {
