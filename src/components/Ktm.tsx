    ...
    export type KtmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Ktm = React.forwardRef<SVGSVGElement, KtmProps>(function Ktm({color = 'currentColor', size = 24, title = "ktm", ...others}, ref) {
