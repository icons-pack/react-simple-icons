    ...
    export type LenovoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lenovo = React.forwardRef<SVGSVGElement, LenovoProps>(function Lenovo({color = 'currentColor', size = 24, title = "lenovo", ...others}, ref) {
