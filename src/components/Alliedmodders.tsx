    ...
    export type AlliedmoddersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Alliedmodders = React.forwardRef<SVGSVGElement, AlliedmoddersProps>(function Alliedmodders({color = 'currentColor', size = 24, title = "alliedmodders", ...others}, ref) {
