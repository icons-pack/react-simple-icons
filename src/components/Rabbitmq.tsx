    ...
    export type RabbitmqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rabbitmq = React.forwardRef<SVGSVGElement, RabbitmqProps>(function Rabbitmq({color = 'currentColor', size = 24, title = "rabbitmq", ...others}, ref) {
