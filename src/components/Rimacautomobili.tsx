    ...
    export type RimacautomobiliProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rimacautomobili = React.forwardRef<SVGSVGElement, RimacautomobiliProps>(function Rimacautomobili({color = 'currentColor', size = 24, title = "rimacautomobili", ...others}, ref) {
    ...
    export default Rimacautomobili
