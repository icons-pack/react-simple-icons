    ...
    export type FluentdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Fluentd = React.forwardRef<SVGSVGElement, FluentdProps>(function Fluentd({color = 'currentColor', size = 24, title = "fluentd", ...others}, ref) {
