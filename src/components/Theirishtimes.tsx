...
export type TheirishtimesProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Theirishtimes = React.forwardRef<SVGSVGElement, TheirishtimesProps>(function Theirishtimes({color = 'currentColor', size = 24, title = "theirishtimes", ...others}, ref) {
