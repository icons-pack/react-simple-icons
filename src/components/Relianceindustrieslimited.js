...
const Relianceindustrieslimited = forwardRef(function Relianceindustrieslimited(
  { color = 'currentColor', size = 24, title = 'Reliance Industries Limited', ...others },
  ref
) {
  return (
    <svg
...
Relianceindustrieslimited.propTypes = {
  /**
