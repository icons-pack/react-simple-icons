    ...
    export type AwslambdaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Awslambda = React.forwardRef<SVGSVGElement, AwslambdaProps>(function Awslambda({color = 'currentColor', size = 24, title = "awslambda", ...others}, ref) {
