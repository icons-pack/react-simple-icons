    ...
    const Apacheecharts = React.forwardRef<SVGSVGElement, ApacheechartsProps>(function Apacheecharts({color = 'currentColor', size = 24, title = "apacheecharts", ...others}, ref) {
