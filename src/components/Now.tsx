    ...
    export type NowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Now = React.forwardRef<SVGSVGElement, NowProps>(function Now({color = 'currentColor', size = 24, title = "now", ...others}, ref) {
