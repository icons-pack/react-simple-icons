    ...
    export type TuneinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tunein = React.forwardRef<SVGSVGElement, TuneinProps>(function Tunein({color = 'currentColor', size = 24, title = "tunein", ...others}, ref) {
