...
const Automatic = forwardRef(function Automatic(
  { color = 'currentColor', size = 24, title = 'Automatic', ...others },
  ref
) {
  return (
    <svg
