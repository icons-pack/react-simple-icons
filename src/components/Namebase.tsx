...
export type NamebaseProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Namebase = React.forwardRef<SVGSVGElement, NamebaseProps>(function Namebase({color = 'currentColor', size = 24, title = "namebase", ...others}, ref) {
