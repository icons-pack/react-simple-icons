    ...
    export type SololearnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Sololearn = React.forwardRef<SVGSVGElement, SololearnProps>(function Sololearn({color = 'currentColor', size = 24, title = "sololearn", ...others}, ref) {
