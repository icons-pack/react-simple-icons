...
export type ScopusProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Scopus = React.forwardRef<SVGSVGElement, ScopusProps>(function Scopus({color = 'currentColor', size = 24, title = "scopus", ...others}, ref) {
