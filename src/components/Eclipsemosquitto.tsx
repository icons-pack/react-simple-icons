...
const Eclipsemosquitto = React.forwardRef<SVGSVGElement, IconProps>(function Eclipsemosquitto({color = 'currentColor', size = 24, title = "eclipsemosquitto", ...others}, ref) {
