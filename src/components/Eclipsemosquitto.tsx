...
const Eclipsemosquitto = React.forwardRef<SVGSVGElement, EclipsemosquittoProps>(function Eclipsemosquitto({color = 'currentColor', size = 24, title = "eclipsemosquitto", ...others}, ref) {
