...
export type GoogledomainsProps = {
  /**
...
const Googledomains = React.forwardRef<SVGSVGElement, GoogledomainsProps>(function Googledomains(
  { color = 'currentColor', size = 24, title = 'googledomains', ...others },
  ref,
) {
  return (
    <svg
