    ...
    export type StarshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Starship = React.forwardRef<SVGSVGElement, StarshipProps>(function Starship({color = 'currentColor', size = 24, title = "starship", ...others}, ref) {
