    ...
    export type NbaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Nba = React.forwardRef<SVGSVGElement, NbaProps>(function Nba({color = 'currentColor', size = 24, title = "nba", ...others}, ref) {
