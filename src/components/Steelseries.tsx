    ...
    export type SteelseriesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Steelseries = React.forwardRef<SVGSVGElement, SteelseriesProps>(function Steelseries({color = 'currentColor', size = 24, title = "steelseries", ...others}, ref) {
