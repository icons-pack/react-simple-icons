...
export type AeroflotProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Aeroflot = React.forwardRef<SVGSVGElement, AeroflotProps>(function Aeroflot({color = 'currentColor', size = 24, title = "aeroflot", ...others}, ref) {
