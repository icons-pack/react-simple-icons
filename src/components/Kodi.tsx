...
export type KodiProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Kodi = React.forwardRef<SVGSVGElement, KodiProps>(function Kodi({color = 'currentColor', size = 24, title = "kodi", ...others}, ref) {
