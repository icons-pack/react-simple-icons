...
export type OpensourceinitiativeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Opensourceinitiative = React.forwardRef<SVGSVGElement, OpensourceinitiativeProps>(function Opensourceinitiative({color = 'currentColor', size = 24, title = "opensourceinitiative", ...others}, ref) {
