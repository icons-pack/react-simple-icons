    ...
    export type AdblockplusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Adblockplus = React.forwardRef<SVGSVGElement, AdblockplusProps>(function Adblockplus({color = 'currentColor', size = 24, title = "adblockplus", ...others}, ref) {
