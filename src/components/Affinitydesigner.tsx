...
const Affinitydesigner = React.forwardRef<SVGSVGElement, IconProps>(function Affinitydesigner({color = 'currentColor', size = 24, title = "affinitydesigner", ...others}, ref) {
