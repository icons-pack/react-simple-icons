...
export type SiemensProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Siemens = React.forwardRef<SVGSVGElement, SiemensProps>(function Siemens({color = 'currentColor', size = 24, title = "siemens", ...others}, ref) {
