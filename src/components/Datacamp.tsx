    ...
    export type DatacampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Datacamp = React.forwardRef<SVGSVGElement, DatacampProps>(function Datacamp({color = 'currentColor', size = 24, title = "datacamp", ...others}, ref) {
