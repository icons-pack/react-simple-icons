    ...
    export type RancherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rancher = React.forwardRef<SVGSVGElement, RancherProps>(function Rancher({color = 'currentColor', size = 24, title = "rancher", ...others}, ref) {
