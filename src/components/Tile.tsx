    ...
    export type TileProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tile = React.forwardRef<SVGSVGElement, TileProps>(function Tile({color = 'currentColor', size = 24, title = "tile", ...others}, ref) {
