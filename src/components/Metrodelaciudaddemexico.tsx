...
const Metrodelaciudaddemexico = React.forwardRef<SVGSVGElement, MetrodelaciudaddemexicoProps>(function Metrodelaciudaddemexico({color = 'currentColor', size = 24, title = "metrodelaciudaddemexico", ...others}, ref) {
