...
const Metrodelaciudaddemexico = React.forwardRef<SVGSVGElement, IconProps>(function Metrodelaciudaddemexico({color = 'currentColor', size = 24, title = "metrodelaciudaddemexico", ...others}, ref) {
