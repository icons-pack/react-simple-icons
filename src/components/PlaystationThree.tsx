...
const PlaystationThree = React.forwardRef<SVGSVGElement, PlaystationThreeProps>(function PlaystationThree(
  { color = 'currentColor', size = 24, title = 'playstation3', ...others },
  ref,
) {
  return (
    <svg
