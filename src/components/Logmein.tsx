    ...
    export type LogmeinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Logmein = React.forwardRef<SVGSVGElement, LogmeinProps>(function Logmein({color = 'currentColor', size = 24, title = "logmein", ...others}, ref) {
