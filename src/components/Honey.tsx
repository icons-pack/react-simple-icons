...
export type HoneyProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Honey = React.forwardRef<SVGSVGElement, HoneyProps>(function Honey({color = 'currentColor', size = 24, title = "honey", ...others}, ref) {
