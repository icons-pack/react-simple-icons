    ...
    export type BookstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Bookstack = React.forwardRef<SVGSVGElement, BookstackProps>(function Bookstack({color = 'currentColor', size = 24, title = "bookstack", ...others}, ref) {
