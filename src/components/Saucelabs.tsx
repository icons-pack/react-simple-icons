...
export type SaucelabsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Saucelabs = React.forwardRef<SVGSVGElement, SaucelabsProps>(function Saucelabs({color = 'currentColor', size = 24, title = "saucelabs", ...others}, ref) {
