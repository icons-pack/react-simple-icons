    ...
    export type UnityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Unity = React.forwardRef<SVGSVGElement, UnityProps>(function Unity({color = 'currentColor', size = 24, title = "unity", ...others}, ref) {
