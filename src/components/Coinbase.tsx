    ...
    export type CoinbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Coinbase = React.forwardRef<SVGSVGElement, CoinbaseProps>(function Coinbase({color = 'currentColor', size = 24, title = "coinbase", ...others}, ref) {
