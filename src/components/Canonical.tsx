    ...
    export type CanonicalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Canonical = React.forwardRef<SVGSVGElement, CanonicalProps>(function Canonical({color = 'currentColor', size = 24, title = "canonical", ...others}, ref) {
