    ...
    export type PolkadotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Polkadot = React.forwardRef<SVGSVGElement, PolkadotProps>(function Polkadot({color = 'currentColor', size = 24, title = "polkadot", ...others}, ref) {
