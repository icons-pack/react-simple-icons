    ...
    export type LifxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Lifx = React.forwardRef<SVGSVGElement, LifxProps>(function Lifx({color = 'currentColor', size = 24, title = "lifx", ...others}, ref) {
