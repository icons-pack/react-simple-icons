    ...
    export type FirefoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Firefox = React.forwardRef<SVGSVGElement, FirefoxProps>(function Firefox({color = 'currentColor', size = 24, title = "firefox", ...others}, ref) {
