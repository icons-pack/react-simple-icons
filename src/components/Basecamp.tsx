    ...
    export type BasecampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Basecamp = React.forwardRef<SVGSVGElement, BasecampProps>(function Basecamp({color = 'currentColor', size = 24, title = "basecamp", ...others}, ref) {
