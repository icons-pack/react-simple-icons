    ...
    export type PicpayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Picpay = React.forwardRef<SVGSVGElement, PicpayProps>(function Picpay({color = 'currentColor', size = 24, title = "picpay", ...others}, ref) {
