    ...
    export type UpstashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Upstash = React.forwardRef<SVGSVGElement, UpstashProps>(function Upstash({color = 'currentColor', size = 24, title = "upstash", ...others}, ref) {
