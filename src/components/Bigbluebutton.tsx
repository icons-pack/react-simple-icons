...
export type BigbluebuttonProps = {
  /**
...
const Bigbluebutton = React.forwardRef<SVGSVGElement, BigbluebuttonProps>(function Bigbluebutton(
  { color = 'currentColor', size = 24, title = 'bigbluebutton', ...others },
  ref,
) {
  return (
    <svg
