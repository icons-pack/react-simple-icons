...
export type FitbitProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Fitbit = React.forwardRef<SVGSVGElement, FitbitProps>(function Fitbit({color = 'currentColor', size = 24, title = "fitbit", ...others}, ref) {
