...
export type VolkswagenProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Volkswagen = React.forwardRef<SVGSVGElement, VolkswagenProps>(function Volkswagen({color = 'currentColor', size = 24, title = "volkswagen", ...others}, ref) {
