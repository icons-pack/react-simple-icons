    ...
    export type JblProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jbl = React.forwardRef<SVGSVGElement, JblProps>(function Jbl({color = 'currentColor', size = 24, title = "jbl", ...others}, ref) {
