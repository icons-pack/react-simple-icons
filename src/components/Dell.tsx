    ...
    export type DellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Dell = React.forwardRef<SVGSVGElement, DellProps>(function Dell({color = 'currentColor', size = 24, title = "dell", ...others}, ref) {
