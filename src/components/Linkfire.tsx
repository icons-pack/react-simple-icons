    ...
    export type LinkfireProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Linkfire = React.forwardRef<SVGSVGElement, LinkfireProps>(function Linkfire({color = 'currentColor', size = 24, title = "linkfire", ...others}, ref) {
