    ...
    export type TplinkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tplink = React.forwardRef<SVGSVGElement, TplinkProps>(function Tplink({color = 'currentColor', size = 24, title = "tplink", ...others}, ref) {
