    ...
    export type RstudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Rstudio = React.forwardRef<SVGSVGElement, RstudioProps>(function Rstudio({color = 'currentColor', size = 24, title = "rstudio", ...others}, ref) {
