    ...
    export type InternetarchiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Internetarchive = React.forwardRef<SVGSVGElement, InternetarchiveProps>(function Internetarchive({color = 'currentColor', size = 24, title = "internetarchive", ...others}, ref) {
