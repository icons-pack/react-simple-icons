...
const Internetarchive = React.forwardRef<SVGSVGElement, InternetarchiveProps>(function Internetarchive(
  { color = 'currentColor', size = 24, title = 'internetarchive', ...others },
  ref,
) {
  return (
    <svg
