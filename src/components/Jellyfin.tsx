    ...
    export type JellyfinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Jellyfin = React.forwardRef<SVGSVGElement, JellyfinProps>(function Jellyfin({color = 'currentColor', size = 24, title = "jellyfin", ...others}, ref) {
