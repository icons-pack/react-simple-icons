    ...
    export type KfcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Kfc = React.forwardRef<SVGSVGElement, KfcProps>(function Kfc({color = 'currentColor', size = 24, title = "kfc", ...others}, ref) {
