    ...
    export type AlibabadotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Alibabadotcom = React.forwardRef<SVGSVGElement, AlibabadotcomProps>(function Alibabadotcom({color = 'currentColor', size = 24, title = "alibabadotcom", ...others}, ref) {
