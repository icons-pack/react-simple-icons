    ...
    export type AndelaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Andela = React.forwardRef<SVGSVGElement, AndelaProps>(function Andela({color = 'currentColor', size = 24, title = "andela", ...others}, ref) {
