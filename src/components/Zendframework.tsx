    ...
    export type ZendframeworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Zendframework = React.forwardRef<SVGSVGElement, ZendframeworkProps>(function Zendframework({color = 'currentColor', size = 24, title = "zendframework", ...others}, ref) {
