...
export type BackbonedotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Backbonedotjs = React.forwardRef<SVGSVGElement, BackbonedotjsProps>(function Backbonedotjs({color = 'currentColor', size = 24, title = "backbonedotjs", ...others}, ref) {
