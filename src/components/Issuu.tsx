    ...
    export type IssuuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Issuu = React.forwardRef<SVGSVGElement, IssuuProps>(function Issuu({color = 'currentColor', size = 24, title = "issuu", ...others}, ref) {
