    ...
    export type TadoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Tado = React.forwardRef<SVGSVGElement, TadoProps>(function Tado({color = 'currentColor', size = 24, title = "tado", ...others}, ref) {
