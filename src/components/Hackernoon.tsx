    ...
    export type HackernoonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Hackernoon = React.forwardRef<SVGSVGElement, HackernoonProps>(function Hackernoon({color = 'currentColor', size = 24, title = "hackernoon", ...others}, ref) {
