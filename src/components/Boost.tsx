    ...
    export type BoostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Boost = React.forwardRef<SVGSVGElement, BoostProps>(function Boost({color = 'currentColor', size = 24, title = "boost", ...others}, ref) {
