...
export type JoplinProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Joplin = React.forwardRef<SVGSVGElement, JoplinProps>(function Joplin({color = 'currentColor', size = 24, title = "joplin", ...others}, ref) {
