...
export type AntaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Anta = React.forwardRef<SVGSVGElement, AntaProps>(function Anta({color = 'currentColor', size = 24, title = "anta", ...others}, ref) {
