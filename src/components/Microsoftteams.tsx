    ...
    export type MicrosoftteamsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Microsoftteams = React.forwardRef<SVGSVGElement, MicrosoftteamsProps>(function Microsoftteams({color = 'currentColor', size = 24, title = "microsoftteams", ...others}, ref) {
