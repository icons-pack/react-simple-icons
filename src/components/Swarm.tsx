    ...
    export type SwarmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Swarm = React.forwardRef<SVGSVGElement, SwarmProps>(function Swarm({color = 'currentColor', size = 24, title = "swarm", ...others}, ref) {
