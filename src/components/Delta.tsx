...
export type DeltaProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Delta = React.forwardRef<SVGSVGElement, DeltaProps>(function Delta({color = 'currentColor', size = 24, title = "delta", ...others}, ref) {
