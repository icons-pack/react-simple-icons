    ...
    export type VtexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Vtex = React.forwardRef<SVGSVGElement, VtexProps>(function Vtex({color = 'currentColor', size = 24, title = "vtex", ...others}, ref) {
