    ...
    export type OpenwrtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Openwrt = React.forwardRef<SVGSVGElement, OpenwrtProps>(function Openwrt({color = 'currentColor', size = 24, title = "openwrt", ...others}, ref) {
