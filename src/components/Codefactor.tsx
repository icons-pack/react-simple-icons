    ...
    export type CodefactorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Codefactor = React.forwardRef<SVGSVGElement, CodefactorProps>(function Codefactor({color = 'currentColor', size = 24, title = "codefactor", ...others}, ref) {
