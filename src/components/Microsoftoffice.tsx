...
export type MicrosoftofficeProps = React.ComponentPropsWithoutRef<'svg'> & {
  /**
...
const Microsoftoffice = React.forwardRef<SVGSVGElement, MicrosoftofficeProps>(function Microsoftoffice({color = 'currentColor', size = 24, title = "microsoftoffice", ...others}, ref) {
