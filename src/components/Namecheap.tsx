    ...
    export type NamecheapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Namecheap = React.forwardRef<SVGSVGElement, NamecheapProps>(function Namecheap({color = 'currentColor', size = 24, title = "namecheap", ...others}, ref) {
