    ...
    export type YubicoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Yubico = React.forwardRef<SVGSVGElement, YubicoProps>(function Yubico({color = 'currentColor', size = 24, title = "yubico", ...others}, ref) {
