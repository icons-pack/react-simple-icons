    ...
    export type YamahamotorcorporationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Yamahamotorcorporation = React.forwardRef<SVGSVGElement, YamahamotorcorporationProps>(function Yamahamotorcorporation({color = 'currentColor', size = 24, title = "yamahamotorcorporation", ...others}, ref) {
