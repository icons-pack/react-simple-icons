...
This package provides the [Simple Icons 3.3.0](https://github.com/simple-icons/simple-icons/releases/tag/3.3.0) packaged as a set of [React](https://facebook.github.io/react/) components.
