...
const Hackhands = forwardRef(function Hackhands(
  { color = 'currentColor', size = 24, title = 'HackHands', ...others },
  ref
) {
  return (
    <svg
