...
const Letsencrypt = forwardRef(function Letsencrypt(
  { color = 'currentColor', size = 24, title = 'Let’s Encrypt', ...others },
  ref
) {
  return (
    <svg
